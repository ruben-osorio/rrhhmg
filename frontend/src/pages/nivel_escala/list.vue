                ...
                <div class="container-fluid">
                    <div class="row justify-between items-center q-col-gutter-md">
                        ...
                        <div  class="col-md-auto col-12 " >
                            <template v-if="auth.canView('/nivel_escala/add')">
                                <q-btn       :rounded="false"  size=""  color="primary" no-caps  unelevated   :to="`/nivel_escala/add`" class="" >
                        ...
                        <div >
                            <template v-if="showBreadcrumbs && $route.query.tag">
                                <q-breadcrumbs class="q-pa-md">
                                    <q-breadcrumbs-el icon="arrow_back" class="text-capitalize" :label="$route.query.tag" to="/nivel_escala"></q-breadcrumbs-el>
                            ...
                            <div >
                                ...
                                :bordered="false"
                                :columns="app.menus.NivelEscalaListHeaderItems" 
                                :rows="records"
                                ...
                                <template v-slot:body="props">
                                    <q-tr :class="{selected: isCurrentRecord(props.row)}" :props="props">
                                                ...
                                                <q-btn icon="menu" padding="xs" round flat color="grey">
                                                    <q-menu auto-close transition-show="flip-right"  transition-hide="flip-left" self="center middle" anchor="center middle">
                                                        <q-list dense rounded nav>
                                                            <template v-if="auth.canView('nivel_escala/view')">
                                                                <q-item link clickable v-ripple @click="app.openPageDialog({ page:'nivel_escala/view', url: `/nivel_escala/view/${props.row.id_nivel_esc}` , closeBtn: true })">
                                                                    <q-item-section>
                                                            ...
                                                            <template v-if="auth.canView('nivel_escala/edit')">
                                                                <q-item link clickable v-ripple @click="app.openPageDialog({ page:'nivel_escala/edit', url: `/nivel_escala/edit/${props.row.id_nivel_esc}` , closeBtn: true })">
                                                                    <q-item-section>
                                                            ...
                                                            <template v-if="auth.canView('nivel_escala/delete')">
                                                                <q-item link clickable v-ripple @click="deleteItem(props.row.id_nivel_esc)">
                                                                    <q-item-section>
                                        ...
                                        <q-td  key="valor_nivel" :props="props">
                                            {{ props.row.valor_nivel }}
                                        </q-td>
                                        <q-td  key="descripcion_niv" :props="props">
                                            {{ props.row.descripcion_niv }}
                                        </q-td>
                                    </q-tr>
                                </template>
                                <!-- End of Table Layout-->
...
<script setup>
	...
	const props = defineProps({
		...
		routeName : {
			type : String,
			default : 'nivel_escalalist',
		},
		apiPath : {
			type : String,
			default : 'nivel_escala/index',
		},
		paginate: {
			type: Boolean,
			default: true,
