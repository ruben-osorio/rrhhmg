                ...
                <div class="container-fluid">
                    <div class="row justify-between items-center q-col-gutter-md">
                        ...
                        <div  class="col-md-auto col-12 " >
                            <template v-if="auth.canView('/genero/add')">
                                <q-btn       :rounded="false"  size=""  color="primary" no-caps  unelevated   :to="`/genero/add`" class="" >
                        ...
                        <div >
                            <template v-if="showBreadcrumbs && $route.query.tag">
                                <q-breadcrumbs class="q-pa-md">
                                    <q-breadcrumbs-el icon="arrow_back" class="text-capitalize" :label="$route.query.tag" to="/genero"></q-breadcrumbs-el>
                            ...
                            <div >
                                ...
                                :bordered="false"
                                :columns="app.menus.GeneroListHeaderItems" 
                                :rows="records"
                                ...
                                <template v-slot:body="props">
                                    <q-tr :class="{selected: isCurrentRecord(props.row)}" :props="props">
                                        ...
                                        <q-td  key="idgenero" :props="props">
                                            <q-btn padding="xs"   :rounded="false"  color="primary"  no-caps  unelevated   flat :to="`/genero/view/${props.row.idgenero}`">{{ props.row.idgenero }}</q-btn>
                                        </q-td>
                                        <q-td  key="nomgenero" :props="props">
                                            {{ props.row.nomgenero }}
                                        </q-td>
                                        <q-td  key="abrevgenero" :props="props">
                                            {{ props.row.abrevgenero }}
                                        </q-td>
                                                ...
                                                <q-btn icon="menu" padding="xs" round flat color="grey">
                                                    <q-menu auto-close transition-show="flip-right"  transition-hide="flip-left" self="center middle" anchor="center middle">
                                                        <q-list dense rounded nav>
                                                            <template v-if="auth.canView('genero/view')">
                                                                <q-item link clickable v-ripple :to="`/genero/view/${props.row.idgenero}`">
                                                                    <q-item-section>
                                                            ...
                                                            <template v-if="auth.canView('genero/edit')">
                                                                <q-item link clickable v-ripple :to="`/genero/edit/${props.row.idgenero}`">
                                                                    <q-item-section>
                                                            ...
                                                            <template v-if="auth.canView('genero/delete')">
                                                                <q-item link clickable v-ripple @click="deleteItem(props.row.idgenero)">
                                                                    <q-item-section>
