                ...
                <div class="container-fluid">
                    <div class="row justify-between items-center q-col-gutter-md">
                        ...
                        <div  class="col-md-auto col-12 " >
                            <template v-if="auth.canView('/evaluacion_perfil/add')">
                                <q-btn       :rounded="false"  size=""  color="primary" no-caps  unelevated   :to="`/evaluacion_perfil/add`" class="" >
                        ...
                        <div >
                            <template v-if="showBreadcrumbs && $route.query.tag">
                                <q-breadcrumbs class="q-pa-md">
                                    <q-breadcrumbs-el icon="arrow_back" class="text-capitalize" :label="$route.query.tag" to="/evaluacion_perfil"></q-breadcrumbs-el>
                            ...
                            <div >
                                ...
                                :bordered="false"
                                :columns="app.menus.EvaluacionPerfilListHeaderItems" 
                                :rows="records"
                                ...
                                <template v-slot:body="props">
                                    <q-tr :class="{selected: isCurrentRecord(props.row)}" :props="props">
                                                ...
                                                <q-btn icon="menu" padding="xs" round flat color="grey">
                                                    <q-menu auto-close transition-show="flip-right"  transition-hide="flip-left" self="center middle" anchor="center middle">
                                                        <q-list dense rounded nav>
                                                            <template v-if="auth.canView('evaluacion_perfil/view')">
                                                                <q-item link clickable v-ripple :to="`/evaluacion_perfil/view/${props.row.id}`">
                                                                    <q-item-section>
                                                            ...
                                                            <template v-if="auth.canView('evaluacion_perfil/edit')">
                                                                <q-item link clickable v-ripple :to="`/evaluacion_perfil/edit/${props.row.id}`">
                                                                    <q-item-section>
                                                            ...
                                                            <template v-if="auth.canView('evaluacion_perfil/delete')">
                                        ...
                                        <q-td  key="id" :props="props">
                                            <q-btn padding="xs"   :rounded="false"  color="primary"  no-caps  unelevated   flat :to="`/evaluacion_perfil/view/${props.row.id}`">{{ props.row.id }}</q-btn>
                                        </q-td>
                                        <q-td  key="aprovado" :props="props">
                                            {{ props.row.aprovado }}
                                        </q-td>
                                        <q-td  key="formacion_academica" :props="props">
                                            {{ props.row.formacion_academica }}
                                        </q-td>
                                        ...
                                        <q-td  key="exp_especifica" :props="props">
                                            {{ props.row.exp_especifica }}
                                        </q-td>
                                        <q-td  key="exp_general" :props="props">
                                            {{ props.row.exp_general }}
                                        </q-td>
                                    </q-tr>
                                </template>
                                <!-- End of Table Layout-->
...
<script setup>
	...
	const props = defineProps({
		...
		routeName : {
			type : String,
			default : 'evaluacion_perfillist',
		},
		apiPath : {
			type : String,
			default : 'evaluacion_perfil/index',
		},
		paginate: {
			type: Boolean,
			default: true,
