                ...
                <div class="container-fluid">
                    <div class="row justify-between items-center q-col-gutter-md">
                        ...
                        <div  class="col-md-auto col-12 " >
                            <template v-if="auth.canView('/parentesco/add')">
                                <q-btn       :rounded="false"  size=""  color="primary" no-caps  unelevated   :to="`/parentesco/add`" class="" >
                        ...
                        <div >
                            <template v-if="showBreadcrumbs && $route.query.tag">
                                <q-breadcrumbs class="q-pa-md">
                                    <q-breadcrumbs-el icon="arrow_back" class="text-capitalize" :label="$route.query.tag" to="/parentesco"></q-breadcrumbs-el>
                            ...
                            <div >
                                ...
                                :bordered="false"
                                :columns="app.menus.ParentescoListHeaderItems" 
                                :rows="records"
                                ...
                                <template v-slot:body="props">
                                    <q-tr :class="{selected: isCurrentRecord(props.row)}" :props="props">
                                        ...
                                        <q-td  key="idparentesco" :props="props">
                                            <q-btn padding="xs"   :rounded="false"  color="primary"  no-caps  unelevated   flat :to="`/parentesco/view/${props.row.idparentesco}`">{{ props.row.idparentesco }}</q-btn>
                                        </q-td>
                                        ...
                                        <q-td  key="nacionalidad" :props="props">
                                            {{ props.row.nacionalidad }}
                                        </q-td>
                                                ...
                                                <q-btn icon="menu" padding="xs" round flat color="grey">
                                                    <q-menu auto-close transition-show="flip-right"  transition-hide="flip-left" self="center middle" anchor="center middle">
                                                        <q-list dense rounded nav>
                                                            <template v-if="auth.canView('parentesco/view')">
                                                                <q-item link clickable v-ripple :to="`/parentesco/view/${props.row.idparentesco}`">
                                                                    <q-item-section>
                                                            ...
                                                            <template v-if="auth.canView('parentesco/edit')">
                                                                <q-item link clickable v-ripple :to="`/parentesco/edit/${props.row.idparentesco}`">
                                                                    <q-item-section>
                                                            ...
                                                            <template v-if="auth.canView('parentesco/delete')">
                                                                <q-item link clickable v-ripple @click="deleteItem(props.row.idparentesco)">
                                                                    <q-item-section>
...
<script setup>
	...
	const props = defineProps({
		...
		routeName : {
			type : String,
			default : 'parentescolist',
		},
		apiPath : {
			type : String,
			default : 'parentesco/index',
		},
		paginate: {
			type: Boolean,
			default: true,
