                                    ...
                                    <div class="row q-col-gutter-x-md">
                                        <div class="col-12">
                                            <div class="row">
                                                ...
                                                <div class="col-sm-9 col-12">
                                                    <q-input   ref="ctrlnombres" v-model.trim="formData.nombres"  label="Nombres" type="text" placeholder="Escribir Nombres"      
                                                    class="" :error="isFieldValid('nombres')" :error-message="getFieldError('nombres')">
                                                    </q-input>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-12">
                                            <div class="row">
                                                ...
                                                <div class="col-sm-9 col-12">
                                                    <q-input  ref="ctrlfechanacimiento" v-model="formData.fechanacimiento" label="Fechanacimiento"    :error="isFieldValid('fechanacimiento')" :error-message="getFieldError('fechanacimiento')">
                                                    <template v-slot:append>
                                                        <q-icon name="date_range" class="cursor-pointer">
                                                        <q-popup-proxy ref="ctrlfechanacimiento" transition-show="scale" transition-hide="scale">
                                                        <q-date    mask="YYYY-MM-DD" v-model="formData.fechanacimiento" @input="$refs.ctrlfechanacimiento.hide()" />
                                                        </q-popup-proxy>
                                                        </q-icon>
                                                    </template>
                                                    </q-input>      
                                        ...
                                        <div class="col-12">
                                            <div class="row">
                                                ...
                                                <div class="col-sm-9 col-12">
                                                    <q-input   ref="ctrlnacionalidad" v-model.trim="formData.nacionalidad"  label="Nacionalidad" type="text" placeholder="Escribir Nacionalidad"      
                                                    class="" :error="isFieldValid('nacionalidad')" :error-message="getFieldError('nacionalidad')">
                                                    </q-input>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-12">
                                            <div class="row">
                                                ...
                                                <div class="col-sm-9 col-12">
                                                    <q-input   ref="ctrlnrodocumento" v-model.trim="formData.nrodocumento"  label="Nrodocumento" type="text" placeholder="Escribir Nrodocumento"      
                                                    class="" :error="isFieldValid('nrodocumento')" :error-message="getFieldError('nrodocumento')">
                                                    </q-input>
                                                </div>
                                            </div>
                                        </div>
...
<script setup>
	...
	const props = defineProps({
		...
		routeName: {
			type: String,
			default: 'parentescoedit',
		},
		pagePath: {
			type : String,
			default : 'parentesco/edit',
		},
		apiPath: {
			type: String,
			default: 'parentesco/edit',
