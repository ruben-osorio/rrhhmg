                ...
                <div class="container-fluid">
                    <div class="row justify-between items-center q-col-gutter-md">
                        ...
                        <div  class="col-md-auto col-12 " >
                            <template v-if="auth.canView('/insthv/add')">
                                <q-btn       :rounded="false"  size=""  color="primary" no-caps  unelevated   :to="`/insthv/add`" class="" >
                        ...
                        <div >
                            <template v-if="showBreadcrumbs && $route.query.tag">
                                <q-breadcrumbs class="q-pa-md">
                                    <q-breadcrumbs-el icon="arrow_back" class="text-capitalize" :label="$route.query.tag" to="/insthv"></q-breadcrumbs-el>
                            ...
                            <div >
                                ...
                                :bordered="false"
                                :columns="app.menus.InsthvListHeaderItems" 
                                :rows="records"
                                ...
                                <template v-slot:body="props">
                                    <q-tr :class="{selected: isCurrentRecord(props.row)}" :props="props">
                                                ...
                                                <q-btn icon="menu" padding="xs" round flat color="grey">
                                                    <q-menu auto-close transition-show="flip-right"  transition-hide="flip-left" self="center middle" anchor="center middle">
                                                        <q-list dense rounded nav>
                                                            <template v-if="auth.canView('insthv/view')">
                                                                <q-item link clickable v-ripple :to="`/insthv/view/${props.row.idinsthv}`">
                                                                    <q-item-section>
                                                            ...
                                                            <template v-if="auth.canView('insthv/edit')">
                                                                <q-item link clickable v-ripple :to="`/insthv/edit/${props.row.idinsthv}`">
                                                                    <q-item-section>
                                                            ...
                                                            <template v-if="auth.canView('insthv/delete')">
                                                                <q-item link clickable v-ripple @click="deleteItem(props.row.idinsthv)">
                                                                    <q-item-section>
                                        ...
                                        <q-td  key="idinsthv" :props="props">
                                            <q-btn padding="xs"   :rounded="false"  color="primary"  no-caps  unelevated   flat :to="`/insthv/view/${props.row.idinsthv}`">{{ props.row.idinsthv }}</q-btn>
                                        </q-td>
                                        <q-td  key="insthv" :props="props">
                                            {{ props.row.insthv }}
                                        </q-td>
