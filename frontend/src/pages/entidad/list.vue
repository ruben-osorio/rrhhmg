                ...
                <div class="container-fluid">
                    <div class="row justify-between items-center q-col-gutter-md">
                        ...
                        <div  class="col-md-auto col-12 " >
                            <template v-if="auth.canView('/entidad/add')">
                                <q-btn       :rounded="false"  size=""  color="primary" no-caps  unelevated   :to="`/entidad/add`" class="" >
                        ...
                        <div >
                            <template v-if="showBreadcrumbs && $route.query.tag">
                                <q-breadcrumbs class="q-pa-md">
                                    <q-breadcrumbs-el icon="arrow_back" class="text-capitalize" :label="$route.query.tag" to="/entidad"></q-breadcrumbs-el>
                            ...
                            <div class="row q-col-gutter-x-md q-col-gutter-md justify-start">
                                <div class="col">
                                    ...
                                    <div >
                                        ...
                                        :bordered="false"
                                        :columns="app.menus.EntidadListHeaderItems" 
                                        :rows="records"
                                        ...
                                        <template v-slot:body="props">
                                            <q-tr :class="{selected: isCurrentRecord(props.row)}" :props="props">
                                                ...
                                                <q-td  key="identidad" :props="props">
                                                    <q-btn padding="xs"   :rounded="false"  color="primary"  no-caps  unelevated   flat :to="`/entidad/view/${props.row.identidad}`">{{ props.row.identidad }}</q-btn>
                                                </q-td>
                                                <q-td  key="dependencia" :props="props">
                                                    <q-btn v-if="props.row.dependencia" @click="app.openPageDialog({ page: 'entidad/view', url: `/entidad/view/${props.row.dependencia}` , closeBtn: true })" padding="xs" flat color="primary" no-caps >
                                                        ...
                                                        <q-btn icon="menu" padding="xs" round flat color="grey">
                                                            <q-menu auto-close transition-show="flip-right"  transition-hide="flip-left" self="center middle" anchor="center middle">
                                                                <q-list dense rounded nav>
                                                                    <template v-if="auth.canView('entidad/view')">
                                                                        <q-item link clickable v-ripple :to="`/entidad/view/${props.row.identidad}`">
                                                                            <q-item-section>
                                                                    ...
                                                                    <template v-if="auth.canView('entidad/edit')">
                                                                        <q-item link clickable v-ripple :to="`/entidad/edit/${props.row.identidad}`">
                                                                            <q-item-section>
                                                                    ...
                                                                    <template v-if="auth.canView('entidad/delete')">
                                                                        <q-item link clickable v-ripple @click="deleteItem(props.row.identidad)">
                                                                            <q-item-section>
