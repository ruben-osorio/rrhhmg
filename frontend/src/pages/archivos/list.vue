                ...
                <div class="container-fluid">
                    <div class="row justify-between items-center q-col-gutter-md">
                        ...
                        <div  class="col-md-auto col-12 " >
                            <template v-if="auth.canView('/archivos/add')">
                                <q-btn       :rounded="false"  size=""  color="primary" no-caps  unelevated   :to="`/archivos/add`" class="" >
                        ...
                        <div >
                            <template v-if="showBreadcrumbs && $route.query.tag">
                                <q-breadcrumbs class="q-pa-md">
                                    <q-breadcrumbs-el icon="arrow_back" class="text-capitalize" :label="$route.query.tag" to="/archivos"></q-breadcrumbs-el>
                            ...
                            <div >
                                ...
                                :bordered="false"
                                :columns="app.menus.ArchivosListHeaderItems" 
                                :rows="records"
                                ...
                                <template v-slot:body="props">
                                    <q-tr :class="{selected: isCurrentRecord(props.row)}" :props="props">
                                        ...
                                        <q-td  key="idarchivo" :props="props">
                                            <q-btn padding="xs"   :rounded="false"  color="primary"  no-caps  unelevated   flat :to="`/archivos/view/${props.row.idarchivo}`">{{ props.row.idarchivo }}</q-btn>
                                        </q-td>
                                                ...
                                                <q-btn icon="menu" padding="xs" round flat color="grey">
                                                    <q-menu auto-close transition-show="flip-right"  transition-hide="flip-left" self="center middle" anchor="center middle">
                                                        <q-list dense rounded nav>
                                                            <template v-if="auth.canView('archivos/view')">
                                                                <q-item link clickable v-ripple :to="`/archivos/view/${props.row.idarchivo}`">
                                                                    <q-item-section>
                                                            ...
                                                            <template v-if="auth.canView('archivos/edit')">
                                                                <q-item link clickable v-ripple :to="`/archivos/edit/${props.row.idarchivo}`">
                                                                    <q-item-section>
                                                            ...
                                                            <template v-if="auth.canView('archivos/delete')">
                                                                <q-item link clickable v-ripple @click="deleteItem(props.row.idarchivo)">
                                                                    <q-item-section>
...
<script setup>
	...
	const props = defineProps({
		...
		routeName : {
			type : String,
			default : 'archivoslist',
		},
		apiPath : {
			type : String,
			default : 'archivos/index',
		},
		paginate: {
			type: Boolean,
			default: true,
