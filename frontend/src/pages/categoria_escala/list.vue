                ...
                <div class="container-fluid">
                    <div class="row justify-between items-center q-col-gutter-md">
                        ...
                        <div  class="col-md-auto col-12 " >
                            <template v-if="auth.canView('/categoria_escala/add')">
                                <q-btn       :rounded="false"  size=""  color="primary" no-caps  unelevated   :to="`/categoria_escala/add`" class="" >
                        ...
                        <div >
                            <template v-if="showBreadcrumbs && $route.query.tag">
                                <q-breadcrumbs class="q-pa-md">
                                    <q-breadcrumbs-el icon="arrow_back" class="text-capitalize" :label="$route.query.tag" to="/categoria_escala"></q-breadcrumbs-el>
                            ...
                            <div >
                                ...
                                :bordered="false"
                                :columns="app.menus.CategoriaEscalaListHeaderItems" 
                                :rows="records"
                                ...
                                <template v-slot:body="props">
                                    <q-tr :class="{selected: isCurrentRecord(props.row)}" :props="props">
                                        ...
                                        <q-td  key="id_catescala" :props="props">
                                            <q-btn padding="xs"   :rounded="false"  color="primary"  no-caps  unelevated   flat :to="`/categoria_escala/view/${props.row.id_catescala}`">{{ props.row.id_catescala }}</q-btn>
                                        </q-td>
                                        <q-td  key="desc_catescala" :props="props">
                                            {{ props.row.desc_catescala }}
                                        </q-td>
                                        <q-td  key="id_fk_nivel" :props="props">
                                            {{ props.row.id_fk_nivel }}
                                        </q-td>
                                                ...
                                                <q-btn icon="menu" padding="xs" round flat color="grey">
                                                    <q-menu auto-close transition-show="flip-right"  transition-hide="flip-left" self="center middle" anchor="center middle">
                                                        <q-list dense rounded nav>
                                                            <template v-if="auth.canView('categoria_escala/view')">
                                                                <q-item link clickable v-ripple :to="`/categoria_escala/view/${props.row.id_catescala}`">
                                                                    <q-item-section>
                                                            ...
                                                            <template v-if="auth.canView('categoria_escala/edit')">
                                                                <q-item link clickable v-ripple :to="`/categoria_escala/edit/${props.row.id_catescala}`">
                                                                    <q-item-section>
                                                            ...
                                                            <template v-if="auth.canView('categoria_escala/delete')">
                                                                <q-item link clickable v-ripple @click="deleteItem(props.row.id_catescala)">
                                                                    <q-item-section>
...
<script setup>
	...
	const props = defineProps({
		primaryKey : {
			type : String,
			default : 'id_catescala',
		},
		pageName : {
			type : String,
			default : 'categoria_escala',
		},
		routeName : {
			type : String,
			default : 'categoria_escalalist',
		},
		apiPath : {
			type : String,
			default : 'categoria_escala/index',
		},
		paginate: {
			type: Boolean,
			default: true,
