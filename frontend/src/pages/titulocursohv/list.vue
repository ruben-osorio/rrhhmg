                ...
                <div class="container-fluid">
                    <div class="row justify-between items-center q-col-gutter-md">
                        ...
                        <div  class="col-md-auto col-12 " >
                            <template v-if="auth.canView('/titulocursohv/add')">
                                <q-btn       :rounded="false"  size=""  color="primary" no-caps  unelevated   :to="`/titulocursohv/add`" class="" >
                        ...
                        <div >
                            <template v-if="showBreadcrumbs && $route.query.tag">
                                <q-breadcrumbs class="q-pa-md">
                                    <q-breadcrumbs-el icon="arrow_back" class="text-capitalize" :label="$route.query.tag" to="/titulocursohv"></q-breadcrumbs-el>
                            ...
                            <div >
                                ...
                                :bordered="false"
                                :columns="app.menus.TitulocursohvListHeaderItems" 
                                :rows="records"
                                ...
                                <template v-slot:body="props">
                                    <q-tr :class="{selected: isCurrentRecord(props.row)}" :props="props">
                                                ...
                                                <q-btn icon="menu" padding="xs" round flat color="grey">
                                                    <q-menu auto-close transition-show="flip-right"  transition-hide="flip-left" self="center middle" anchor="center middle">
                                                        <q-list dense rounded nav>
                                                            <template v-if="auth.canView('titulocursohv/view')">
                                                                <q-item link clickable v-ripple :to="`/titulocursohv/view/${props.row.idcursos}`">
                                                                    <q-item-section>
                                                            ...
                                                            <template v-if="auth.canView('titulocursohv/edit')">
                                                                <q-item link clickable v-ripple :to="`/titulocursohv/edit/${props.row.idcursos}`">
                                                                    <q-item-section>
                                                            ...
                                                            <template v-if="auth.canView('titulocursohv/delete')">
                                                                <q-item link clickable v-ripple @click="deleteItem(props.row.idcursos)">
                                                                    <q-item-section>
                                        ...
                                        <q-td  key="idcursos" :props="props">
                                            <q-btn padding="xs"   :rounded="false"  color="primary"  no-caps  unelevated   flat :to="`/titulocursohv/view/${props.row.idcursos}`">{{ props.row.idcursos }}</q-btn>
                                        </q-td>
...
<script setup>
	...
	const props = defineProps({
		...
		pageName : {
			type : String,
			default : 'titulocursohv',
		},
		routeName : {
			type : String,
			default : 'titulocursohvlist',
		},
		apiPath : {
			type : String,
			default : 'titulocursohv/index',
		},
		paginate: {
			type: Boolean,
			default: true,
