                ...
                <div class="container-fluid">
                    <div class="row justify-between items-center q-col-gutter-md">
                        ...
                        <div  class="col-md-auto col-12 " >
                            <template v-if="auth.canView('/antiguedad/add')">
                                <q-btn       :rounded="false"  size=""  color="primary" no-caps  unelevated   :to="`/antiguedad/add`" class="" >
                        ...
                        <div >
                            <template v-if="showBreadcrumbs && $route.query.tag">
                                <q-breadcrumbs class="q-pa-md">
                                    <q-breadcrumbs-el icon="arrow_back" class="text-capitalize" :label="$route.query.tag" to="/antiguedad"></q-breadcrumbs-el>
                            ...
                            <div >
                                ...
                                :bordered="false"
                                :columns="app.menus.AntiguedadListHeaderItems" 
                                :rows="records"
                                ...
                                <template v-slot:body="props">
                                    <q-tr :class="{selected: isCurrentRecord(props.row)}" :props="props">
                                        ...
                                        <q-td  key="idantiguedad" :props="props">
                                            <q-btn padding="xs"   :rounded="false"  color="primary"  no-caps  unelevated   flat :to="`/antiguedad/view/${props.row.idantiguedad}`">{{ props.row.idantiguedad }}</q-btn>
                                        </q-td>
                                        <q-td  key="anios" :props="props">
                                            {{ props.row.anios }}
                                        </q-td>
                                        ...
                                        <q-td  key="numero_informe_cas" :props="props">
                                            {{ props.row.numero_informe_cas }}
                                        </q-td>
                                                ...
                                                <q-btn icon="menu" padding="xs" round flat color="grey">
                                                    <q-menu auto-close transition-show="flip-right"  transition-hide="flip-left" self="center middle" anchor="center middle">
                                                        <q-list dense rounded nav>
                                                            <template v-if="auth.canView('antiguedad/view')">
                                                                <q-item link clickable v-ripple :to="`/antiguedad/view/${props.row.idantiguedad}`">
                                                                    <q-item-section>
                                                            ...
                                                            <template v-if="auth.canView('antiguedad/edit')">
                                                                <q-item link clickable v-ripple :to="`/antiguedad/edit/${props.row.idantiguedad}`">
                                                                    <q-item-section>
                                                            ...
                                                            <template v-if="auth.canView('antiguedad/delete')">
                                                                <q-item link clickable v-ripple @click="deleteItem(props.row.idantiguedad)">
                                                                    <q-item-section>
...
<script setup>
	...
	const props = defineProps({
		...
		routeName : {
			type : String,
			default : 'antiguedadlist',
		},
		apiPath : {
			type : String,
			default : 'antiguedad/index',
		},
		paginate: {
			type: Boolean,
			default: true,
