                ...
                <div class="container-fluid">
                    <div class="row justify-between items-center q-col-gutter-md">
                        ...
                        <div  class="col-md-auto col-12 " >
                            <template v-if="auth.canView('/cursocolegio/add')">
                                <q-btn       :rounded="false"  size=""  color="primary" no-caps  unelevated   :to="`/cursocolegio/add`" class="" >
                        ...
                        <div >
                            <template v-if="showBreadcrumbs && $route.query.tag">
                                <q-breadcrumbs class="q-pa-md">
                                    <q-breadcrumbs-el icon="arrow_back" class="text-capitalize" :label="$route.query.tag" to="/cursocolegio"></q-breadcrumbs-el>
                            ...
                            <div >
                                ...
                                :bordered="false"
                                :columns="app.menus.CursocolegioListHeaderItems" 
                                :rows="records"
                                ...
                                <template v-slot:body="props">
                                    <q-tr :class="{selected: isCurrentRecord(props.row)}" :props="props">
                                                ...
                                                <q-btn icon="menu" padding="xs" round flat color="grey">
                                                    <q-menu auto-close transition-show="flip-right"  transition-hide="flip-left" self="center middle" anchor="center middle">
                                                        <q-list dense rounded nav>
                                                            <template v-if="auth.canView('cursocolegio/view')">
                                                                <q-item link clickable v-ripple :to="`/cursocolegio/view/${props.row.idcurso}`">
                                                                    <q-item-section>
                                                            ...
                                                            <template v-if="auth.canView('cursocolegio/edit')">
                                                                <q-item link clickable v-ripple :to="`/cursocolegio/edit/${props.row.idcurso}`">
                                                                    <q-item-section>
                                                            ...
                                                            <template v-if="auth.canView('cursocolegio/delete')">
                                                                <q-item link clickable v-ripple @click="deleteItem(props.row.idcurso)">
                                                                    <q-item-section>
                                        ...
                                        <q-td  key="idcurso" :props="props">
                                            <q-btn padding="xs"   :rounded="false"  color="primary"  no-caps  unelevated   flat :to="`/cursocolegio/view/${props.row.idcurso}`">{{ props.row.idcurso }}</q-btn>
                                        </q-td>
                                        <q-td  key="nombrecurso" :props="props">
                                            {{ props.row.nombrecurso }}
                                        </q-td>
                                        <q-td  key="abrevcurso" :props="props">
                                            {{ props.row.abrevcurso }}
                                        </q-td>
                                    </q-tr>
                                </template>
                                <!-- End of Table Layout-->
...
<script setup>
	...
	const props = defineProps({
		...
		pageName : {
			type : String,
			default : 'cursocolegio',
		},
		routeName : {
			type : String,
			default : 'cursocolegiolist',
		},
		apiPath : {
			type : String,
			default : 'cursocolegio/index',
		},
		paginate: {
			type: Boolean,
			default: true,
