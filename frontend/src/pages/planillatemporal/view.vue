                        ...
                        <div  class="col comp-grid" >
                            <div >
                                <div class="q-mb-3 row q-col-gutter-md justify-start">
                                    ...
                                    <div class="col-12 col-md-4">
                                        <q-card  class="q-pa-md nice-shadow-16">
                                            <div class="row q-col-gutter-x-md items-center">
                                                <div class="col">
                                                    <div class="text-grey text-weight-medium mb-1">Finicio</div>
                                                    <div class="text-bold">{{ item.finicio }}</div>
                                                </div>
                                            </div>
                                        </q-card>
                                    </div>
                                    <div class="col-12 col-md-4">
                                        <q-card  class="q-pa-md nice-shadow-16">
                                            <div class="row q-col-gutter-x-md items-center">
                                                <div class="col">
                                                    <div class="text-grey text-weight-medium mb-1">Ffinal</div>
                                                    <div class="text-bold">{{ item.ffinal }}</div>
                                                </div>
                                            </div>
                                        </q-card>
                                    </div>
                                    ...
                                    <div class="col-12 col-md-4">
                                        <q-card  class="q-pa-md nice-shadow-16">
                                            <div class="row q-col-gutter-x-md items-center">
                                                <div class="col">
                                                    <div class="text-grey text-weight-medium mb-1">Monto</div>
                                                    <div class="text-bold">{{ item.monto }}</div>
                                                </div>
                                            </div>
                                        </q-card>
                                    </div>
                                    <div class="col-12 col-md-4">
                                        <q-card  class="q-pa-md nice-shadow-16">
                                            <div class="row q-col-gutter-x-md items-center">
                                                <div class="col">
                                                    <div class="text-grey text-weight-medium mb-1">Salario</div>
                                                    <div class="text-bold">{{ item.salario }}</div>
                                                </div>
                                            </div>
                                        </q-card>
                                    </div>
                                    <div class="col-12 col-md-4">
                                        <q-card  class="q-pa-md nice-shadow-16">
                                            <div class="row q-col-gutter-x-md items-center">
                                                <div class="col">
                                                    <div class="text-grey text-weight-medium mb-1">Idplatmp</div>
                                                    <div class="text-bold">{{ item.idplatmp }}</div>
                                                </div>
                                            </div>
                                        </q-card>
                                    </div>
                                ...
                                <div class="row q-col-gutter-xs justify-start q-ma-md">
                                    <template v-if="auth.canView('planillatemporal/edit')">
                                        <div><q-btn icon="edit" label="Edit" glossy  flat :rounded="false"  no-caps  unelevated   padding="xs" color="positive" title="Editar"  @click="app.openPageDialog({ page:'planillatemporal/edit', url: `/planillatemporal/edit/${item.idplatmp}` , closeBtn: true })">
                                        </q-btn></div>
                                    </template>
                                    <template v-if="auth.canView('planillatemporal/delete')">
                                        <div><q-btn icon="delete_sweep" label="Delete" glossy  flat :rounded="false"  no-caps  unelevated   padding="xs" color="negative" title="Borrar"  @click="deleteItem(item.idplatmp)">
                                        </q-btn></div>
                                    </template>
                                </div>
                            </div>
...
<script setup>
	...
	const props = defineProps({
		...
		pageName: {
			type: String,
			default: 'planillatemporal',
		},
		routeName: {
			type: String,
			default: 'planillatemporalview',
		},
		apiPath: {
			type: String,
			default: 'planillatemporal/view',
		},
		editButton: {
			type: Boolean,
			default: true,
