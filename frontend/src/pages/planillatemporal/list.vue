                ...
                <div class="container-fluid">
                    <div class="row justify-between items-center q-col-gutter-md">
                        ...
                        <div  class="col-md-auto col-12 " >
                            <template v-if="auth.canView('/planillatemporal/add')">
                                <q-btn       :rounded="false"  size=""  color="primary" no-caps  unelevated   :to="`/planillatemporal/add`" class="" >
                        ...
                        <div >
                            <template v-if="showBreadcrumbs && $route.query.tag">
                                <q-breadcrumbs class="q-pa-md">
                                    <q-breadcrumbs-el icon="arrow_back" class="text-capitalize" :label="$route.query.tag" to="/planillatemporal"></q-breadcrumbs-el>
                            ...
                            <div >
                                ...
                                :bordered="false"
                                :columns="app.menus.PlanillatemporalListHeaderItems" 
                                :rows="records"
                                ...
                                <template v-slot:body="props">
                                    <q-tr :class="{selected: isCurrentRecord(props.row)}" :props="props">
                                        ...
                                        <q-td  key="finicio" :props="props">
                                            {{ props.row.finicio }}
                                        </q-td>
                                        <q-td  key="ffinal" :props="props">
                                            {{ props.row.ffinal }}
                                        </q-td>
                                        ...
                                        <q-td  key="salario" :props="props">
                                            {{ props.row.salario }}
                                        </q-td>
                                        <q-td  key="idplatmp" :props="props">
                                            <q-btn padding="xs"   :rounded="false"  color="primary"  no-caps  unelevated   flat :to="`/planillatemporal/view/${props.row.idplatmp}`">{{ props.row.idplatmp }}</q-btn>
                                        </q-td>
                                                ...
                                                <q-btn icon="menu" padding="xs" round flat color="grey">
                                                    <q-menu auto-close transition-show="flip-right"  transition-hide="flip-left" self="center middle" anchor="center middle">
                                                        <q-list dense rounded nav>
                                                            <template v-if="auth.canView('planillatemporal/view')">
                                                                <q-item link clickable v-ripple :to="`/planillatemporal/view/${props.row.idplatmp}`">
                                                                    <q-item-section>
                                                            ...
                                                            <template v-if="auth.canView('planillatemporal/edit')">
                                                                <q-item link clickable v-ripple :to="`/planillatemporal/edit/${props.row.idplatmp}`">
                                                                    <q-item-section>
                                                            ...
                                                            <template v-if="auth.canView('planillatemporal/delete')">
                                                                <q-item link clickable v-ripple @click="deleteItem(props.row.idplatmp)">
                                                                    <q-item-section>
...
<script setup>
	...
	const props = defineProps({
		...
		routeName : {
			type : String,
			default : 'planillatemporallist',
		},
		apiPath : {
			type : String,
			default : 'planillatemporal/index',
		},
		paginate: {
			type: Boolean,
			default: true,
