                ...
                <div class="container-fluid">
                    <div class="row justify-between items-center q-col-gutter-md">
                        ...
                        <div  class="col-md-auto col-12 " >
                            <template v-if="auth.canView('/evaluacion/add')">
                                <q-btn       :rounded="false"  size=""  color="primary" no-caps  unelevated   :to="`/evaluacion/add`" class="" >
                        ...
                        <div >
                            <template v-if="showBreadcrumbs && $route.query.tag">
                                <q-breadcrumbs class="q-pa-md">
                                    <q-breadcrumbs-el icon="arrow_back" class="text-capitalize" :label="$route.query.tag" to="/evaluacion"></q-breadcrumbs-el>
                            ...
                            <div class="row q-col-gutter-x-md q-col-gutter-md justify-start">
                                <div class="col">
                                    ...
                                    <div >
                                        ...
                                        :bordered="false"
                                        :columns="app.menus.EvaluacionListHeaderItems" 
                                        :rows="records"
                                        ...
                                        <template v-slot:body="props">
                                            <q-tr :class="{selected: isCurrentRecord(props.row)}" :props="props">
                                                ...
                                                <q-td  key="valacademico" :props="props">
                                                    {{ props.row.valacademico }}
                                                </q-td>
                                                <q-td  key="valespecifica" :props="props">
                                                    {{ props.row.valespecifica }}
                                                </q-td>
                                                <q-td  key="valgeneral" :props="props">
                                                    {{ props.row.valgeneral }}
                                                </q-td>
                                                <q-td  key="resultado" :props="props">
                                                    {{ props.row.resultado }}
                                                </q-td>
                                                <q-td  key="detespecifica" :props="props">
                                                    {{ props.row.detespecifica }}
                                                </q-td>
                                                <q-td  key="detgeneral" :props="props">
                                                    {{ props.row.detgeneral }}
                                                </q-td>
                                                <q-td  key="idevaluacion" :props="props">
                                                    <q-btn padding="xs"   :rounded="false"  color="primary"  no-caps  unelevated   flat :to="`/evaluacion/view/${props.row.idevaluacion}`">{{ props.row.idevaluacion }}</q-btn>
                                                </q-td>
                                                        ...
                                                        <q-btn icon="menu" padding="xs" round flat color="grey">
                                                            <q-menu auto-close transition-show="flip-right"  transition-hide="flip-left" self="center middle" anchor="center middle">
                                                                <q-list dense rounded nav>
                                                                    <template v-if="auth.canView('evaluacion/view')">
                                                                        <q-item link clickable v-ripple :to="`/evaluacion/view/${props.row.idevaluacion}`">
                                                                            <q-item-section>
                                                                    ...
                                                                    <template v-if="auth.canView('evaluacion/edit')">
                                                                        <q-item link clickable v-ripple :to="`/evaluacion/edit/${props.row.idevaluacion}`">
                                                                            <q-item-section>
                                                                    ...
                                                                    <template v-if="auth.canView('evaluacion/delete')">
                                                                        <q-item link clickable v-ripple @click="deleteItem(props.row.idevaluacion)">
                                                                            <q-item-section>
...
<script setup>
	...
	const props = defineProps({
		...
		routeName : {
			type : String,
			default : 'evaluacionlist',
		},
		apiPath : {
			type : String,
			default : 'evaluacion/index',
		},
		paginate: {
			type: Boolean,
			default: true,
