                                    ...
                                    <div class="row q-col-gutter-x-md">
                                        <div class="col-12">
                                            <div class="row">
                                                ...
                                                <div class="col-sm-9 col-12">
                                                    ...
                                                    <q-option-group  ref="ctrlhabilitado" v-model="formData.habilitado" :options="app.menus.habilitadoItems"  inline size="md" left-label></q-option-group>
                                                    </q-field>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-12">
                                            <div class="row">
                                                ...
                                                <div class="col-sm-9 col-12">
                                                    <q-input   ref="ctrlanyo" v-model.trim="formData.anyo"  label="Año" type="number" placeholder="Escribir Año"   step="any"    
