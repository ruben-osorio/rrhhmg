                ...
                <div class="container-fluid">
                    <div class="row justify-between items-center q-col-gutter-md">
                        ...
                        <div  class="col-md-auto col-12 " >
                            <template v-if="auth.canView('/cursos/add')">
                                <q-btn       :rounded="false"  size=""  color="primary" no-caps  unelevated   :to="`/cursos/add`" class="" >
                        ...
                        <div >
                            <template v-if="showBreadcrumbs && $route.query.tag">
                                <q-breadcrumbs class="q-pa-md">
                                    <q-breadcrumbs-el icon="arrow_back" class="text-capitalize" :label="$route.query.tag" to="/cursos"></q-breadcrumbs-el>
                            ...
                            <div >
                                ...
                                :bordered="false"
                                :columns="app.menus.CursosListHeaderItems" 
                                :rows="records"
                                ...
                                <template v-slot:body="props">
                                    <q-tr :class="{selected: isCurrentRecord(props.row)}" :props="props">
                                        ...
                                        <q-td  key="detperiodo" :props="props">
                                            {{ props.row.detperiodo }}
                                        </q-td>
                                        <q-td  key="horas" :props="props">
                                            {{ props.row.horas }}
                                        </q-td>
                                        <q-td  key="idcurso" :props="props">
                                            <q-btn padding="xs"   :rounded="false"  color="primary"  no-caps  unelevated   flat :to="`/cursos/view/${props.row.idcurso}`">{{ props.row.idcurso }}</q-btn>
                                        </q-td>
                                                ...
                                                <q-btn icon="menu" padding="xs" round flat color="grey">
                                                    <q-menu auto-close transition-show="flip-right"  transition-hide="flip-left" self="center middle" anchor="center middle">
                                                        <q-list dense rounded nav>
                                                            <template v-if="auth.canView('cursos/view')">
                                                                <q-item link clickable v-ripple :to="`/cursos/view/${props.row.idcurso}`">
                                                                    <q-item-section>
                                                            ...
                                                            <template v-if="auth.canView('cursos/edit')">
                                                                <q-item link clickable v-ripple :to="`/cursos/edit/${props.row.idcurso}`">
                                                                    <q-item-section>
