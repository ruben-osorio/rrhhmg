                ...
                <div class="container-fluid">
                    <div class="row justify-between items-center q-col-gutter-md">
                        ...
                        <div  class="col-md-auto col-12 " >
                            <template v-if="auth.canView('/eventuales/add')">
                                <q-btn       :rounded="false"  size=""  color="primary" no-caps  unelevated   :to="`/eventuales/add`" class="" >
                        ...
                        <div >
                            <template v-if="showBreadcrumbs && $route.query.tag">
                                <q-breadcrumbs class="q-pa-md">
                                    <q-breadcrumbs-el icon="arrow_back" class="text-capitalize" :label="$route.query.tag" to="/eventuales"></q-breadcrumbs-el>
                            ...
                            <div >
                                ...
                                :bordered="false"
                                :columns="app.menus.EventualesListHeaderItems" 
                                :rows="records"
                                ...
                                <template v-slot:body="props">
                                    <q-tr :class="{selected: isCurrentRecord(props.row)}" :props="props">
                                        ...
                                        <q-td  key="ideventual" :props="props">
                                            <q-btn padding="xs"   :rounded="false"  color="primary"  no-caps  unelevated   flat :to="`/eventuales/view/${props.row.ideventual}`">{{ props.row.ideventual }}</q-btn>
                                        </q-td>
                                        ...
                                        <q-td  key="codescala" :props="props">
                                            <q-btn v-if="props.row.codescala" @click="app.openPageDialog({ page: 'escala/view', url: `/escala/view/${props.row.codescala}` , closeBtn: true })" padding="xs" flat color="primary" no-caps >
                                                <q-icon name="visibility" size="xs"  class="q-mr-xs"></q-icon>  Escala
                                            </q-btn>
                                        </q-td>
                                        <q-td  key="codcontrol" :props="props">
                                            {{ props.row.codcontrol }}
                                        </q-td>
                                        ...
                                        <q-td  key="resolucion" :props="props">
                                                ...
                                                <q-btn icon="menu" padding="xs" round flat color="grey">
                                                    <q-menu auto-close transition-show="flip-right"  transition-hide="flip-left" self="center middle" anchor="center middle">
                                                        <q-list dense rounded nav>
                                                            <template v-if="auth.canView('eventuales/view')">
                                                                <q-item link clickable v-ripple :to="`/eventuales/view/${props.row.ideventual}`">
                                                                    <q-item-section>
                                                            ...
                                                            <template v-if="auth.canView('eventuales/edit')">
                                                                <q-item link clickable v-ripple :to="`/eventuales/edit/${props.row.ideventual}`">
                                                                    <q-item-section>
                                                            ...
                                                            <template v-if="auth.canView('eventuales/delete')">
                                                                <q-item link clickable v-ripple @click="deleteItem(props.row.ideventual)">
                                                                    <q-item-section>
...
<script setup>
	...
	const props = defineProps({
		...
		routeName : {
			type : String,
			default : 'eventualeslist',
		},
		apiPath : {
			type : String,
			default : 'eventuales/index',
		},
		paginate: {
			type: Boolean,
			default: true,
