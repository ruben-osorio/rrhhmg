                ...
                <div class="container-fluid">
                    <div class="row justify-between items-center q-col-gutter-md">
                        ...
                        <div  class="col-md-auto col-12 " >
                            <template v-if="auth.canView('/cas/add')">
                                <q-btn       :rounded="false"  size=""  color="primary" no-caps  unelevated   :to="`/cas/add`" class="" >
                        ...
                        <div >
                            <template v-if="showBreadcrumbs && $route.query.tag">
                                <q-breadcrumbs class="q-pa-md">
                                    <q-breadcrumbs-el icon="arrow_back" class="text-capitalize" :label="$route.query.tag" to="/cas"></q-breadcrumbs-el>
                            ...
                            <div class="row q-col-gutter-x-md q-col-gutter-md justify-start">
                                <div class="col">
                                    ...
                                    <div >
                                        ...
                                        :bordered="false"
                                        :columns="app.menus.CasListHeaderItems" 
                                        :rows="records"
                                        ...
                                        <template v-slot:body="props">
                                            <q-tr :class="{selected: isCurrentRecord(props.row)}" :props="props">
                                                        ...
                                                        <q-btn icon="menu" padding="xs" round flat color="grey">
                                                            <q-menu auto-close transition-show="flip-right"  transition-hide="flip-left" self="center middle" anchor="center middle">
                                                                <q-list dense rounded nav>
                                                                    <template v-if="auth.canView('cas/view')">
                                                                        <q-item link clickable v-ripple :to="`/cas/view/${props.row.id_cas}`">
                                                                            <q-item-section>
                                                                    ...
                                                                    <template v-if="auth.canView('cas/edit')">
                                                                        <q-item link clickable v-ripple :to="`/cas/edit/${props.row.id_cas}`">
                                                                            <q-item-section>
                                                                    ...
                                                                    <template v-if="auth.canView('cas/delete')">
                                                                        <q-item link clickable v-ripple @click="deleteItem(props.row.id_cas)">
                                                                            <q-item-section>
                                                ...
                                                <q-td  key="fecha_recepcion" :props="props">
                                                    {{$utils.humanDate( props.row.fecha_recepcion )}}
                                                </q-td>
                                                <q-td  key="anios_serv" :props="props">
                                                    {{ props.row.anios_serv }}
                                                </q-td>
                                                <q-td  key="meses_serv" :props="props">
                                                    {{ props.row.meses_serv }}
                                                </q-td>
                                                <q-td  key="dias_serv" :props="props">
                                                    {{ props.row.dias_serv }}
                                                </q-td>
                                                <q-td  key="monto_cas" :props="props">
                                                    {{ props.row.monto_cas }}
                                                </q-td>
                                                <q-td  key="incremento" :props="props">
                                                    {{ props.row.incremento }}
                                                </q-td>
                                            </q-tr>
                                        </template>
                                        <!-- End of Table Layout-->
