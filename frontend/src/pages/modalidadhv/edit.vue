                                        ...
                                        <div class="col-12">
                                            <div class="row">
                                                ...
                                                <div class="col-sm-9 col-12">
                                                    <q-input   ref="ctrlmodalidadhv" v-model.trim="formData.modalidadhv"  label="Modalidadhv" type="text" placeholder="Escribir Modalidadhv"      
                                                    class="" :error="isFieldValid('modalidadhv')" :error-message="getFieldError('modalidadhv')">
                                                    </q-input>
                                                </div>
                                            </div>
                                        </div>
...
<script setup>
	...
	const props = defineProps({
		...
		routeName: {
			type: String,
			default: 'modalidadhvedit',
		},
		pagePath: {
			type : String,
			default : 'modalidadhv/edit',
		},
		apiPath: {
			type: String,
			default: 'modalidadhv/edit',
