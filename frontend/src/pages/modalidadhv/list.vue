                ...
                <div class="container-fluid">
                    <div class="row justify-between items-center q-col-gutter-md">
                        ...
                        <div  class="col-md-auto col-12 " >
                            <template v-if="auth.canView('/modalidadhv/add')">
                                <q-btn       :rounded="false"  size=""  color="primary" no-caps  unelevated   :to="`/modalidadhv/add`" class="" >
                        ...
                        <div >
                            <template v-if="showBreadcrumbs && $route.query.tag">
                                <q-breadcrumbs class="q-pa-md">
                                    <q-breadcrumbs-el icon="arrow_back" class="text-capitalize" :label="$route.query.tag" to="/modalidadhv"></q-breadcrumbs-el>
                            ...
                            <div >
                                ...
                                :bordered="false"
                                :columns="app.menus.ModalidadhvListHeaderItems" 
                                :rows="records"
                                ...
                                <template v-slot:body="props">
                                    <q-tr :class="{selected: isCurrentRecord(props.row)}" :props="props">
                                                ...
                                                <q-btn icon="menu" padding="xs" round flat color="grey">
                                                    <q-menu auto-close transition-show="flip-right"  transition-hide="flip-left" self="center middle" anchor="center middle">
                                                        <q-list dense rounded nav>
                                                            <template v-if="auth.canView('modalidadhv/view')">
                                                                <q-item link clickable v-ripple :to="`/modalidadhv/view/${props.row.idmodhv}`">
                                                                    <q-item-section>
                                                            ...
                                                            <template v-if="auth.canView('modalidadhv/edit')">
                                                                <q-item link clickable v-ripple :to="`/modalidadhv/edit/${props.row.idmodhv}`">
                                                                    <q-item-section>
                                                            ...
                                                            <template v-if="auth.canView('modalidadhv/delete')">
                                                                <q-item link clickable v-ripple @click="deleteItem(props.row.idmodhv)">
                                                                    <q-item-section>
                                        ...
                                        <q-td  key="idmodhv" :props="props">
                                            <q-btn padding="xs"   :rounded="false"  color="primary"  no-caps  unelevated   flat :to="`/modalidadhv/view/${props.row.idmodhv}`">{{ props.row.idmodhv }}</q-btn>
                                        </q-td>
                                        <q-td  key="modalidadhv" :props="props">
                                            {{ props.row.modalidadhv }}
                                        </q-td>
                                    </q-tr>
                                </template>
                                <!-- End of Table Layout-->
...
<script setup>
	...
	const props = defineProps({
		...
		routeName : {
			type : String,
			default : 'modalidadhvlist',
		},
		apiPath : {
			type : String,
			default : 'modalidadhv/index',
		},
		paginate: {
			type: Boolean,
			default: true,
