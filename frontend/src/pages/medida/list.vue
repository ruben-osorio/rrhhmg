                ...
                <div class="container-fluid">
                    <div class="row justify-between items-center q-col-gutter-md">
                        ...
                        <div  class="col-md-auto col-12 " >
                            <template v-if="auth.canView('/medida/add')">
                                <q-btn       :rounded="false"  size=""  color="primary" no-caps  unelevated   :to="`/medida/add`" class="" >
                        ...
                        <div >
                            <template v-if="showBreadcrumbs && $route.query.tag">
                                <q-breadcrumbs class="q-pa-md">
                                    <q-breadcrumbs-el icon="arrow_back" class="text-capitalize" :label="$route.query.tag" to="/medida"></q-breadcrumbs-el>
                            ...
                            <div >
                                ...
                                :bordered="false"
                                :columns="app.menus.MedidaListHeaderItems" 
                                :rows="records"
                                ...
                                <template v-slot:body="props">
                                    <q-tr :class="{selected: isCurrentRecord(props.row)}" :props="props">
                                        ...
                                        <q-td  key="idmedida" :props="props">
                                            <q-btn padding="xs"   :rounded="false"  color="primary"  no-caps  unelevated   flat :to="`/medida/view/${props.row.idmedida}`">{{ props.row.idmedida }}</q-btn>
                                        </q-td>
                                                ...
                                                <q-btn icon="menu" padding="xs" round flat color="grey">
                                                    <q-menu auto-close transition-show="flip-right"  transition-hide="flip-left" self="center middle" anchor="center middle">
                                                        <q-list dense rounded nav>
                                                            <template v-if="auth.canView('medida/view')">
                                                                <q-item link clickable v-ripple :to="`/medida/view/${props.row.idmedida}`">
                                                                    <q-item-section>
                                                            ...
                                                            <template v-if="auth.canView('medida/edit')">
                                                                <q-item link clickable v-ripple :to="`/medida/edit/${props.row.idmedida}`">
                                                                    <q-item-section>
                                                            ...
                                                            <template v-if="auth.canView('medida/delete')">
                                                                <q-item link clickable v-ripple @click="deleteItem(props.row.idmedida)">
                                                                    <q-item-section>
