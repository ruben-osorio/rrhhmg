                ...
                <div class="container-fluid">
                    <div class="row justify-between items-center q-col-gutter-md">
                        ...
                        <div  class="col-md-auto col-12 " >
                            <template v-if="auth.canView('/decjurada/add')">
                                <q-btn       :rounded="false"  size=""  color="primary" no-caps  unelevated   :to="`/decjurada/add`" class="" >
                        ...
                        <div >
                            <template v-if="showBreadcrumbs && $route.query.tag">
                                <q-breadcrumbs class="q-pa-md">
                                    <q-breadcrumbs-el icon="arrow_back" class="text-capitalize" :label="$route.query.tag" to="/decjurada"></q-breadcrumbs-el>
                            ...
                            <div >
                                ...
                                :bordered="false"
                                :columns="app.menus.DecjuradaListHeaderItems" 
                                :rows="records"
                                ...
                                <template v-slot:body="props">
                                    <q-tr :class="{selected: isCurrentRecord(props.row)}" :props="props">
                                        ...
                                        <q-td  key="tercero" :props="props">
                                            {{ props.row.tercero }}
                                        </q-td>
                                        <q-td  key="idjurada" :props="props">
                                            <q-btn padding="xs"   :rounded="false"  color="primary"  no-caps  unelevated   flat :to="`/decjurada/view/${props.row.idjurada}`">{{ props.row.idjurada }}</q-btn>
                                        </q-td>
                                        ...
                                        <q-td  key="primero" :props="props">
                                            {{ props.row.primero }}
                                        </q-td>
                                        <q-td  key="segundo" :props="props">
                                            {{ props.row.segundo }}
                                        </q-td>
                                                ...
                                                <q-btn icon="menu" padding="xs" round flat color="grey">
                                                    <q-menu auto-close transition-show="flip-right"  transition-hide="flip-left" self="center middle" anchor="center middle">
                                                        <q-list dense rounded nav>
                                                            <template v-if="auth.canView('decjurada/view')">
                                                                <q-item link clickable v-ripple :to="`/decjurada/view/${props.row.idjurada}`">
                                                                    <q-item-section>
                                                            ...
                                                            <template v-if="auth.canView('decjurada/edit')">
                                                                <q-item link clickable v-ripple :to="`/decjurada/edit/${props.row.idjurada}`">
                                                                    <q-item-section>
                                                            ...
                                                            <template v-if="auth.canView('decjurada/delete')">
                                                                <q-item link clickable v-ripple @click="deleteItem(props.row.idjurada)">
                                                                    <q-item-section>
...
<script setup>
	...
	const props = defineProps({
		...
		routeName : {
			type : String,
			default : 'decjuradalist',
		},
		apiPath : {
			type : String,
			default : 'decjurada/index',
		},
		paginate: {
			type: Boolean,
			default: true,
