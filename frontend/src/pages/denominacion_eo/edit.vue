                                    ...
                                    <div class="row q-col-gutter-x-md">
                                        ...
                                        <div class="col-12">
                                            <div class="row">
                                                ...
                                                <div class="col-sm-9 col-12">
                                                    <q-input   ref="ctrlnombre_denom" v-model.trim="formData.nombre_denom"  label="Nombre Denom" type="text" placeholder="Escribir Nombre Denom"      
                                                    class="" :error="isFieldValid('nombre_denom')" :error-message="getFieldError('nombre_denom')">
                                                    </q-input>
                                                </div>
                                            </div>
                                        </div>
...
<script setup>
	...
	const props = defineProps({
		...
		routeName: {
			type: String,
			default: 'denominacion_eoedit',
		},
		pagePath: {
			type : String,
			default : 'denominacion_eo/edit',
		},
		apiPath: {
			type: String,
			default: 'denominacion_eo/edit',
	...
	function afterSubmit(response) {
		...
		if(app.isDialogOpen()){
			...
			app.navigateTo(`/denominacion_eo`);
		}
	}
