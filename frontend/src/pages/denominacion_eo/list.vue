                ...
                <div class="container-fluid">
                    <div class="row justify-between items-center q-col-gutter-md">
                        ...
                        <div  class="col-md-auto col-12 " >
                            <template v-if="auth.canView('/denominacion_eo/add')">
                                <q-btn       :rounded="false"  size=""  color="primary" no-caps  unelevated   :to="`/denominacion_eo/add`" class="" >
                        ...
                        <div >
                            <template v-if="showBreadcrumbs && $route.query.tag">
                                <q-breadcrumbs class="q-pa-md">
                                    <q-breadcrumbs-el icon="arrow_back" class="text-capitalize" :label="$route.query.tag" to="/denominacion_eo"></q-breadcrumbs-el>
                            ...
                            <div >
                                ...
                                :bordered="false"
                                :columns="app.menus.DenominacionEoListHeaderItems" 
                                :rows="records"
                                ...
                                <template v-slot:body="props">
                                    <q-tr :class="{selected: isCurrentRecord(props.row)}" :props="props">
                                                ...
                                                <q-btn icon="menu" padding="xs" round flat color="grey">
                                                    <q-menu auto-close transition-show="flip-right"  transition-hide="flip-left" self="center middle" anchor="center middle">
                                                        <q-list dense rounded nav>
                                                            <template v-if="auth.canView('denominacion_eo/view')">
                                                                <q-item link clickable v-ripple :to="`/denominacion_eo/view/${props.row.id_den_eo}`">
                                                                    <q-item-section>
                                                            ...
                                                            <template v-if="auth.canView('denominacion_eo/edit')">
                                                                <q-item link clickable v-ripple :to="`/denominacion_eo/edit/${props.row.id_den_eo}`">
                                                                    <q-item-section>
                                                            ...
                                                            <template v-if="auth.canView('denominacion_eo/delete')">
                                                                <q-item link clickable v-ripple @click="deleteItem(props.row.id_den_eo)">
                                                                    <q-item-section>
                                        ...
                                        <q-td  key="id_den_eo" :props="props">
                                            <q-btn padding="xs"   :rounded="false"  color="primary"  no-caps  unelevated   flat :to="`/denominacion_eo/view/${props.row.id_den_eo}`">{{ props.row.id_den_eo }}</q-btn>
                                        </q-td>
                                        <q-td  key="fecha_reg" :props="props">
                                            {{ props.row.fecha_reg }}
                                        </q-td>
                                        <q-td  key="nombre_denom" :props="props">
                                            {{ props.row.nombre_denom }}
                                        </q-td>
                                        <q-td  key="sigla" :props="props">
                                            {{ props.row.sigla }}
                                        </q-td>
                                        <q-td  key="cod_gestion" :props="props">
                                            {{ props.row.cod_gestion }}
                                        </q-td>
                                    </q-tr>
                                </template>
                                <!-- End of Table Layout-->
...
<script setup>
	...
	const props = defineProps({
		...
		pageName : {
			type : String,
			default : 'denominacion_eo',
		},
		routeName : {
			type : String,
			default : 'denominacion_eolist',
		},
		apiPath : {
			type : String,
			default : 'denominacion_eo/index',
		},
		paginate: {
			type: Boolean,
			default: true,
