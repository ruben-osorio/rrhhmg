                ...
                <div class="container-fluid">
                    <div class="row justify-between items-center q-col-gutter-md">
                        ...
                        <div  class="col-md-auto col-12 " >
                            <template v-if="auth.canView('/altashv/add')">
                                <q-btn       :rounded="false"  size=""  color="primary" no-caps  unelevated   :to="`/altashv/add`" class="" >
                        ...
                        <div >
                            <template v-if="showBreadcrumbs && $route.query.tag">
                                <q-breadcrumbs class="q-pa-md">
                                    <q-breadcrumbs-el icon="arrow_back" class="text-capitalize" :label="$route.query.tag" to="/altashv"></q-breadcrumbs-el>
                            ...
                            <div >
                                ...
                                :bordered="false"
                                :columns="app.menus.AltashvListHeaderItems" 
                                :rows="records"
                                ...
                                <template v-slot:body="props">
                                    <q-tr :class="{selected: isCurrentRecord(props.row)}" :props="props">
                                                ...
                                                <q-btn icon="menu" padding="xs" round flat color="grey">
                                                    <q-menu auto-close transition-show="flip-right"  transition-hide="flip-left" self="center middle" anchor="center middle">
                                                        <q-list dense rounded nav>
                                                            <template v-if="auth.canView('altashv/view')">
                                                                <q-item link clickable v-ripple :to="`/altashv/view/${props.row.idaltashv}`">
                                                                    <q-item-section>
                                                            ...
                                                            <template v-if="auth.canView('altashv/edit')">
                                                                <q-item link clickable v-ripple :to="`/altashv/edit/${props.row.idaltashv}`">
                                                                    <q-item-section>
                                                            ...
                                                            <template v-if="auth.canView('altashv/delete')">
                                                                <q-item link clickable v-ripple @click="deleteItem(props.row.idaltashv)">
                                                                    <q-item-section>
                                        ...
                                        <q-td  key="idaltashv" :props="props">
                                            <q-btn padding="xs"   :rounded="false"  color="primary"  no-caps  unelevated   flat :to="`/altashv/view/${props.row.idaltashv}`">{{ props.row.idaltashv }}</q-btn>
                                        </q-td>
                                        <q-td  key="cialtas" :props="props">
                                            {{ props.row.cialtas }}
                                        </q-td>
                                        <q-td  key="prinomaltas" :props="props">
                                            {{ props.row.prinomaltas }}
                                        </q-td>
                                        <q-td  key="segnomaltas" :props="props">
                                            {{ props.row.segnomaltas }}
                                        </q-td>
                                        <q-td  key="priapealtas" :props="props">
                                            {{ props.row.priapealtas }}
                                        </q-td>
                                        <q-td  key="segapealtas" :props="props">
                                            {{ props.row.segapealtas }}
                                        </q-td>
