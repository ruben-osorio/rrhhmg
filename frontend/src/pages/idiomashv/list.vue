                ...
                <div class="container-fluid">
                    <div class="row justify-between items-center q-col-gutter-md">
                        ...
                        <div  class="col-md-auto col-12 " >
                            <template v-if="auth.canView('/idiomashv/add')">
                                <q-btn       :rounded="false"  size=""  color="primary" no-caps  unelevated   :to="`/idiomashv/add`" class="" >
                        ...
                        <div >
                            <template v-if="showBreadcrumbs && $route.query.tag">
                                <q-breadcrumbs class="q-pa-md">
                                    <q-breadcrumbs-el icon="arrow_back" class="text-capitalize" :label="$route.query.tag" to="/idiomashv"></q-breadcrumbs-el>
                            ...
                            <div >
                                ...
                                :bordered="false"
                                :columns="app.menus.IdiomashvListHeaderItems" 
                                :rows="records"
                                ...
                                <template v-slot:body="props">
                                    <q-tr :class="{selected: isCurrentRecord(props.row)}" :props="props">
                                                ...
                                                <q-btn icon="menu" padding="xs" round flat color="grey">
                                                    <q-menu auto-close transition-show="flip-right"  transition-hide="flip-left" self="center middle" anchor="center middle">
                                                        <q-list dense rounded nav>
                                                            <template v-if="auth.canView('idiomashv/view')">
                                                                <q-item link clickable v-ripple :to="`/idiomashv/view/${props.row.idmas}`">
                                                                    <q-item-section>
                                                            ...
                                                            <template v-if="auth.canView('idiomashv/edit')">
                                                                <q-item link clickable v-ripple :to="`/idiomashv/edit/${props.row.idmas}`">
                                                                    <q-item-section>
                                                            ...
                                                            <template v-if="auth.canView('idiomashv/delete')">
                                                                <q-item link clickable v-ripple @click="deleteItem(props.row.idmas)">
                                                                    <q-item-section>
                                        ...
                                        <q-td  key="idmas" :props="props">
                                            <q-btn padding="xs"   :rounded="false"  color="primary"  no-caps  unelevated   flat :to="`/idiomashv/view/${props.row.idmas}`">{{ props.row.idmas }}</q-btn>
                                        </q-td>
                                        <q-td  key="idiomasnombres" :props="props">
                                            {{ props.row.idiomasnombres }}
                                        </q-td>
                                        <q-td  key="nativo" :props="props">
                                            {{ props.row.nativo }}
                                        </q-td>
                                        <q-td  key="extranjero" :props="props">
                                            {{ props.row.extranjero }}
                                        </q-td>
                                    </q-tr>
                                </template>
                                <!-- End of Table Layout-->
...
<script setup>
	...
	const props = defineProps({
		...
		routeName : {
			type : String,
			default : 'idiomashvlist',
		},
		apiPath : {
			type : String,
			default : 'idiomashv/index',
		},
		paginate: {
			type: Boolean,
			default: true,
