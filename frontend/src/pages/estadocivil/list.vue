                ...
                <div class="container-fluid">
                    <div class="row justify-between items-center q-col-gutter-md">
                        ...
                        <div  class="col-md-auto col-12 " >
                            <template v-if="auth.canView('/estadocivil/add')">
                                <q-btn       :rounded="false"  size=""  color="primary" no-caps  unelevated   :to="`/estadocivil/add`" class="" >
                        ...
                        <div >
                            <template v-if="showBreadcrumbs && $route.query.tag">
                                <q-breadcrumbs class="q-pa-md">
                                    <q-breadcrumbs-el icon="arrow_back" class="text-capitalize" :label="$route.query.tag" to="/estadocivil"></q-breadcrumbs-el>
                            ...
                            <div >
                                ...
                                :bordered="false"
                                :columns="app.menus.EstadocivilListHeaderItems" 
                                :rows="records"
                                ...
                                <template v-slot:body="props">
                                    <q-tr :class="{selected: isCurrentRecord(props.row)}" :props="props">
                                        ...
                                        <q-td  key="idestcivil" :props="props">
                                            <q-btn padding="xs"   :rounded="false"  color="primary"  no-caps  unelevated   flat :to="`/estadocivil/view/${props.row.idestcivil}`">{{ props.row.idestcivil }}</q-btn>
                                        </q-td>
                                        <q-td  key="nombrestciv" :props="props">
                                            {{ props.row.nombrestciv }}
                                        </q-td>
                                        <q-td  key="abrevciv" :props="props">
                                            {{ props.row.abrevciv }}
                                        </q-td>
                                                ...
                                                <q-btn icon="menu" padding="xs" round flat color="grey">
                                                    <q-menu auto-close transition-show="flip-right"  transition-hide="flip-left" self="center middle" anchor="center middle">
                                                        <q-list dense rounded nav>
                                                            <template v-if="auth.canView('estadocivil/view')">
                                                                <q-item link clickable v-ripple :to="`/estadocivil/view/${props.row.idestcivil}`">
                                                                    <q-item-section>
                                                            ...
                                                            <template v-if="auth.canView('estadocivil/edit')">
                                                                <q-item link clickable v-ripple :to="`/estadocivil/edit/${props.row.idestcivil}`">
                                                                    <q-item-section>
                                                            ...
                                                            <template v-if="auth.canView('estadocivil/delete')">
                                                                <q-item link clickable v-ripple @click="deleteItem(props.row.idestcivil)">
                                                                    <q-item-section>
...
<script setup>
	...
	const props = defineProps({
		...
		routeName : {
			type : String,
			default : 'estadocivillist',
		},
		apiPath : {
			type : String,
			default : 'estadocivil/index',
		},
		paginate: {
			type: Boolean,
			default: true,
