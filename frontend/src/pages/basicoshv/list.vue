                ...
                <div class="container-fluid">
                    <div class="row justify-between items-center q-col-gutter-md">
                        ...
                        <div  class="col-md-auto col-12 " >
                            <template v-if="auth.canView('/basicoshv/add')">
                                <q-btn       :rounded="false"  size=""  color="primary" no-caps  unelevated   :to="`/basicoshv/add`" class="" >
                        ...
                        <div >
                            <template v-if="showBreadcrumbs && $route.query.tag">
                                <q-breadcrumbs class="q-pa-md">
                                    <q-breadcrumbs-el icon="arrow_back" class="text-capitalize" :label="$route.query.tag" to="/basicoshv"></q-breadcrumbs-el>
                            ...
                            <div >
                                ...
                                :bordered="false"
                                :columns="app.menus.BasicoshvListHeaderItems" 
                                :rows="records"
                                ...
                                <template v-slot:body="props">
                                    <q-tr :class="{selected: isCurrentRecord(props.row)}" :props="props">
                                                ...
                                                <q-btn icon="menu" padding="xs" round flat color="grey">
                                                    <q-menu auto-close transition-show="flip-right"  transition-hide="flip-left" self="center middle" anchor="center middle">
                                                        <q-list dense rounded nav>
                                                            <template v-if="auth.canView('basicoshv/view')">
                                                                <q-item link clickable v-ripple :to="`/basicoshv/view/${props.row.id_bas}`">
                                                                    <q-item-section>
                                                            ...
                                                            <template v-if="auth.canView('basicoshv/edit')">
                                                                <q-item link clickable v-ripple :to="`/basicoshv/edit/${props.row.id_bas}`">
                                                                    <q-item-section>
                                                            ...
                                                            <template v-if="auth.canView('basicoshv/delete')">
                                                                <q-item link clickable v-ripple @click="deleteItem(props.row.id_bas)">
                                                                    <q-item-section>
                                        ...
                                        <q-td  key="id_bas" :props="props">
                                            <q-btn padding="xs"   :rounded="false"  color="primary"  no-caps  unelevated   flat :to="`/basicoshv/view/${props.row.id_bas}`">{{ props.row.id_bas }}</q-btn>
                                        </q-td>
                                        <q-td  key="nombre_bas" :props="props">
                                            {{ props.row.nombre_bas }}
                                        </q-td>
                                        <q-td  key="abrev_bas" :props="props">
                                            {{ props.row.abrev_bas }}
                                        </q-td>
                                    </q-tr>
                                </template>
...
<script setup>
	...
	const props = defineProps({
		...
		routeName : {
			type : String,
			default : 'basicoshvlist',
		},
		apiPath : {
			type : String,
			default : 'basicoshv/index',
		},
		paginate: {
			type: Boolean,
			default: true,
