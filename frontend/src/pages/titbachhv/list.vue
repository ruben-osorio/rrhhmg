                ...
                <div class="container-fluid">
                    <div class="row justify-between items-center q-col-gutter-md">
                        ...
                        <div  class="col-md-auto col-12 " >
                            <template v-if="auth.canView('/titbachhv/add')">
                                <q-btn       :rounded="false"  size=""  color="primary" no-caps  unelevated   :to="`/titbachhv/add`" class="" >
                        ...
                        <div >
                            <template v-if="showBreadcrumbs && $route.query.tag">
                                <q-breadcrumbs class="q-pa-md">
                                    <q-breadcrumbs-el icon="arrow_back" class="text-capitalize" :label="$route.query.tag" to="/titbachhv"></q-breadcrumbs-el>
                            ...
                            <div >
                                ...
                                :bordered="false"
                                :columns="app.menus.TitbachhvListHeaderItems" 
                                :rows="records"
                                ...
                                <template v-slot:body="props">
                                    <q-tr :class="{selected: isCurrentRecord(props.row)}" :props="props">
                                                ...
                                                <q-btn icon="menu" padding="xs" round flat color="grey">
                                                    <q-menu auto-close transition-show="flip-right"  transition-hide="flip-left" self="center middle" anchor="center middle">
                                                        <q-list dense rounded nav>
                                                            <template v-if="auth.canView('titbachhv/view')">
                                                                <q-item link clickable v-ripple :to="`/titbachhv/view/${props.row.idtitbach}`">
                                                                    <q-item-section>
                                                            ...
                                                            <template v-if="auth.canView('titbachhv/edit')">
                                                                <q-item link clickable v-ripple :to="`/titbachhv/edit/${props.row.idtitbach}`">
                                                                    <q-item-section>
                                                            ...
                                                            <template v-if="auth.canView('titbachhv/delete')">
                                                                <q-item link clickable v-ripple @click="deleteItem(props.row.idtitbach)">
                                                                    <q-item-section>
                                        ...
                                        <q-td  key="idtitbach" :props="props">
                                            <q-btn padding="xs"   :rounded="false"  color="primary"  no-caps  unelevated   flat :to="`/titbachhv/view/${props.row.idtitbach}`">{{ props.row.idtitbach }}</q-btn>
                                        </q-td>
                                        <q-td  key="tiene" :props="props">
                                            {{ props.row.tiene }}
                                        </q-td>
                                    </q-tr>
                                </template>
...
<script setup>
	...
	const props = defineProps({
		...
		routeName : {
			type : String,
			default : 'titbachhvlist',
		},
		apiPath : {
			type : String,
			default : 'titbachhv/index',
		},
		paginate: {
			type: Boolean,
			default: true,
