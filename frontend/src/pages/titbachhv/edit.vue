                                        ...
                                        <div class="col-12">
                                            <div class="row">
                                                ...
                                                <div class="col-sm-9 col-12">
                                                    <q-input   ref="ctrltiene" v-model.trim="formData.tiene"  label="Tiene" type="text" placeholder="Escribir Tiene"      
                                                    class="" :error="isFieldValid('tiene')" :error-message="getFieldError('tiene')">
                                                    </q-input>
                                                </div>
                                            </div>
                                        </div>
...
<script setup>
	...
	const props = defineProps({
		...
		routeName: {
			type: String,
			default: 'titbachhvedit',
		},
		pagePath: {
			type : String,
			default : 'titbachhv/edit',
		},
		apiPath: {
			type: String,
			default: 'titbachhv/edit',
