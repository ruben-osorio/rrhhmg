                ...
                <div class="container-fluid">
                    <div class="row justify-between items-center q-col-gutter-md">
                        ...
                        <div  class="col-md-auto col-12 " >
                            <template v-if="auth.canView('/planillas/add')">
                                <q-btn       :rounded="false"  size=""  color="primary" no-caps  unelevated   :to="`/planillas/add`" class="" >
                        ...
                        <div >
                            <template v-if="showBreadcrumbs && $route.query.tag">
                                <q-breadcrumbs class="q-pa-md">
                                    <q-breadcrumbs-el icon="arrow_back" class="text-capitalize" :label="$route.query.tag" to="/planillas"></q-breadcrumbs-el>
                            ...
                            <div >
                                ...
                                :bordered="false"
                                :columns="app.menus.PlanillasListHeaderItems" 
                                :rows="records"
                                ...
                                <template v-slot:body="props">
                                    <q-tr :class="{selected: isCurrentRecord(props.row)}" :props="props">
                                        ...
                                        <q-td  key="idpla" :props="props">
                                            <q-btn padding="xs"   :rounded="false"  color="primary"  no-caps  unelevated   flat :to="`/planillas/view/${props.row.idpla}`">{{ props.row.idpla }}</q-btn>
                                        </q-td>
                                                ...
                                                <q-btn icon="menu" padding="xs" round flat color="grey">
                                                    <q-menu auto-close transition-show="flip-right"  transition-hide="flip-left" self="center middle" anchor="center middle">
                                                        <q-list dense rounded nav>
                                                            <template v-if="auth.canView('planillas/view')">
                                                                <q-item link clickable v-ripple :to="`/planillas/view/${props.row.idpla}`">
                                                                    <q-item-section>
                                                            ...
                                                            <template v-if="auth.canView('planillas/edit')">
                                                                <q-item link clickable v-ripple :to="`/planillas/edit/${props.row.idpla}`">
                                                                    <q-item-section>
                                                            ...
                                                            <template v-if="auth.canView('planillas/delete')">
                                                                <q-item link clickable v-ripple @click="deleteItem(props.row.idpla)">
                                                                    <q-item-section>
...
<script setup>
	...
	const props = defineProps({
		...
		routeName : {
			type : String,
			default : 'planillaslist',
		},
		apiPath : {
			type : String,
			default : 'planillas/index',
		},
		paginate: {
			type: Boolean,
			default: true,
