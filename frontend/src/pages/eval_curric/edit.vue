                                        ...
                                        <div class="col-12">
                                            <div class="row">
                                                ...
                                                <div class="col-sm-9 col-12">
                                                    <q-input   ref="ctrllistado_hoja" v-model.trim="formData.listado_hoja"  label="Listado Hoja" type="text" placeholder="Escribir Listado Hoja"      
                                                    class="" :error="isFieldValid('listado_hoja')" :error-message="getFieldError('listado_hoja')">
                                                    </q-input>
                                                </div>
                                            </div>
                                        </div>
...
<script setup>
	...
	const props = defineProps({
		...
		routeName: {
			type: String,
			default: 'eval_curricedit',
		},
		pagePath: {
			type : String,
			default : 'eval_curric/edit',
		},
		apiPath: {
			type: String,
			default: 'eval_curric/edit',
