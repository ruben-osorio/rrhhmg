                ...
                <div class="container-fluid">
                    <div class="row justify-between items-center q-col-gutter-md">
                        ...
                        <div  class="col-md-auto col-12 " >
                            <template v-if="auth.canView('/eval_curric/add')">
                                <q-btn       :rounded="false"  size=""  color="primary" no-caps  unelevated   :to="`/eval_curric/add`" class="" >
                        ...
                        <div >
                            <template v-if="showBreadcrumbs && $route.query.tag">
                                <q-breadcrumbs class="q-pa-md">
                                    <q-breadcrumbs-el icon="arrow_back" class="text-capitalize" :label="$route.query.tag" to="/eval_curric"></q-breadcrumbs-el>
                            ...
                            <div >
                                ...
                                :bordered="false"
                                :columns="app.menus.EvalCurricListHeaderItems" 
                                :rows="records"
                                ...
                                <template v-slot:body="props">
                                    <q-tr :class="{selected: isCurrentRecord(props.row)}" :props="props">
                                                ...
                                                <q-btn icon="menu" padding="xs" round flat color="grey">
                                                    <q-menu auto-close transition-show="flip-right"  transition-hide="flip-left" self="center middle" anchor="center middle">
                                                        <q-list dense rounded nav>
                                                            <template v-if="auth.canView('eval_curric/view')">
                                                                <q-item link clickable v-ripple :to="`/eval_curric/view/${props.row.id_ec}`">
                                                                    <q-item-section>
                                                            ...
                                                            <template v-if="auth.canView('eval_curric/edit')">
                                                                <q-item link clickable v-ripple :to="`/eval_curric/edit/${props.row.id_ec}`">
                                                                    <q-item-section>
                                                            ...
                                                            <template v-if="auth.canView('eval_curric/delete')">
                                                                <q-item link clickable v-ripple @click="deleteItem(props.row.id_ec)">
                                                                    <q-item-section>
                                        ...
                                        <q-td  key="id_ec" :props="props">
                                            <q-btn padding="xs"   :rounded="false"  color="primary"  no-caps  unelevated   flat :to="`/eval_curric/view/${props.row.id_ec}`">{{ props.row.id_ec }}</q-btn>
                                        </q-td>
                                        <q-td  key="listado_hoja" :props="props">
                                            {{ props.row.listado_hoja }}
                                        </q-td>
                                    </q-tr>
                                </template>
                                <!-- End of Table Layout-->
...
<script setup>
	...
	const props = defineProps({
		...
		routeName : {
			type : String,
			default : 'eval_curriclist',
		},
		apiPath : {
			type : String,
			default : 'eval_curric/index',
		},
		paginate: {
			type: Boolean,
			default: true,
