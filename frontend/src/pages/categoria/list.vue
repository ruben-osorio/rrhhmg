                ...
                <div class="container-fluid">
                    <div class="row justify-between items-center q-col-gutter-md">
                        ...
                        <div  class="col-md-auto col-12 " >
                            <template v-if="auth.canView('/categoria/add')">
                                <q-btn       :rounded="false"  size=""  color="primary" no-caps  unelevated   :to="`/categoria/add`" class="" >
                        ...
                        <div >
                            <template v-if="showBreadcrumbs && $route.query.tag">
                                <q-breadcrumbs class="q-pa-md">
                                    <q-breadcrumbs-el icon="arrow_back" class="text-capitalize" :label="$route.query.tag" to="/categoria"></q-breadcrumbs-el>
                            ...
                            <div >
                                ...
                                :bordered="false"
                                :columns="app.menus.CategoriaListHeaderItems" 
                                :rows="records"
                                ...
                                <template v-slot:body="props">
                                    <q-tr :class="{selected: isCurrentRecord(props.row)}" :props="props">
                                        ...
                                        <q-td  key="idcategoria" :props="props">
                                            <q-btn padding="xs"   :rounded="false"  color="primary"  no-caps  unelevated   flat :to="`/categoria/view/${props.row.idcategoria}`">{{ props.row.idcategoria }}</q-btn>
                                        </q-td>
                                                ...
                                                <q-btn icon="menu" padding="xs" round flat color="grey">
                                                    <q-menu auto-close transition-show="flip-right"  transition-hide="flip-left" self="center middle" anchor="center middle">
                                                        <q-list dense rounded nav>
                                                            <template v-if="auth.canView('categoria/view')">
                                                                <q-item link clickable v-ripple :to="`/categoria/view/${props.row.idcategoria}`">
                                                                    <q-item-section>
                                                            ...
                                                            <template v-if="auth.canView('categoria/edit')">
                                                                <q-item link clickable v-ripple :to="`/categoria/edit/${props.row.idcategoria}`">
                                                                    <q-item-section>
                                                            ...
                                                            <template v-if="auth.canView('categoria/delete')">
                                                                <q-item link clickable v-ripple @click="deleteItem(props.row.idcategoria)">
                                                                    <q-item-section>
...
<script setup>
	...
	const props = defineProps({
		...
		routeName : {
			type : String,
			default : 'categorialist',
		},
		apiPath : {
			type : String,
			default : 'categoria/index',
		},
		paginate: {
			type: Boolean,
			default: true,
