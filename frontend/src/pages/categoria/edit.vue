                                    ...
                                    <div class="row q-col-gutter-x-md">
                                        ...
                                        <div class="col-12">
                                            <div class="row">
                                                ...
                                                <div class="col-sm-9 col-12">
                                                    <q-input   ref="ctrlprefijo" v-model.trim="formData.prefijo"  label="Prefijo" type="text" placeholder="Escribir Prefijo"      
                                                    class="" :error="isFieldValid('prefijo')" :error-message="getFieldError('prefijo')">
                                                    </q-input>
                                                </div>
                                            </div>
                                        </div>
...
<script setup>
	...
	const props = defineProps({
		...
		routeName: {
			type: String,
			default: 'categoriaedit',
		},
		pagePath: {
			type : String,
			default : 'categoria/edit',
		},
		apiPath: {
			type: String,
			default: 'categoria/edit',
