                ...
                <div class="container-fluid">
                    <div class="row justify-between items-center q-col-gutter-md">
                        ...
                        <div  class="col-md-auto col-12 " >
                            <template v-if="auth.canView('/plantillauo/add')">
                                <q-btn       :rounded="false"  size=""  color="primary" no-caps  unelevated   :to="`/plantillauo/add`" class="" >
                        ...
                        <div >
                            <template v-if="showBreadcrumbs && $route.query.tag">
                                <q-breadcrumbs class="q-pa-md">
                                    <q-breadcrumbs-el icon="arrow_back" class="text-capitalize" :label="$route.query.tag" to="/plantillauo"></q-breadcrumbs-el>
                            ...
                            <div >
                                ...
                                :bordered="false"
                                :columns="app.menus.PlantillauoListHeaderItems" 
                                :rows="records"
                                ...
                                <template v-slot:body="props">
                                    <q-tr :class="{selected: isCurrentRecord(props.row)}" :props="props">
                                                ...
                                                <q-btn icon="menu" padding="xs" round flat color="grey">
                                                    <q-menu auto-close transition-show="flip-right"  transition-hide="flip-left" self="center middle" anchor="center middle">
                                                        <q-list dense rounded nav>
                                                            <template v-if="auth.canView('plantillauo/view')">
                                                                <q-item link clickable v-ripple :to="`/plantillauo/view/${props.row.idpuo}`">
                                                                    <q-item-section>
                                                            ...
                                                            <template v-if="auth.canView('plantillauo/edit')">
                                                                <q-item link clickable v-ripple :to="`/plantillauo/edit/${props.row.idpuo}`">
                                                                    <q-item-section>
                                        ...
                                        <q-td  key="soa_nombre" :props="props">
                                            {{ props.row.soa_nombre }}
                                        </q-td>
                                    </q-tr>
                                </template>
                                <!-- End of Table Layout-->
                                    ...
                                    <div class="q-pa-md" v-show="pageReady">
                                        <div class="row items-center justify-between">
                                            <div class="row items-center q-col-gutter-md">
                                                ...
                                                <template v-if="auth.canView('plantillauo/importdata')">
                                                    <div>
                                                        <import-data label="Seleccione un archivo para importar" ref="dataimport" upload-path="plantillauo/importdata" @importComplete="importComplete">
...
<script setup>
	...
	const props = defineProps({
		...
		routeName : {
			type : String,
			default : 'plantillauolist',
		},
		apiPath : {
			type : String,
			default : 'plantillauo/index',
		},
		paginate: {
			type: Boolean,
			default: true,
