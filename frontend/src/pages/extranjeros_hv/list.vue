                ...
                <div class="container-fluid">
                    <div class="row justify-between items-center q-col-gutter-md">
                        ...
                        <div  class="col-md-auto col-12 " >
                            <template v-if="auth.canView('/extranjeros_hv/add')">
                                <q-btn       :rounded="false"  size=""  color="primary" no-caps  unelevated   :to="`/extranjeros_hv/add`" class="" >
                        ...
                        <div >
                            <template v-if="showBreadcrumbs && $route.query.tag">
                                <q-breadcrumbs class="q-pa-md">
                                    <q-breadcrumbs-el icon="arrow_back" class="text-capitalize" :label="$route.query.tag" to="/extranjeros_hv"></q-breadcrumbs-el>
                            ...
                            <div >
                                ...
                                :bordered="false"
                                :columns="app.menus.ExtranjerosHvListHeaderItems" 
                                :rows="records"
                                ...
                                <template v-slot:body="props">
                                    <q-tr :class="{selected: isCurrentRecord(props.row)}" :props="props">
                                                ...
                                                <q-btn icon="menu" padding="xs" round flat color="grey">
                                                    <q-menu auto-close transition-show="flip-right"  transition-hide="flip-left" self="center middle" anchor="center middle">
                                                        <q-list dense rounded nav>
                                                            <template v-if="auth.canView('extranjeros_hv/view')">
                                                                <q-item link clickable v-ripple :to="`/extranjeros_hv/view/${props.row.id_extran_hv}`">
                                                                    <q-item-section>
                                                            ...
                                                            <template v-if="auth.canView('extranjeros_hv/edit')">
                                                                <q-item link clickable v-ripple :to="`/extranjeros_hv/edit/${props.row.id_extran_hv}`">
                                                                    <q-item-section>
                                                            ...
                                                            <template v-if="auth.canView('extranjeros_hv/delete')">
                                                                <q-item link clickable v-ripple @click="deleteItem(props.row.id_extran_hv)">
                                                                    <q-item-section>
                                        ...
                                        <q-td  key="id_extran_hv" :props="props">
                                            <q-btn padding="xs"   :rounded="false"  color="primary"  no-caps  unelevated   flat :to="`/extranjeros_hv/view/${props.row.id_extran_hv}`">{{ props.row.id_extran_hv }}</q-btn>
                                        </q-td>
                                        <q-td  key="nom_hv" :props="props">
                                            {{ props.row.nom_hv }}
                                        </q-td>
                                        <q-td  key="abrev_hv" :props="props">
                                            {{ props.row.abrev_hv }}
                                        </q-td>
                                    </q-tr>
                                </template>
...
<script setup>
	...
	const props = defineProps({
		primaryKey : {
			type : String,
			default : 'id_extran_hv',
		},
		pageName : {
			type : String,
			default : 'extranjeros_hv',
		},
		routeName : {
			type : String,
			default : 'extranjeros_hvlist',
		},
		apiPath : {
			type : String,
			default : 'extranjeros_hv/index',
		},
		paginate: {
			type: Boolean,
			default: true,
