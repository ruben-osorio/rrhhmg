                    ...
                    <div  class="col comp-grid" >
                        ...
                        <div >
                            ...
                            <div >
                                ...
                                :bordered="false"
                                :columns="app.menus.DenominacionVistaHeaderItems" 
                                :rows="records"
                                ...
                                <template v-slot:body="props">
                                    <q-tr :class="{selected: isCurrentRecord(props.row)}" :props="props">
                                                ...
                                                <q-btn icon="menu" padding="xs" round flat color="grey">
                                                    <q-menu auto-close transition-show="flip-right"  transition-hide="flip-left" self="center middle" anchor="center middle">
                                                        <q-list dense rounded nav>
                                                            <template v-if="auth.canView('denominacion/view')">
                                                                <q-item link clickable v-ripple :to="`/denominacion/view/${props.row.id_denominacion}`">
                                                                    <q-item-section>
                                        ...
                                        <q-td  key="id_denominacion" :props="props">
                                            <q-btn padding="xs"   :rounded="false"  color="primary"  no-caps  unelevated   flat :to="`/denominacion/view/${props.row.id_denominacion}`">{{ props.row.id_denominacion }}</q-btn>
                                        </q-td>
...
<script setup>
	...
	const props = defineProps({
		...
		routeName : {
			type : String,
			default : 'denominacionvistainte',
		},
		apiPath : {
			type : String,
			default : 'denominacion/vistainte',
		},
		paginate: {
			type: Boolean,
			default: true,
