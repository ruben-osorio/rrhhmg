                ...
                <div class="container-fluid">
                    <div class="row justify-between items-center q-col-gutter-md">
                        ...
                        <div  class="col-md-auto col-12 " >
                            <template v-if="auth.canView('/nativos_hv/add')">
                                <q-btn       :rounded="false"  size=""  color="primary" no-caps  unelevated   :to="`/nativos_hv/add`" class="" >
                        ...
                        <div >
                            <template v-if="showBreadcrumbs && $route.query.tag">
                                <q-breadcrumbs class="q-pa-md">
                                    <q-breadcrumbs-el icon="arrow_back" class="text-capitalize" :label="$route.query.tag" to="/nativos_hv"></q-breadcrumbs-el>
                            ...
                            <div >
                                ...
                                :bordered="false"
                                :columns="app.menus.NativosHvListHeaderItems" 
                                :rows="records"
                                ...
                                <template v-slot:body="props">
                                    <q-tr :class="{selected: isCurrentRecord(props.row)}" :props="props">
                                                ...
                                                <q-btn icon="menu" padding="xs" round flat color="grey">
                                                    <q-menu auto-close transition-show="flip-right"  transition-hide="flip-left" self="center middle" anchor="center middle">
                                                        <q-list dense rounded nav>
                                                            <template v-if="auth.canView('nativos_hv/view')">
                                                                <q-item link clickable v-ripple :to="`/nativos_hv/view/${props.row.id_nativo_hv}`">
                                                                    <q-item-section>
                                                            ...
                                                            <template v-if="auth.canView('nativos_hv/edit')">
                                                                <q-item link clickable v-ripple :to="`/nativos_hv/edit/${props.row.id_nativo_hv}`">
                                                                    <q-item-section>
                                                            ...
                                                            <template v-if="auth.canView('nativos_hv/delete')">
                                                                <q-item link clickable v-ripple @click="deleteItem(props.row.id_nativo_hv)">
                                                                    <q-item-section>
                                        ...
                                        <q-td  key="id_nativo_hv" :props="props">
                                            <q-btn padding="xs"   :rounded="false"  color="primary"  no-caps  unelevated   flat :to="`/nativos_hv/view/${props.row.id_nativo_hv}`">{{ props.row.id_nativo_hv }}</q-btn>
                                        </q-td>
...
<script setup>
	...
	const props = defineProps({
		...
		routeName : {
			type : String,
			default : 'nativos_hvlist',
		},
		apiPath : {
			type : String,
			default : 'nativos_hv/index',
		},
		paginate: {
			type: Boolean,
			default: true,
