                    ...
                    <div class="row justify-between items-center q-col-gutter-md">
                        ...
                        <div  class="col-md-auto col-12 " >
                            <template v-if="auth.canView('/estructura_org/add')">
                                <q-btn       :rounded="false"  size=""  color="primary" no-caps  unelevated   :to="`/estructura_org/add`" class="" >
                                                    ...
                                                    <q-menu auto-close transition-show="flip-right"  transition-hide="flip-left" self="center middle" anchor="center middle">
                                                        <q-list dense rounded nav>
                                                            ...
                                                            <template v-if="auth.canManage('estructura_org/edit', props.row.idunidad)">
                                                                <q-item link clickable v-ripple :to="`/estructura_org/edit/${props.row.idunidad}`">
                                                                    <q-item-section>
