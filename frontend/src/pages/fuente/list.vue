                ...
                <div class="container-fluid">
                    <div class="row justify-between items-center q-col-gutter-md">
                        ...
                        <div  class="col-md-auto col-12 " >
                            <template v-if="auth.canView('/fuente/add')">
                                <q-btn       :rounded="false"  size=""  color="primary" no-caps  unelevated   :to="`/fuente/add`" class="" >
                        ...
                        <div >
                            <template v-if="showBreadcrumbs && $route.query.tag">
                                <q-breadcrumbs class="q-pa-md">
                                    <q-breadcrumbs-el icon="arrow_back" class="text-capitalize" :label="$route.query.tag" to="/fuente"></q-breadcrumbs-el>
                            ...
                            <div >
                                ...
                                :bordered="false"
                                :columns="app.menus.FuenteListHeaderItems" 
                                :rows="records"
                                ...
                                <template v-slot:body="props">
                                    <q-tr :class="{selected: isCurrentRecord(props.row)}" :props="props">
                                                    ...
                                                    <q-menu auto-close transition-show="flip-right"  transition-hide="flip-left" self="center middle" anchor="center middle">
                                                        <q-list dense rounded nav>
                                                            <template v-if="auth.canView('fuente/edit')">
                                                                <q-item link clickable v-ripple :to="`/fuente/edit/${props.row.idfuente}`">
                                                                    <q-item-section>
                                                            ...
                                                            <template v-if="auth.canView('fuente/delete')">
                                                                <q-item link clickable v-ripple @click="deleteItem(props.row.idfuente)">
                                                                    <q-item-section>
                                        ...
                                        <q-td  key="fuente_desc" :props="props">
                                            {{ props.row.fuente_desc }}
                                        </q-td>
                                        <q-td  key="fuente_resumen" :props="props">
                                            {{ props.row.fuente_resumen }}
                                        </q-td>
                                    </q-tr>
                                </template>
                                <!-- End of Table Layout-->
