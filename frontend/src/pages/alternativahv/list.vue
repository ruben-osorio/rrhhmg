                ...
                <div class="container-fluid">
                    <div class="row justify-between items-center q-col-gutter-md">
                        ...
                        <div  class="col-md-auto col-12 " >
                            <template v-if="auth.canView('/alternativahv/add')">
                                <q-btn       :rounded="false"  size=""  color="primary" no-caps  unelevated   :to="`/alternativahv/add`" class="" >
                        ...
                        <div >
                            <template v-if="showBreadcrumbs && $route.query.tag">
                                <q-breadcrumbs class="q-pa-md">
                                    <q-breadcrumbs-el icon="arrow_back" class="text-capitalize" :label="$route.query.tag" to="/alternativahv"></q-breadcrumbs-el>
                            ...
                            <div >
                                ...
                                :bordered="false"
                                :columns="app.menus.AlternativahvListHeaderItems" 
                                :rows="records"
                                ...
                                <template v-slot:body="props">
                                    <q-tr :class="{selected: isCurrentRecord(props.row)}" :props="props">
                                                ...
                                                <q-btn icon="menu" padding="xs" round flat color="grey">
                                                    <q-menu auto-close transition-show="flip-right"  transition-hide="flip-left" self="center middle" anchor="center middle">
                                                        <q-list dense rounded nav>
                                                            <template v-if="auth.canView('alternativahv/view')">
                                                                <q-item link clickable v-ripple :to="`/alternativahv/view/${props.row.id_altern_hv}`">
                                                                    <q-item-section>
                                                            ...
                                                            <template v-if="auth.canView('alternativahv/edit')">
                                                                <q-item link clickable v-ripple :to="`/alternativahv/edit/${props.row.id_altern_hv}`">
                                                                    <q-item-section>
                                                            ...
                                                            <template v-if="auth.canView('alternativahv/delete')">
                                                                <q-item link clickable v-ripple @click="deleteItem(props.row.id_altern_hv)">
                                                                    <q-item-section>
                                        ...
                                        <q-td  key="id_altern_hv" :props="props">
                                            <q-btn padding="xs"   :rounded="false"  color="primary"  no-caps  unelevated   flat :to="`/alternativahv/view/${props.row.id_altern_hv}`">{{ props.row.id_altern_hv }}</q-btn>
                                        </q-td>
                                        <q-td  key="nombrealterhv" :props="props">
                                            {{ props.row.nombrealterhv }}
                                        </q-td>
                                        <q-td  key="numeralhv" :props="props">
                                            {{ props.row.numeralhv }}
                                        </q-td>
                                    </q-tr>
                                </template>
...
<script setup>
	...
	const props = defineProps({
		primaryKey : {
			type : String,
			default : 'id_altern_hv',
		},
		pageName : {
			type : String,
			default : 'alternativahv',
		},
		routeName : {
			type : String,
			default : 'alternativahvlist',
		},
		apiPath : {
			type : String,
			default : 'alternativahv/index',
		},
		paginate: {
			type: Boolean,
			default: true,
