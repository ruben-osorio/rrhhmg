                ...
                <div class="container-fluid">
                    <div class="row justify-between items-center q-col-gutter-md">
                        ...
                        <div  class="col-md-auto col-12 " >
                            <template v-if="auth.canView('/cursoshv/add')">
                                <q-btn       :rounded="false"  size=""  color="primary" no-caps  unelevated   :to="`/cursoshv/add`" class="" >
                        ...
                        <div >
                            <template v-if="showBreadcrumbs && $route.query.tag">
                                <q-breadcrumbs class="q-pa-md">
                                    <q-breadcrumbs-el icon="arrow_back" class="text-capitalize" :label="$route.query.tag" to="/cursoshv"></q-breadcrumbs-el>
                            ...
                            <div >
                                ...
                                :bordered="false"
                                :columns="app.menus.CursoshvListHeaderItems" 
                                :rows="records"
                                ...
                                <template v-slot:body="props">
                                    <q-tr :class="{selected: isCurrentRecord(props.row)}" :props="props">
                                                ...
                                                <q-btn icon="menu" padding="xs" round flat color="grey">
                                                    <q-menu auto-close transition-show="flip-right"  transition-hide="flip-left" self="center middle" anchor="center middle">
                                                        <q-list dense rounded nav>
                                                            <template v-if="auth.canView('cursoshv/view')">
                                                                <q-item link clickable v-ripple :to="`/cursoshv/view/${props.row.idcursoshv}`">
                                                                    <q-item-section>
                                                            ...
                                                            <template v-if="auth.canView('cursoshv/edit')">
                                                                <q-item link clickable v-ripple :to="`/cursoshv/edit/${props.row.idcursoshv}`">
                                                                    <q-item-section>
                                                            ...
                                                            <template v-if="auth.canView('cursoshv/delete')">
                                        ...
                                        <q-td  key="idcursoshv" :props="props">
                                            <q-btn padding="xs"   :rounded="false"  color="primary"  no-caps  unelevated   flat :to="`/cursoshv/view/${props.row.idcursoshv}`">{{ props.row.idcursoshv }}</q-btn>
                                        </q-td>
...
<script setup>
	...
	const props = defineProps({
		...
		routeName : {
			type : String,
			default : 'cursoshvlist',
		},
		apiPath : {
			type : String,
			default : 'cursoshv/index',
		},
		paginate: {
			type: Boolean,
			default: true,
