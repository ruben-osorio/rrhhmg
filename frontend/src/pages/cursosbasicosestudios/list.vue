                ...
                <div class="container-fluid">
                    <div class="row justify-between items-center q-col-gutter-md">
                        ...
                        <div  class="col-md-auto col-12 " >
                            <template v-if="auth.canView('/cursosbasicosestudios/add')">
                                <q-btn       :rounded="false"  size=""  color="primary" no-caps  unelevated   :to="`/cursosbasicosestudios/add`" class="" >
                        ...
                        <div >
                            <template v-if="showBreadcrumbs && $route.query.tag">
                                <q-breadcrumbs class="q-pa-md">
                                    <q-breadcrumbs-el icon="arrow_back" class="text-capitalize" :label="$route.query.tag" to="/cursosbasicosestudios"></q-breadcrumbs-el>
                            ...
                            <div >
                                ...
                                :bordered="false"
                                :columns="app.menus.CursosbasicosestudiosListHeaderItems" 
                                :rows="records"
                                ...
                                <template v-slot:body="props">
                                    <q-tr :class="{selected: isCurrentRecord(props.row)}" :props="props">
                                        ...
                                        <q-td  key="idbasicosestudios" :props="props">
                                            <q-btn padding="xs"   :rounded="false"  color="primary"  no-caps  unelevated   flat :to="`/cursosbasicosestudios/view/${props.row.idbasicosestudios}`">{{ props.row.idbasicosestudios }}</q-btn>
                                        </q-td>
                                        <q-td  key="gestioncursobasico" :props="props">
                                            {{ props.row.gestioncursobasico }}
                                        </q-td>
                                        <q-td  key="nombrecursobasico" :props="props">
                                            {{ props.row.nombrecursobasico }}
                                        </q-td>
                                        <q-td  key="lugarcursobasico" :props="props">
                                            {{ props.row.lugarcursobasico }}
                                        </q-td>
                                        <q-td  key="certcursobasico" :props="props">
                                            {{ props.row.certcursobasico }}
                                        </q-td>
                                                ...
                                                <q-btn icon="menu" padding="xs" round flat color="grey">
                                                    <q-menu auto-close transition-show="flip-right"  transition-hide="flip-left" self="center middle" anchor="center middle">
                                                        <q-list dense rounded nav>
                                                            <template v-if="auth.canView('cursosbasicosestudios/view')">
                                                                <q-item link clickable v-ripple :to="`/cursosbasicosestudios/view/${props.row.idbasicosestudios}`">
                                                                    <q-item-section>
                                                            ...
                                                            <template v-if="auth.canView('cursosbasicosestudios/edit')">
                                                                <q-item link clickable v-ripple :to="`/cursosbasicosestudios/edit/${props.row.idbasicosestudios}`">
                                                                    <q-item-section>
                                                            ...
                                                            <template v-if="auth.canView('cursosbasicosestudios/delete')">
                                                                <q-item link clickable v-ripple @click="deleteItem(props.row.idbasicosestudios)">
                                                                    <q-item-section>
...
<script setup>
	...
	const props = defineProps({
		primaryKey : {
			type : String,
			default : 'idbasicosestudios',
		},
		pageName : {
			type : String,
			default : 'cursosbasicosestudios',
		},
		routeName : {
			type : String,
			default : 'cursosbasicosestudioslist',
		},
		apiPath : {
			type : String,
			default : 'cursosbasicosestudios/index',
		},
		paginate: {
			type: Boolean,
			default: true,
