                ...
                <div class="container-fluid">
                    <div class="row justify-between items-center q-col-gutter-md">
                        ...
                        <div  class="col-md-auto col-12 " >
                            <template v-if="auth.canView('/postgradohv/add')">
                                <q-btn       :rounded="false"  size=""  color="primary" no-caps  unelevated   :to="`/postgradohv/add`" class="" >
                        ...
                        <div >
                            <template v-if="showBreadcrumbs && $route.query.tag">
                                <q-breadcrumbs class="q-pa-md">
                                    <q-breadcrumbs-el icon="arrow_back" class="text-capitalize" :label="$route.query.tag" to="/postgradohv"></q-breadcrumbs-el>
                            ...
                            <div >
                                ...
                                :bordered="false"
                                :columns="app.menus.PostgradohvListHeaderItems" 
                                :rows="records"
                                ...
                                <template v-slot:body="props">
                                    <q-tr :class="{selected: isCurrentRecord(props.row)}" :props="props">
                                                ...
                                                <q-btn icon="menu" padding="xs" round flat color="grey">
                                                    <q-menu auto-close transition-show="flip-right"  transition-hide="flip-left" self="center middle" anchor="center middle">
                                                        <q-list dense rounded nav>
                                                            <template v-if="auth.canView('postgradohv/view')">
                                                                <q-item link clickable v-ripple :to="`/postgradohv/view/${props.row.idposthv}`">
                                                                    <q-item-section>
                                                            ...
                                                            <template v-if="auth.canView('postgradohv/edit')">
                                                                <q-item link clickable v-ripple :to="`/postgradohv/edit/${props.row.idposthv}`">
                                                                    <q-item-section>
                                                            ...
                                                            <template v-if="auth.canView('postgradohv/delete')">
                                                                <q-item link clickable v-ripple @click="deleteItem(props.row.idposthv)">
                                                                    <q-item-section>
                                        ...
                                        <q-td  key="idposthv" :props="props">
                                            <q-btn padding="xs"   :rounded="false"  color="primary"  no-caps  unelevated   flat :to="`/postgradohv/view/${props.row.idposthv}`">{{ props.row.idposthv }}</q-btn>
                                        </q-td>
                                        <q-td  key="nomposhv" :props="props">
                                            {{ props.row.nomposhv }}
                                        </q-td>
                                        <q-td  key="abrev" :props="props">
                                            {{ props.row.abrev }}
                                        </q-td>
                                    </q-tr>
                                </template>
...
<script setup>
	...
	const props = defineProps({
		...
		routeName : {
			type : String,
			default : 'postgradohvlist',
		},
		apiPath : {
			type : String,
			default : 'postgradohv/index',
		},
		paginate: {
			type: Boolean,
			default: true,
