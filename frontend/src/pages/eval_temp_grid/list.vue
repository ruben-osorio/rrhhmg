                ...
                <div class="container-fluid">
                    <div class="row justify-between items-center q-col-gutter-md">
                        ...
                        <div  class="col-md-auto col-12 " >
                            <template v-if="auth.canView('/eval_temp_grid/add')">
                                <q-btn       :rounded="false"  size=""  color="primary" no-caps  unelevated   :to="`/eval_temp_grid/add`" class="" >
                        ...
                        <div >
                            <template v-if="showBreadcrumbs && $route.query.tag">
                                <q-breadcrumbs class="q-pa-md">
                                    <q-breadcrumbs-el icon="arrow_back" class="text-capitalize" :label="$route.query.tag" to="/eval_temp_grid"></q-breadcrumbs-el>
                            ...
                            <div >
                                ...
                                :bordered="false"
                                :columns="app.menus.EvalTempGridListHeaderItems" 
                                :rows="records"
                                ...
                                <template v-slot:body="props">
                                    <q-tr :class="{selected: isCurrentRecord(props.row)}" :props="props">
                                                ...
                                                <q-btn icon="menu" padding="xs" round flat color="grey">
                                                    <q-menu auto-close transition-show="flip-right"  transition-hide="flip-left" self="center middle" anchor="center middle">
                                                        <q-list dense rounded nav>
                                                            <template v-if="auth.canView('eval_temp_grid/view')">
                                                                <q-item link clickable v-ripple :to="`/eval_temp_grid/view/${props.row.id_eval_tem}`">
                                                                    <q-item-section>
                                                            ...
                                                            <template v-if="auth.canView('eval_temp_grid/edit')">
                                                                <q-item link clickable v-ripple :to="`/eval_temp_grid/edit/${props.row.id_eval_tem}`">
                                                                    <q-item-section>
                                                            ...
                                                            <template v-if="auth.canView('eval_temp_grid/delete')">
                                                                <q-item link clickable v-ripple @click="deleteItem(props.row.id_eval_tem)">
                                                                    <q-item-section>
                                        ...
                                        <q-td  key="codusuario" :props="props">
                                            <q-btn v-if="props.row.codusuario" :to="`/users/view/${props.row.codusuario}`" padding="xs" flat color="primary" no-caps >
                                                <q-icon name="visibility" size="xs"  class="q-mr-xs"></q-icon>  Users
                                            </q-btn>
                                        </q-td>
                                        <q-td  key="idref" :props="props">
                                            <q-btn v-if="props.row.idref" :to="`/perfilreferencial/view/${props.row.idref}`" padding="xs" flat color="primary" no-caps >
                                                <q-icon name="visibility" size="xs"  class="q-mr-xs"></q-icon>  Perfilreferencial
                                            </q-btn>
                                        </q-td>
                                        <q-td  key="ultimo_secund_perfil" :props="props">
                                            {{ props.row.ultimo_secund_perfil }}
                                        </q-td>
                                        <q-td  key="ultimo_universit_perfil" :props="props">
                                            {{ props.row.ultimo_universit_perfil }}
                                        </q-td>
                                        <q-td  key="postgrado_perfil" :props="props">
                                            {{ props.row.postgrado_perfil }}
                                        </q-td>
                                        <q-td  key="denominacion" :props="props">
                                            {{ props.row.denominacion }}
                                        </q-td>
                                        <q-td  key="estadof1" :props="props">
                                            {{ props.row.estadof1 }}
                                        </q-td>
                                        <q-td  key="estadof2" :props="props">
                                            {{ props.row.estadof2 }}
                                        </q-td>
                                        <q-td  key="estadof3" :props="props">
                                            {{ props.row.estadof3 }}
                                        </q-td>
                                    </q-tr>
                                </template>
...
<script setup>
	...
	const props = defineProps({
		...
		routeName : {
			type : String,
			default : 'eval_temp_gridlist',
		},
		apiPath : {
			type : String,
			default : 'eval_temp_grid/index',
		},
		paginate: {
			type: Boolean,
			default: true,
