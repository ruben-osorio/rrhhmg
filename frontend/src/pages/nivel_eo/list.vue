                ...
                <div class="container-fluid">
                    <div class="row justify-between items-center q-col-gutter-md">
                        ...
                        <div  class="col-md-auto col-12 " >
                            <template v-if="auth.canView('/nivel_eo/add')">
                                <q-btn       :rounded="false"  size=""  color="primary" no-caps  unelevated   :to="`/nivel_eo/add`" class="" >
                        ...
                        <div >
                            <template v-if="showBreadcrumbs && $route.query.tag">
                                <q-breadcrumbs class="q-pa-md">
                                    <q-breadcrumbs-el icon="arrow_back" class="text-capitalize" :label="$route.query.tag" to="/nivel_eo"></q-breadcrumbs-el>
                            ...
                            <div >
                                ...
                                :bordered="false"
                                :columns="app.menus.NivelEoListHeaderItems" 
                                :rows="records"
                                ...
                                <template v-slot:body="props">
                                    <q-tr :class="{selected: isCurrentRecord(props.row)}" :props="props">
                                                ...
                                                <q-btn icon="menu" padding="xs" round flat color="grey">
                                                    <q-menu auto-close transition-show="flip-right"  transition-hide="flip-left" self="center middle" anchor="center middle">
                                                        <q-list dense rounded nav>
                                                            <template v-if="auth.canView('nivel_eo/view')">
                                                                <q-item link clickable v-ripple :to="`/nivel_eo/view/${props.row.id_niv_eo}`">
                                                                    <q-item-section>
                                                            ...
                                                            <template v-if="auth.canView('nivel_eo/edit')">
                                                                <q-item link clickable v-ripple :to="`/nivel_eo/edit/${props.row.id_niv_eo}`">
                                                                    <q-item-section>
                                                            ...
                                                            <template v-if="auth.canView('nivel_eo/delete')">
                                                                <q-item link clickable v-ripple @click="deleteItem(props.row.id_niv_eo)">
                                                                    <q-item-section>
                                        ...
                                        <q-td  key="id_niv_eo" :props="props">
                                            <q-btn padding="xs"   :rounded="false"  color="primary"  no-caps  unelevated   flat :to="`/nivel_eo/view/${props.row.id_niv_eo}`">{{ props.row.id_niv_eo }}</q-btn>
                                        </q-td>
                                        <q-td  key="nombre_nivel" :props="props">
                                            {{ props.row.nombre_nivel }}
                                        </q-td>
...
<script setup>
	...
	const props = defineProps({
		...
		routeName : {
			type : String,
			default : 'nivel_eolist',
		},
		apiPath : {
			type : String,
			default : 'nivel_eo/index',
		},
		paginate: {
			type: Boolean,
			default: true,
