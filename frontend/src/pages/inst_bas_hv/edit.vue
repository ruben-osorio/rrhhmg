                                        ...
                                        <div class="col-12">
                                            <div class="row">
                                                ...
                                                <div class="col-sm-9 col-12">
                                                    <q-input   ref="ctrlnombre_ib_hv" v-model.trim="formData.nombre_ib_hv"  label="Nombre Ib Hv" type="text" placeholder="Escribir Nombre Ib Hv"      
                                                    class="" :error="isFieldValid('nombre_ib_hv')" :error-message="getFieldError('nombre_ib_hv')">
                                                    </q-input>
                                                </div>
                                            </div>
                                        </div>
...
<script setup>
	...
	const props = defineProps({
		...
		routeName: {
			type: String,
			default: 'inst_bas_hvedit',
		},
		pagePath: {
			type : String,
			default : 'inst_bas_hv/edit',
		},
		apiPath: {
			type: String,
			default: 'inst_bas_hv/edit',
