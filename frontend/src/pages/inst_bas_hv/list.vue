                ...
                <div class="container-fluid">
                    <div class="row justify-between items-center q-col-gutter-md">
                        ...
                        <div  class="col-md-auto col-12 " >
                            <template v-if="auth.canView('/inst_bas_hv/add')">
                                <q-btn       :rounded="false"  size=""  color="primary" no-caps  unelevated   :to="`/inst_bas_hv/add`" class="" >
                        ...
                        <div >
                            <template v-if="showBreadcrumbs && $route.query.tag">
                                <q-breadcrumbs class="q-pa-md">
                                    <q-breadcrumbs-el icon="arrow_back" class="text-capitalize" :label="$route.query.tag" to="/inst_bas_hv"></q-breadcrumbs-el>
                            ...
                            <div >
                                ...
                                :bordered="false"
                                :columns="app.menus.InstBasHvListHeaderItems" 
                                :rows="records"
                                ...
                                <template v-slot:body="props">
                                    <q-tr :class="{selected: isCurrentRecord(props.row)}" :props="props">
                                                ...
                                                <q-btn icon="menu" padding="xs" round flat color="grey">
                                                    <q-menu auto-close transition-show="flip-right"  transition-hide="flip-left" self="center middle" anchor="center middle">
                                                        <q-list dense rounded nav>
                                                            <template v-if="auth.canView('inst_bas_hv/view')">
                                                                <q-item link clickable v-ripple :to="`/inst_bas_hv/view/${props.row.id_bas_hv}`">
                                                                    <q-item-section>
                                                            ...
                                                            <template v-if="auth.canView('inst_bas_hv/edit')">
                                                                <q-item link clickable v-ripple :to="`/inst_bas_hv/edit/${props.row.id_bas_hv}`">
                                                                    <q-item-section>
                                                            ...
                                                            <template v-if="auth.canView('inst_bas_hv/delete')">
                                                                <q-item link clickable v-ripple @click="deleteItem(props.row.id_bas_hv)">
                                                                    <q-item-section>
                                        ...
                                        <q-td  key="id_bas_hv" :props="props">
                                            <q-btn padding="xs"   :rounded="false"  color="primary"  no-caps  unelevated   flat :to="`/inst_bas_hv/view/${props.row.id_bas_hv}`">{{ props.row.id_bas_hv }}</q-btn>
                                        </q-td>
                                        <q-td  key="nombre_ib_hv" :props="props">
                                            {{ props.row.nombre_ib_hv }}
                                        </q-td>
...
<script setup>
	...
	const props = defineProps({
		...
		routeName : {
			type : String,
			default : 'inst_bas_hvlist',
		},
		apiPath : {
			type : String,
			default : 'inst_bas_hv/index',
		},
		paginate: {
			type: Boolean,
			default: true,
