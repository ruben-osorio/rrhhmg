                ...
                <div class="container-fluid">
                    <div class="row justify-between items-center q-col-gutter-md">
                        ...
                        <div  class="col-md-auto col-12 " >
                            <template v-if="auth.canView('/gradocolegiohv/add')">
                                <q-btn       :rounded="false"  size=""  color="primary" no-caps  unelevated   :to="`/gradocolegiohv/add`" class="" >
                        ...
                        <div >
                            <template v-if="showBreadcrumbs && $route.query.tag">
                                <q-breadcrumbs class="q-pa-md">
                                    <q-breadcrumbs-el icon="arrow_back" class="text-capitalize" :label="$route.query.tag" to="/gradocolegiohv"></q-breadcrumbs-el>
                            ...
                            <div >
                                ...
                                :bordered="false"
                                :columns="app.menus.GradocolegiohvListHeaderItems" 
                                :rows="records"
                                ...
                                <template v-slot:body="props">
                                    <q-tr :class="{selected: isCurrentRecord(props.row)}" :props="props">
                                                ...
                                                <q-btn icon="menu" padding="xs" round flat color="grey">
                                                    <q-menu auto-close transition-show="flip-right"  transition-hide="flip-left" self="center middle" anchor="center middle">
                                                        <q-list dense rounded nav>
                                                            <template v-if="auth.canView('gradocolegiohv/view')">
                                                                <q-item link clickable v-ripple :to="`/gradocolegiohv/view/${props.row.idgradohv}`">
                                                                    <q-item-section>
                                                            ...
                                                            <template v-if="auth.canView('gradocolegiohv/edit')">
                                                                <q-item link clickable v-ripple :to="`/gradocolegiohv/edit/${props.row.idgradohv}`">
                                                                    <q-item-section>
                                                            ...
                                                            <template v-if="auth.canView('gradocolegiohv/delete')">
                                                                <q-item link clickable v-ripple @click="deleteItem(props.row.idgradohv)">
                                                                    <q-item-section>
                                        ...
                                        <q-td  key="idgradohv" :props="props">
                                            <q-btn padding="xs"   :rounded="false"  color="primary"  no-caps  unelevated   flat :to="`/gradocolegiohv/view/${props.row.idgradohv}`">{{ props.row.idgradohv }}</q-btn>
                                        </q-td>
                                        <q-td  key="nombrehv" :props="props">
                                            {{ props.row.nombrehv }}
                                        </q-td>
                                        <q-td  key="abrevhv" :props="props">
                                            {{ props.row.abrevhv }}
                                        </q-td>
                                    </q-tr>
                                </template>
...
<script setup>
	...
	const props = defineProps({
		...
		pageName : {
			type : String,
			default : 'gradocolegiohv',
		},
		routeName : {
			type : String,
			default : 'gradocolegiohvlist',
		},
		apiPath : {
			type : String,
			default : 'gradocolegiohv/index',
		},
		paginate: {
			type: Boolean,
			default: true,
