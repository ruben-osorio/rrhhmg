                ...
                <div class="container-fluid">
                    <div class="row justify-between items-center q-col-gutter-md">
                        ...
                        <div  class="col-md-auto col-12 " >
                            <template v-if="auth.canView('/experiencia/add')">
                                <q-btn       :rounded="false"  size=""  color="primary" no-caps  unelevated   :to="`/experiencia/add`" class="" >
                        ...
                        <div >
                            <template v-if="showBreadcrumbs && $route.query.tag">
                                <q-breadcrumbs class="q-pa-md">
                                    <q-breadcrumbs-el icon="arrow_back" class="text-capitalize" :label="$route.query.tag" to="/experiencia"></q-breadcrumbs-el>
                            ...
                            <div >
                                ...
                                :bordered="false"
                                :columns="app.menus.ExperienciaListHeaderItems" 
                                :rows="records"
                                ...
                                <template v-slot:body="props">
                                    <q-tr :class="{selected: isCurrentRecord(props.row)}" :props="props">
                                        ...
                                        <q-td  key="funciones" :props="props">
                                            {{ props.row.funciones }}
                                        </q-td>
                                        <q-td  key="f_inicio" :props="props">
                                            {{ props.row.f_inicio }}
                                        </q-td>
                                        <q-td  key="f_fin" :props="props">
                                            {{ props.row.f_fin }}
                                        </q-td>
                                        ...
                                        <q-td  key="idexp" :props="props">
                                            <q-btn padding="xs"   :rounded="false"  color="primary"  no-caps  unelevated   flat :to="`/experiencia/view/${props.row.idexp}`">{{ props.row.idexp }}</q-btn>
                                        </q-td>
                                                ...
                                                <q-btn icon="menu" padding="xs" round flat color="grey">
                                                    <q-menu auto-close transition-show="flip-right"  transition-hide="flip-left" self="center middle" anchor="center middle">
                                                        <q-list dense rounded nav>
                                                            <template v-if="auth.canView('experiencia/view')">
                                                                <q-item link clickable v-ripple :to="`/experiencia/view/${props.row.idexp}`">
                                                                    <q-item-section>
                                                            ...
                                                            <template v-if="auth.canView('experiencia/edit')">
                                                                <q-item link clickable v-ripple :to="`/experiencia/edit/${props.row.idexp}`">
                                                                    <q-item-section>
                                                            ...
                                                            <template v-if="auth.canView('experiencia/delete')">
                                                                <q-item link clickable v-ripple @click="deleteItem(props.row.idexp)">
                                                                    <q-item-section>
...
<script setup>
	...
	const props = defineProps({
		...
		routeName : {
			type : String,
			default : 'experiencialist',
		},
		apiPath : {
			type : String,
			default : 'experiencia/index',
		},
		paginate: {
			type: Boolean,
			default: true,
