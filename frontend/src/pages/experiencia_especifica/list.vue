                ...
                <div class="container-fluid">
                    <div class="row justify-between items-center q-col-gutter-md">
                        ...
                        <div  class="col-md-auto col-12 " >
                            <template v-if="auth.canView('/experiencia_especifica/add')">
                                <q-btn       :rounded="false"  size=""  color="primary" no-caps  unelevated   :to="`/experiencia_especifica/add`" class="" >
                        ...
                        <div >
                            <template v-if="showBreadcrumbs && $route.query.tag">
                                <q-breadcrumbs class="q-pa-md">
                                    <q-breadcrumbs-el icon="arrow_back" class="text-capitalize" :label="$route.query.tag" to="/experiencia_especifica"></q-breadcrumbs-el>
                            ...
                            <div >
                                ...
                                :bordered="false"
                                :columns="app.menus.ExperienciaEspecificaListHeaderItems" 
                                :rows="records"
                                ...
                                <template v-slot:body="props">
                                    <q-tr :class="{selected: isCurrentRecord(props.row)}" :props="props">
                                                ...
                                                <q-btn icon="menu" padding="xs" round flat color="grey">
                                                    <q-menu auto-close transition-show="flip-right"  transition-hide="flip-left" self="center middle" anchor="center middle">
                                                        <q-list dense rounded nav>
                                                            <template v-if="auth.canView('experiencia_especifica/view')">
                                                                <q-item link clickable v-ripple :to="`/experiencia_especifica/view/${props.row.id_ee}`">
                                                                    <q-item-section>
                                                            ...
                                                            <template v-if="auth.canView('experiencia_especifica/edit')">
                                                                <q-item link clickable v-ripple :to="`/experiencia_especifica/edit/${props.row.id_ee}`">
                                                                    <q-item-section>
                                                            ...
                                                            <template v-if="auth.canView('experiencia_especifica/delete')">
                                                                <q-item link clickable v-ripple @click="deleteItem(props.row.id_ee)">
                                                                    <q-item-section>
                                        ...
                                        <q-td  key="id_ee" :props="props">
                                            <q-btn padding="xs"   :rounded="false"  color="primary"  no-caps  unelevated   flat :to="`/experiencia_especifica/view/${props.row.id_ee}`">{{ props.row.id_ee }}</q-btn>
                                        </q-td>
                                        <q-td  key="id_evaluacionperfil" :props="props">
                                            {{ props.row.id_evaluacionperfil }}
                                        </q-td>
                                        <q-td  key="detalle_ee" :props="props">
                                            {{ props.row.detalle_ee }}
                                        </q-td>
                                    </q-tr>
                                </template>
                                <!-- End of Table Layout-->
...
<script setup>
	...
	const props = defineProps({
		...
		pageName : {
			type : String,
			default : 'experiencia_especifica',
		},
		routeName : {
			type : String,
			default : 'experiencia_especificalist',
		},
		apiPath : {
			type : String,
			default : 'experiencia_especifica/index',
		},
		paginate: {
			type: Boolean,
			default: true,
