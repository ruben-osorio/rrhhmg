                ...
                <div class="container-fluid">
                    <div class="row justify-between items-center q-col-gutter-md">
                        ...
                        <div  class="col-md-auto col-12 " >
                            <template v-if="auth.canView('/formestudiossup3/add')">
                                <q-btn       :rounded="false"  size=""  color="primary" no-caps  unelevated   :to="`/formestudiossup3/add`" class="" >
                        ...
                        <div >
                            <template v-if="showBreadcrumbs && $route.query.tag">
                                <q-breadcrumbs class="q-pa-md">
                                    <q-breadcrumbs-el icon="arrow_back" class="text-capitalize" :label="$route.query.tag" to="/formestudiossup3"></q-breadcrumbs-el>
                            ...
                            <div >
                                ...
                                :bordered="false"
                                :columns="app.menus.Formestudiossup3ListHeaderItems" 
                                :rows="records"
                                                ...
                                                <q-btn icon="menu" padding="xs" round flat color="grey">
                                                    <q-menu auto-close transition-show="flip-right"  transition-hide="flip-left" self="center middle" anchor="center middle">
                                                        <q-list dense rounded nav>
                                                            <template v-if="auth.canView('formestudiossup3/view')">
                                                                <q-item link clickable v-ripple :to="`/formestudiossup3/view/${props.row.idformestsup}`">
                                                                    <q-item-section>
                                                            ...
                                                            <template v-if="auth.canView('formestudiossup3/edit')">
                                                                <q-item link clickable v-ripple :to="`/formestudiossup3/edit/${props.row.idformestsup}`">
                                                                    <q-item-section>
                                                            ...
                                                            <template v-if="auth.canView('formestudiossup3/delete')">
                                                                <q-item link clickable v-ripple @click="deleteItem(props.row.idformestsup)">
                                                                    <q-item-section>
...
<script setup>
	...
	const props = defineProps({
		...
		routeName : {
			type : String,
			default : 'formestudiossup3list',
		},
		apiPath : {
			type : String,
			default : 'formestudiossup3/index',
		},
		paginate: {
			type: Boolean,
			default: true,
