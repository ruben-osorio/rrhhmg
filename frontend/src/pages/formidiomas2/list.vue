                ...
                <div class="container-fluid">
                    <div class="row justify-between items-center q-col-gutter-md">
                        ...
                        <div  class="col-md-auto col-12 " >
                            <template v-if="auth.canView('/formidiomas2/add')">
                                <q-btn       :rounded="false"  size=""  color="primary" no-caps  unelevated   :to="`/formidiomas2/add`" class="" >
                        ...
                        <div >
                            <template v-if="showBreadcrumbs && $route.query.tag">
                                <q-breadcrumbs class="q-pa-md">
                                    <q-breadcrumbs-el icon="arrow_back" class="text-capitalize" :label="$route.query.tag" to="/formidiomas2"></q-breadcrumbs-el>
                            ...
                            <div >
                                ...
                                :bordered="false"
                                :columns="app.menus.Formidiomas2ListHeaderItems" 
                                :rows="records"
                                ...
                                <template v-slot:body="props">
                                    <q-tr :class="{selected: isCurrentRecord(props.row)}" :props="props">
                                        ...
                                        <q-td  key="nombreidioma" :props="props">
                                            {{ props.row.nombreidioma }}
                                        </q-td>
                                        <q-td  key="horasingles" :props="props">
                                            {{ props.row.horasingles }}
                                        </q-td>
                                        <q-td  key="certificadoidioma" :props="props">
                                            {{ props.row.certificadoidioma }}
                                        </q-td>
                                                ...
                                                <q-btn icon="menu" padding="xs" round flat color="grey">
                                                    <q-menu auto-close transition-show="flip-right"  transition-hide="flip-left" self="center middle" anchor="center middle">
                                                        <q-list dense rounded nav>
                                                            <template v-if="auth.canView('formidiomas2/view')">
                                                                <q-item link clickable v-ripple :to="`/formidiomas2/view/${props.row.idformidioma}`">
                                                                    <q-item-section>
                                                            ...
                                                            <template v-if="auth.canView('formidiomas2/edit')">
                                                                <q-item link clickable v-ripple :to="`/formidiomas2/edit/${props.row.idformidioma}`">
                                                                    <q-item-section>
                                                            ...
                                                            <template v-if="auth.canView('formidiomas2/delete')">
                                                                <q-item link clickable v-ripple @click="deleteItem(props.row.idformidioma)">
                                                                    <q-item-section>
...
<script setup>
	...
	const props = defineProps({
		...
		routeName : {
			type : String,
			default : 'formidiomas2list',
		},
		apiPath : {
			type : String,
			default : 'formidiomas2/index',
		},
		paginate: {
			type: Boolean,
			default: true,
