                ...
                <div class="container-fluid">
                    <div class="row justify-between items-center q-col-gutter-md">
                        ...
                        <div  class="col-md-auto col-12 " >
                            <template v-if="auth.canView('/vacaciones/add')">
                                <q-btn       :rounded="false"  size=""  color="primary" no-caps  unelevated   :to="`/vacaciones/add`" class="" >
                        ...
                        <div >
                            <template v-if="showBreadcrumbs && $route.query.tag">
                                <q-breadcrumbs class="q-pa-md">
                                    <q-breadcrumbs-el icon="arrow_back" class="text-capitalize" :label="$route.query.tag" to="/vacaciones"></q-breadcrumbs-el>
                                                ...
                                                <q-btn icon="menu" padding="xs" round flat color="grey">
                                                    <q-menu auto-close transition-show="flip-right"  transition-hide="flip-left" self="center middle" anchor="center middle">
                                                        <q-list dense rounded nav>
                                                            <template v-if="auth.canView('vacaciones/view')">
                                                            ...
                                                            <template v-if="auth.canView('vacaciones/edit')">
                                                            ...
                                                            <template v-if="auth.canView('vacaciones/delete')">
...
<script setup>
	...
	const props = defineProps({
		...
		routeName : {
			type : String,
			default : 'vacacioneslist',
		},
		apiPath : {
			type : String,
			default : 'vacaciones/index',
		},
		paginate: {
			type: Boolean,
			default: true,
