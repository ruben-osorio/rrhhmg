                ...
                <div class="container-fluid">
                    <div class="row justify-between items-center q-col-gutter-md">
                        ...
                        <div  class="col-md-auto col-12 " >
                            <template v-if="auth.canView('/item_escala/add')">
                                <q-btn       :rounded="false"  size=""  color="primary" no-caps  unelevated   :to="`/item_escala/add`" class="" >
                        ...
                        <div >
                            <template v-if="showBreadcrumbs && $route.query.tag">
                                <q-breadcrumbs class="q-pa-md">
                                    <q-breadcrumbs-el icon="arrow_back" class="text-capitalize" :label="$route.query.tag" to="/item_escala"></q-breadcrumbs-el>
                            ...
                            <div >
                                ...
                                :bordered="false"
                                :columns="app.menus.ItemEscalaListHeaderItems" 
                                :rows="records"
                                ...
                                <template v-slot:body="props">
                                    <q-tr :class="{selected: isCurrentRecord(props.row)}" :props="props">
                                                ...
                                                <q-btn icon="menu" padding="xs" round flat color="grey">
                                                    <q-menu auto-close transition-show="flip-right"  transition-hide="flip-left" self="center middle" anchor="center middle">
                                                        <q-list dense rounded nav>
                                                            <template v-if="auth.canView('item_escala/view')">
                                                                <q-item link clickable v-ripple :to="`/item_escala/view/${props.row.id_item_denom}`">
                                                                    <q-item-section>
                                                            ...
                                                            <template v-if="auth.canView('item_escala/edit')">
                                                                <q-item link clickable v-ripple :to="`/item_escala/edit/${props.row.id_item_denom}`">
                                                                    <q-item-section>
                                                            ...
                                                            <template v-if="auth.canView('item_escala/delete')">
                                                                <q-item link clickable v-ripple @click="deleteItem(props.row.id_item_denom)">
                                                                    <q-item-section>
                                        ...
                                        <q-td  key="h_b_item" :props="props">
                                            {{ props.row.h_b_item }}
                                        </q-td>
                                        <q-td  key="id_item_denom" :props="props">
                                            <q-btn padding="xs"   :rounded="false"  color="primary"  no-caps  unelevated   flat :to="`/item_escala/view/${props.row.id_item_denom}`">{{ props.row.id_item_denom }}</q-btn>
                                        </q-td>
                                        <q-td  key="nro_items" :props="props">
                                            {{ props.row.nro_items }}
                                        </q-td>
                                        <q-td  key="descripcion_item" :props="props">
                                            {{ props.row.descripcion_item }}
                                        </q-td>
                                    </q-tr>
                                </template>
                                <!-- End of Table Layout-->
...
<script setup>
	...
	const props = defineProps({
		...
		routeName : {
			type : String,
			default : 'item_escalalist',
		},
		apiPath : {
			type : String,
			default : 'item_escala/index',
		},
		paginate: {
			type: Boolean,
			default: true,
