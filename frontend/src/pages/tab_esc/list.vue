                ...
                <div class="container-fluid">
                    <div class="row justify-between items-center q-col-gutter-md">
                        ...
                        <div  class="col-md-auto col-12 " >
                            <template v-if="auth.canView('/tab_esc/add')">
                                <q-btn       :rounded="false"  size=""  color="primary" no-caps  unelevated   :to="`/tab_esc/add`" class="" >
                        ...
                        <div >
                            <template v-if="showBreadcrumbs && $route.query.tag">
                                <q-breadcrumbs class="q-pa-md">
                                    <q-breadcrumbs-el icon="arrow_back" class="text-capitalize" :label="$route.query.tag" to="/tab_esc"></q-breadcrumbs-el>
                            ...
                            <div >
                                ...
                                :bordered="false"
                                :columns="app.menus.TabEscListHeaderItems" 
                                :rows="records"
                                ...
                                <template v-slot:body="props">
                                    <q-tr :class="{selected: isCurrentRecord(props.row)}" :props="props">
                                                ...
                                                <q-btn icon="menu" padding="xs" round flat color="grey">
                                                    <q-menu auto-close transition-show="flip-right"  transition-hide="flip-left" self="center middle" anchor="center middle">
                                                        <q-list dense rounded nav>
                                                            <template v-if="auth.canView('tab_esc/view')">
                                                                <q-item link clickable v-ripple :to="`/tab_esc/view/${props.row.id_t_e}`">
                                                                    <q-item-section>
                                                            ...
                                                            <template v-if="auth.canView('tab_esc/edit')">
                                                                <q-item link clickable v-ripple :to="`/tab_esc/edit/${props.row.id_t_e}`">
                                                                    <q-item-section>
                                                            ...
                                                            <template v-if="auth.canView('tab_esc/delete')">
                                                                <q-item link clickable v-ripple @click="deleteItem(props.row.id_t_e)">
                                                                    <q-item-section>
                                        ...
                                        <q-td  key="id_t_e" :props="props">
                                            <q-btn padding="xs"   :rounded="false"  color="primary"  no-caps  unelevated   flat :to="`/tab_esc/view/${props.row.id_t_e}`">{{ props.row.id_t_e }}</q-btn>
                                        </q-td>
                                        <q-td  key="nivel_te" :props="props">
                                            {{ props.row.nivel_te }}
                                        </q-td>
                                        <q-td  key="nro_item_te" :props="props">
                                            {{ props.row.nro_item_te }}
                                        </q-td>
                                        <q-td  key="haber_b_te" :props="props">
                                            {{ props.row.haber_b_te }}
                                        </q-td>
                                        <q-td  key="categoria_te" :props="props">
                                            {{ props.row.categoria_te }}
                                        </q-td>
                                        <q-td  key="denom_te" :props="props">
                                            {{ props.row.denom_te }}
                                        </q-td>
                                    </q-tr>
                                </template>
