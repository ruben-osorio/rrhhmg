                ...
                <div class="container-fluid">
                    <div class="row justify-between items-center q-col-gutter-md">
                        ...
                        <div  class="col-md-auto col-12 " >
                            <template v-if="auth.canView('/experienciahv/add')">
                                <q-btn       :rounded="false"  size=""  color="primary" no-caps  unelevated   :to="`/experienciahv/add`" class="" >
                        ...
                        <div >
                            <template v-if="showBreadcrumbs && $route.query.tag">
                                <q-breadcrumbs class="q-pa-md">
                                    <q-breadcrumbs-el icon="arrow_back" class="text-capitalize" :label="$route.query.tag" to="/experienciahv"></q-breadcrumbs-el>
                            ...
                            <div >
                                ...
                                :bordered="false"
                                :columns="app.menus.ExperienciahvListHeaderItems" 
                                :rows="records"
                                ...
                                <template v-slot:body="props">
                                    <q-tr :class="{selected: isCurrentRecord(props.row)}" :props="props">
                                                ...
                                                <q-btn icon="menu" padding="xs" round flat color="grey">
                                                    <q-menu auto-close transition-show="flip-right"  transition-hide="flip-left" self="center middle" anchor="center middle">
                                                        <q-list dense rounded nav>
                                                            <template v-if="auth.canView('experienciahv/view')">
                                                                <q-item link clickable v-ripple :to="`/experienciahv/view/${props.row.idexp_hv}`">
                                                                    <q-item-section>
                                                            ...
                                                            <template v-if="auth.canView('experienciahv/edit')">
                                                                <q-item link clickable v-ripple :to="`/experienciahv/edit/${props.row.idexp_hv}`">
                                                                    <q-item-section>
                                                            ...
                                                            <template v-if="auth.canView('experienciahv/delete')">
                                                                <q-item link clickable v-ripple @click="deleteItem(props.row.idexp_hv)">
                                                                    <q-item-section>
                                        ...
                                        <q-td  key="idexp_hv" :props="props">
                                            <q-btn padding="xs"   :rounded="false"  color="primary"  no-caps  unelevated   flat :to="`/experienciahv/view/${props.row.idexp_hv}`">{{ props.row.idexp_hv }}</q-btn>
                                        </q-td>
                                        <q-td  key="f_inicio_hv" :props="props">
                                            {{ props.row.f_inicio_hv }}
                                        </q-td>
                                        <q-td  key="f_fin_hv" :props="props">
                                            {{ props.row.f_fin_hv }}
                                        </q-td>
                                        <q-td  key="funciones_hv" :props="props">
                                            {{ props.row.funciones_hv }}
                                        </q-td>
                                        <q-td  key="codusuario" :props="props">
                                            {{ props.row.codusuario }}
                                        </q-td>
                                        <q-td  key="sumatoria" :props="props">
                                            {{ props.row.sumatoria }}
                                        </q-td>
                                        <q-td  key="codgestion" :props="props">
                                            {{ props.row.codgestion }}
                                        </q-td>
                                        <q-td  key="entidad_hv" :props="props">
...
<script setup>
	...
	const props = defineProps({
		...
		routeName : {
			type : String,
			default : 'experienciahvlist',
		},
		apiPath : {
			type : String,
			default : 'experienciahv/index',
		},
		paginate: {
			type: Boolean,
			default: true,
