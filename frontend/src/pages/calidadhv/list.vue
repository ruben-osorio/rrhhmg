                ...
                <div class="container-fluid">
                    <div class="row justify-between items-center q-col-gutter-md">
                        ...
                        <div  class="col-md-auto col-12 " >
                            <template v-if="auth.canView('/calidadhv/add')">
                                <q-btn       :rounded="false"  size=""  color="primary" no-caps  unelevated   :to="`/calidadhv/add`" class="" >
                        ...
                        <div >
                            <template v-if="showBreadcrumbs && $route.query.tag">
                                <q-breadcrumbs class="q-pa-md">
                                    <q-breadcrumbs-el icon="arrow_back" class="text-capitalize" :label="$route.query.tag" to="/calidadhv"></q-breadcrumbs-el>
                            ...
                            <div >
                                ...
                                :bordered="false"
                                :columns="app.menus.CalidadhvListHeaderItems" 
                                :rows="records"
                                ...
                                <template v-slot:body="props">
                                    <q-tr :class="{selected: isCurrentRecord(props.row)}" :props="props">
                                                ...
                                                <q-btn icon="menu" padding="xs" round flat color="grey">
                                                    <q-menu auto-close transition-show="flip-right"  transition-hide="flip-left" self="center middle" anchor="center middle">
                                                        <q-list dense rounded nav>
                                                            <template v-if="auth.canView('calidadhv/view')">
                                                                <q-item link clickable v-ripple :to="`/calidadhv/view/${props.row.idcalidadhv}`">
                                                                    <q-item-section>
                                                            ...
                                                            <template v-if="auth.canView('calidadhv/edit')">
                                                                <q-item link clickable v-ripple :to="`/calidadhv/edit/${props.row.idcalidadhv}`">
                                                                    <q-item-section>
                                                            ...
                                                            <template v-if="auth.canView('calidadhv/delete')">
                                                                <q-item link clickable v-ripple @click="deleteItem(props.row.idcalidadhv)">
                                                                    <q-item-section>
                                        ...
                                        <q-td  key="idcalidadhv" :props="props">
                                            <q-btn padding="xs"   :rounded="false"  color="primary"  no-caps  unelevated   flat :to="`/calidadhv/view/${props.row.idcalidadhv}`">{{ props.row.idcalidadhv }}</q-btn>
                                        </q-td>
...
<script setup>
	...
	const props = defineProps({
		...
		routeName : {
			type : String,
			default : 'calidadhvlist',
		},
		apiPath : {
			type : String,
			default : 'calidadhv/index',
		},
		paginate: {
			type: Boolean,
			default: true,
