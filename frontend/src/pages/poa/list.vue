                ...
                <div class="container-fluid">
                    <div class="row justify-between items-center q-col-gutter-md">
                        ...
                        <div  class="col-md-auto col-12 " >
                            <template v-if="auth.canView('/poa/add')">
                                <q-btn       :rounded="false"  size=""  color="primary" no-caps  unelevated   :to="`/poa/add`" class="" >
                        ...
                        <div >
                            <template v-if="showBreadcrumbs && $route.query.tag">
                                <q-breadcrumbs class="q-pa-md">
                                    <q-breadcrumbs-el icon="arrow_back" class="text-capitalize" :label="$route.query.tag" to="/poa"></q-breadcrumbs-el>
                            ...
                            <div >
                                ...
                                :bordered="false"
                                :columns="app.menus.PoaListHeaderItems" 
                                :rows="records"
                                ...
                                <template v-slot:body="props">
                                    <q-tr :class="{selected: isCurrentRecord(props.row)}" :props="props">
                                        ...
                                        <q-td  key="idpoa" :props="props">
                                            <q-btn padding="xs"   :rounded="false"  color="primary"  no-caps  unelevated   flat :to="`/poa/view/${props.row.idpoa}`">{{ props.row.idpoa }}</q-btn>
                                        </q-td>
                                                ...
                                                <q-btn icon="menu" padding="xs" round flat color="grey">
                                                    <q-menu auto-close transition-show="flip-right"  transition-hide="flip-left" self="center middle" anchor="center middle">
                                                        <q-list dense rounded nav>
                                                            <template v-if="auth.canView('poa/view')">
                                                                <q-item link clickable v-ripple :to="`/poa/view/${props.row.idpoa}`">
                                                                    <q-item-section>
                                                            ...
                                                            <template v-if="auth.canView('poa/edit')">
                                                                <q-item link clickable v-ripple :to="`/poa/edit/${props.row.idpoa}`">
                                                                    <q-item-section>
                                                            ...
                                                            <template v-if="auth.canView('poa/delete')">
                                                                <q-item link clickable v-ripple @click="deleteItem(props.row.idpoa)">
                                                                    <q-item-section>
