                ...
                <div class="container-fluid">
                    <div class="row justify-between items-center q-col-gutter-md">
                        ...
                        <div  class="col-md-auto col-12 " >
                            <template v-if="auth.canView('/detitem/add')">
                                <q-btn       :rounded="false"  size=""  color="primary" no-caps  unelevated   :to="`/detitem/add`" class="" >
                        ...
                        <div >
                            <template v-if="showBreadcrumbs && $route.query.tag">
                                <q-breadcrumbs class="q-pa-md">
                                    <q-breadcrumbs-el icon="arrow_back" class="text-capitalize" :label="$route.query.tag" to="/detitem"></q-breadcrumbs-el>
                            ...
                            <div class="row q-col-gutter-x-md q-col-gutter-md justify-start">
                                <div class="col">
                                    ...
                                    <div >
                                        ...
                                        :bordered="false"
                                        :columns="app.menus.DetitemListHeaderItems" 
                                        :rows="records"
                                        ...
                                        <template v-slot:body="props">
                                            <q-tr :class="{selected: isCurrentRecord(props.row)}" :props="props">
                                                ...
                                                <q-td  key="iditem" :props="props">
                                                    <q-btn padding="xs"   :rounded="false"  color="primary"  no-caps  unelevated   flat :to="`/detitem/view/${props.row.iditem}`">{{ props.row.iditem }}</q-btn>
                                                </q-td>
                                                ...
                                                <q-td  key="claseglo" :props="props">
                                                    {{ props.row.claseglo }}
                                                </q-td>
                                                <q-td  key="nivelglo" :props="props">
                                                    {{ props.row.nivelglo }}
                                                </q-td>
                                                ...
                                                <q-td  key="jefinmsup" :props="props">
                                                    {{ props.row.jefinmsup }}
                                                </q-td>
                                                <q-td  key="jefinmjer" :props="props">
                                                    {{ props.row.jefinmjer }}
                                                </q-td>
                                                        ...
                                                        <q-btn icon="menu" padding="xs" round flat color="grey">
                                                            <q-menu auto-close transition-show="flip-right"  transition-hide="flip-left" self="center middle" anchor="center middle">
                                                                <q-list dense rounded nav>
                                                                    <template v-if="auth.canView('detitem/view')">
                                                                        <q-item link clickable v-ripple :to="`/detitem/view/${props.row.iditem}`">
                                                                            <q-item-section>
                                                                    ...
                                                                    <template v-if="auth.canView('detitem/edit')">
                                                                        <q-item link clickable v-ripple :to="`/detitem/edit/${props.row.iditem}`">
                                                                            <q-item-section>
                                                                    ...
                                                                    <template v-if="auth.canView('detitem/delete')">
                                                                        <q-item link clickable v-ripple @click="deleteItem(props.row.iditem)">
                                                                            <q-item-section>
