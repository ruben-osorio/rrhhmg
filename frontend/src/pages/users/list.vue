                            ...
                            <div class="row q-col-gutter-x-md q-col-gutter-md justify-start">
                                <div class="col">
                                    ...
                                    <div >
                                        ...
                                        :bordered="false"
                                        :columns="app.menus.UsersListHeaderItems" 
                                        :rows="records"
                                        ...
                                        <template v-slot:body="props">
                                            <q-tr :class="{selected: isCurrentRecord(props.row)}" :props="props">
                                                ...
                                                <q-td  key="foto" :props="props">
                                                    <image-viewer image-size="small" image-preview-size="large" :src="props.row.foto" width="50px" height="50px" :num-display="1">
                                                    </image-viewer>
                                                </q-td>
                                                ...
                                                <q-td  key="libreta_militar_gestion" :props="props">
                                                    {{ props.row.libreta_militar_gestion }}
                                                </q-td>
                                                ...
                                                <q-td  key="grupo_sanguineo" :props="props">
                                                    {{ props.row.grupo_sanguineo }}
                                                </q-td>
                                                <q-td  key="direccion" :props="props">
                                                    {{ props.row.direccion }}
                                                </q-td>
                                                <q-td  key="licencia_conducir_nro" :props="props">
                                                    {{ props.row.licencia_conducir_nro }}
                                                </q-td>
                                                <q-td  key="licencia_conducir_cat" :props="props">
                                                    {{ props.row.licencia_conducir_cat }}
                                                </q-td>
                                                <q-td  key="nit" :props="props">
                                                    {{ props.row.nit }}
                                                </q-td>
                                                <q-td  key="libreta_militar_nro" :props="props">
                                                    {{ props.row.libreta_militar_nro }}
                                                </q-td>
                                                <q-td  key="matricula" :props="props">
                                                    {{ props.row.matricula }}
                                                </q-td>
                                                <q-td  key="libreta_militar_tipo" :props="props">
                                                    {{ props.row.libreta_militar_tipo }}
                                                </q-td>
                                                <q-td  key="numero_referencia" :props="props">
                                                    {{ props.row.numero_referencia }}
                                                </q-td>
                                                <q-td  key="detalle_referencia" :props="props">
                                                    {{ props.row.detalle_referencia }}
                                                </q-td>
