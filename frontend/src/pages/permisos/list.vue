                ...
                <div class="container-fluid">
                    <div class="row justify-between items-center q-col-gutter-md">
                        ...
                        <div  class="col-md-auto col-12 " >
                            <template v-if="auth.canView('/permisos/add')">
                                <q-btn       :rounded="false"  size=""  color="primary" no-caps  unelevated   :to="`/permisos/add`" class="" >
                        ...
                        <div >
                            <template v-if="showBreadcrumbs && $route.query.tag">
                                <q-breadcrumbs class="q-pa-md">
                                    <q-breadcrumbs-el icon="arrow_back" class="text-capitalize" :label="$route.query.tag" to="/permisos"></q-breadcrumbs-el>
                            ...
                            <div >
                                ...
                                :bordered="false"
                                :columns="app.menus.PermisosListHeaderItems" 
                                :rows="records"
                                ...
                                <template v-slot:body="props">
                                    <q-tr :class="{selected: isCurrentRecord(props.row)}" :props="props">
                                        ...
                                        <q-td  key="codboleta" :props="props">
                                            <q-btn v-if="props.row.codboleta" @click="app.openPageDialog({ page: 'detboleta/view', url: `/detboleta/view/${props.row.codboleta}` , closeBtn: true })" padding="xs" flat color="primary" no-caps >
                                                <q-icon name="visibility" size="xs"  class="q-mr-xs"></q-icon>  Detboleta
                                            </q-btn>
                                        </q-td>
                                        <q-td  key="ffin" :props="props">
                                            {{ props.row.ffin }}
                                        </q-td>
                                        <q-td  key="fechacreacion" :props="props">
                                            {{ props.row.fechacreacion }}
                                        </q-td>
                                        ...
                                        <q-td  key="idpermiso" :props="props">
                                            <q-btn padding="xs"   :rounded="false"  color="primary"  no-caps  unelevated   flat :to="`/permisos/view/${props.row.idpermiso}`">{{ props.row.idpermiso }}</q-btn>
                                        </q-td>
                                        <q-td  key="estado" :props="props">
                                            {{ props.row.estado }}
                                        </q-td>
                                        <q-td  key="ciaprover" :props="props">
                                            {{ props.row.ciaprover }}
                                        </q-td>
                                                ...
                                                <q-btn icon="menu" padding="xs" round flat color="grey">
                                                    <q-menu auto-close transition-show="flip-right"  transition-hide="flip-left" self="center middle" anchor="center middle">
                                                        <q-list dense rounded nav>
                                                            <template v-if="auth.canView('permisos/view')">
                                                                <q-item link clickable v-ripple :to="`/permisos/view/${props.row.idpermiso}`">
                                                                    <q-item-section>
                                                            ...
                                                            <template v-if="auth.canView('permisos/edit')">
                                                                <q-item link clickable v-ripple :to="`/permisos/edit/${props.row.idpermiso}`">
                                                                    <q-item-section>
                                                            ...
                                                            <template v-if="auth.canView('permisos/delete')">
                                                                <q-item link clickable v-ripple @click="deleteItem(props.row.idpermiso)">
                                                                    <q-item-section>
...
<script setup>
	...
	const props = defineProps({
		...
		routeName : {
			type : String,
			default : 'permisoslist',
		},
		apiPath : {
			type : String,
			default : 'permisos/index',
		},
		paginate: {
			type: Boolean,
			default: true,
