                ...
                <div class="container-fluid">
                    <div class="row justify-between items-center q-col-gutter-md">
                        ...
                        <div  class="col-md-auto col-12 " >
                            <template v-if="auth.canView('/evalcurricular/add')">
                                <q-btn       :rounded="false"  size=""  color="primary" no-caps  unelevated   :to="`/evalcurricular/add`" class="" >
                        ...
                        <div >
                            <template v-if="showBreadcrumbs && $route.query.tag">
                                <q-breadcrumbs class="q-pa-md">
                                    <q-breadcrumbs-el icon="arrow_back" class="text-capitalize" :label="$route.query.tag" to="/evalcurricular"></q-breadcrumbs-el>
                            ...
                            <div >
                                ...
                                :bordered="false"
                                :columns="app.menus.EvalcurricularListHeaderItems" 
                                :rows="records"
                                ...
                                <template v-slot:body="props">
                                    <q-tr :class="{selected: isCurrentRecord(props.row)}" :props="props">
                                        ...
                                        <q-td  key="idec" :props="props">
                                            <q-btn padding="xs"   :rounded="false"  color="primary"  no-caps  unelevated   flat :to="`/evalcurricular/view/${props.row.idec}`">{{ props.row.idec }}</q-btn>
                                        </q-td>
                                        <q-td  key="nivelec" :props="props">
                                            {{ props.row.nivelec }}
                                        </q-td>
                                        <q-td  key="denominacionec" :props="props">
                                            {{ props.row.denominacionec }}
                                        </q-td>
                                        <q-td  key="haberbasicoec" :props="props">
                                            {{ props.row.haberbasicoec }}
                                        </q-td>
                                        <q-td  key="formacadec" :props="props">
                                            {{ props.row.formacadec }}
                                        </q-td>
                                        <q-td  key="ageneralec" :props="props">
                                            {{ props.row.ageneralec }}
                                        </q-td>
                                        <q-td  key="mgeneralec" :props="props">
                                            {{ props.row.mgeneralec }}
                                        </q-td>
                                        <q-td  key="aespecificaec" :props="props">
                                            {{ props.row.aespecificaec }}
                                        </q-td>
                                        <q-td  key="mespecificaec" :props="props">
                                            {{ props.row.mespecificaec }}
                                        </q-td>
                                        <q-td  key="ciec" :props="props">
                                            {{ props.row.ciec }}
                                        </q-td>
                                                ...
                                                <q-btn icon="menu" padding="xs" round flat color="grey">
                                                    <q-menu auto-close transition-show="flip-right"  transition-hide="flip-left" self="center middle" anchor="center middle">
                                                        <q-list dense rounded nav>
                                                            <template v-if="auth.canView('evalcurricular/view')">
                                                                <q-item link clickable v-ripple :to="`/evalcurricular/view/${props.row.idec}`">
                                                                    <q-item-section>
                                                            ...
                                                            <template v-if="auth.canView('evalcurricular/edit')">
                                                                <q-item link clickable v-ripple :to="`/evalcurricular/edit/${props.row.idec}`">
                                                                    <q-item-section>
                                                            ...
                                                            <template v-if="auth.canView('evalcurricular/delete')">
                                                                <q-item link clickable v-ripple @click="deleteItem(props.row.idec)">
                                                                    <q-item-section>
...
<script setup>
	...
	const props = defineProps({
		...
		pageName : {
			type : String,
			default : 'evalcurricular',
		},
		routeName : {
			type : String,
			default : 'evalcurricularlist',
		},
		apiPath : {
			type : String,
			default : 'evalcurricular/index',
		},
		paginate: {
			type: Boolean,
			default: true,
