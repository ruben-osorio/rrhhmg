                ...
                <div class="container-fluid">
                    <div class="row justify-between items-center q-col-gutter-md">
                        ...
                        <div  class="col-md-auto col-12 " >
                            <template v-if="auth.canView('/formacion_guia/add')">
                                <q-btn       :rounded="false"  size=""  color="primary" no-caps  unelevated   :to="`/formacion_guia/add`" class="" >
                        ...
                        <div >
                            <template v-if="showBreadcrumbs && $route.query.tag">
                                <q-breadcrumbs class="q-pa-md">
                                    <q-breadcrumbs-el icon="arrow_back" class="text-capitalize" :label="$route.query.tag" to="/formacion_guia"></q-breadcrumbs-el>
                            ...
                            <div >
                                ...
                                :bordered="false"
                                :columns="app.menus.FormacionGuiaListHeaderItems" 
                                :rows="records"
                                ...
                                <template v-slot:body="props">
                                    <q-tr :class="{selected: isCurrentRecord(props.row)}" :props="props">
                                                ...
                                                <q-btn icon="menu" padding="xs" round flat color="grey">
                                                    <q-menu auto-close transition-show="flip-right"  transition-hide="flip-left" self="center middle" anchor="center middle">
                                                        <q-list dense rounded nav>
                                                            <template v-if="auth.canView('formacion_guia/view')">
                                                                <q-item link clickable v-ripple :to="`/formacion_guia/view/${props.row.idfg}`">
                                                                    <q-item-section>
                                                            ...
                                                            <template v-if="auth.canView('formacion_guia/edit')">
                                                                <q-item link clickable v-ripple :to="`/formacion_guia/edit/${props.row.idfg}`">
                                                                    <q-item-section>
                                                            ...
                                                            <template v-if="auth.canView('formacion_guia/delete')">
                                                                <q-item link clickable v-ripple @click="deleteItem(props.row.idfg)">
                                                                    <q-item-section>
                                        ...
                                        <q-td  key="idfg" :props="props">
                                            <q-btn padding="xs"   :rounded="false"  color="primary"  no-caps  unelevated   flat :to="`/formacion_guia/view/${props.row.idfg}`">{{ props.row.idfg }}</q-btn>
                                        </q-td>
                                        <q-td  key="valorfg" :props="props">
                                            {{ props.row.valorfg }}
                                        </q-td>
                                        <q-td  key="descripciofg" :props="props">
                                            {{ props.row.descripciofg }}
                                        </q-td>
...
<script setup>
	...
	const props = defineProps({
		...
		routeName : {
			type : String,
			default : 'formacion_guialist',
		},
		apiPath : {
			type : String,
			default : 'formacion_guia/index',
		},
		paginate: {
			type: Boolean,
			default: true,
