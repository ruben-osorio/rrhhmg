                ...
                <div class="container-fluid">
                    <div class="row justify-between items-center q-col-gutter-md">
                        ...
                        <div  class="col-md-auto col-12 " >
                            <template v-if="auth.canView('/unidad/add')">
                                <q-btn       :rounded="false"  size=""  color="primary" no-caps  unelevated   :to="`/unidad/add`" class="" >
                        ...
                        <div >
                            <template v-if="showBreadcrumbs && $route.query.tag">
                                <q-breadcrumbs class="q-pa-md">
                                    <q-breadcrumbs-el icon="arrow_back" class="text-capitalize" :label="$route.query.tag" to="/unidad"></q-breadcrumbs-el>
                            ...
                            <div class="row q-col-gutter-x-md q-col-gutter-md justify-start">
                                <div class="col">
                                    ...
                                    <div >
                                        ...
                                        :bordered="false"
                                        :columns="app.menus.UnidadListHeaderItems" 
                                        :rows="records"
                                        ...
                                        <template v-slot:body="props">
                                            <q-tr :class="{selected: isCurrentRecord(props.row)}" :props="props">
                                                ...
                                                <q-td  key="dependencia" :props="props">
                                                    <q-btn v-if="props.row.dependencia" @click="app.openPageDialog({ page: 'unidad/view', url: `/unidad/view/${props.row.dependencia}` , closeBtn: true })" padding="xs" flat color="primary" no-caps >
                                                        <q-icon name="visibility" size="xs"  class="q-mr-xs"></q-icon>  Unidad
                                                    </q-btn>
                                                </q-td>
                                                <q-td  key="codentidad" :props="props">
                                                    <q-btn v-if="props.row.codentidad" @click="app.openPageDialog({ page: 'entidad/view', url: `/entidad/view/${props.row.codentidad}` , closeBtn: true })" padding="xs" flat color="primary" no-caps >
                                                        <q-icon name="visibility" size="xs"  class="q-mr-xs"></q-icon>  Entidad
                                                    </q-btn>
                                                </q-td>
                                                <q-td  key="idunidad" :props="props">
                                                    <q-btn padding="xs"   :rounded="false"  color="primary"  no-caps  unelevated   flat :to="`/unidad/view/${props.row.idunidad}`">{{ props.row.idunidad }}</q-btn>
                                                </q-td>
                                                        ...
                                                        <q-btn icon="menu" padding="xs" round flat color="grey">
                                                            <q-menu auto-close transition-show="flip-right"  transition-hide="flip-left" self="center middle" anchor="center middle">
                                                                <q-list dense rounded nav>
                                                                    <template v-if="auth.canView('unidad/view')">
                                                                        <q-item link clickable v-ripple :to="`/unidad/view/${props.row.idunidad}`">
                                                                            <q-item-section>
                                                                    ...
                                                                    <template v-if="auth.canView('unidad/edit')">
                                                                        <q-item link clickable v-ripple :to="`/unidad/edit/${props.row.idunidad}`">
                                                                            <q-item-section>
