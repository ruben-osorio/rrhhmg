                ...
                <div class="container-fluid">
                    <div class="row justify-between items-center q-col-gutter-md">
                        ...
                        <div  class="col-md-auto col-12 " >
                            <template v-if="auth.canView('/primariahv/add')">
                                <q-btn       :rounded="false"  size=""  color="primary" no-caps  unelevated   :to="`/primariahv/add`" class="" >
                        ...
                        <div >
                            <template v-if="showBreadcrumbs && $route.query.tag">
                                <q-breadcrumbs class="q-pa-md">
                                    <q-breadcrumbs-el icon="arrow_back" class="text-capitalize" :label="$route.query.tag" to="/primariahv"></q-breadcrumbs-el>
                            ...
                            <div >
                                ...
                                :bordered="false"
                                :columns="app.menus.PrimariahvListHeaderItems" 
                                :rows="records"
                                ...
                                <template v-slot:body="props">
                                    <q-tr :class="{selected: isCurrentRecord(props.row)}" :props="props">
                                                ...
                                                <q-btn icon="menu" padding="xs" round flat color="grey">
                                                    <q-menu auto-close transition-show="flip-right"  transition-hide="flip-left" self="center middle" anchor="center middle">
                                                        <q-list dense rounded nav>
                                                            <template v-if="auth.canView('primariahv/view')">
                                                                <q-item link clickable v-ripple :to="`/primariahv/view/${props.row.idprimariahv}`">
                                                                    <q-item-section>
                                                            ...
                                                            <template v-if="auth.canView('primariahv/edit')">
                                                                <q-item link clickable v-ripple :to="`/primariahv/edit/${props.row.idprimariahv}`">
                                                                    <q-item-section>
                                                            ...
                                                            <template v-if="auth.canView('primariahv/delete')">
                                                                <q-item link clickable v-ripple @click="deleteItem(props.row.idprimariahv)">
                                                                    <q-item-section>
                                        ...
                                        <q-td  key="idprimariahv" :props="props">
                                            <q-btn padding="xs"   :rounded="false"  color="primary"  no-caps  unelevated   flat :to="`/primariahv/view/${props.row.idprimariahv}`">{{ props.row.idprimariahv }}</q-btn>
                                        </q-td>
                                        <q-td  key="nombreprimhv" :props="props">
                                            {{ props.row.nombreprimhv }}
                                        </q-td>
...
<script setup>
	...
	const props = defineProps({
		...
		routeName : {
			type : String,
			default : 'primariahvlist',
		},
		apiPath : {
			type : String,
			default : 'primariahv/index',
		},
		paginate: {
			type: Boolean,
			default: true,
