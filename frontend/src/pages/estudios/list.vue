                        ...
                        <div  class="col-md-auto col-12 " >
                            <div class="">
                                <div class="reset-grid">
                                    <list-escala-page ref="escalaListPage"  :limit="15" :show-header="true" :show-breadcrumbs="true" :show-footer="true" :paginate="true">
                                        </list-escala-page>
                                    </div>
                                </div>
                                <template v-if="auth.canView('/estudios/add')">
                                    <q-btn       :rounded="false"  size=""  color="primary" no-caps  unelevated   :to="`/estudios/add`" class="" >
                            ...
                            <div >
                                <template v-if="showBreadcrumbs && $route.query.tag">
                                    <q-breadcrumbs class="q-pa-md">
                                        <q-breadcrumbs-el icon="arrow_back" class="text-capitalize" :label="$route.query.tag" to="/estudios"></q-breadcrumbs-el>
                                ...
                                <div >
                                    ...
                                    :bordered="false"
                                    :columns="app.menus.EstudiosListHeaderItems" 
                                    :rows="records"
                                    ...
                                    <template v-slot:body="props">
                                        <q-tr :class="{selected: isCurrentRecord(props.row)}" :props="props">
                                            ...
                                            <q-td  key="idestudio" :props="props">
                                                <q-btn padding="xs"   :rounded="false"  color="primary"  no-caps  unelevated   flat :to="`/estudios/view/${props.row.idestudio}`">{{ props.row.idestudio }}</q-btn>
                                            </q-td>
                                            <q-td  key="codhoja" :props="props">
                                                <q-btn v-if="props.row.codhoja" @click="app.openPageDialog({ page: 'hojavida/view', url: `/hojavida/view/${props.row.codhoja}` , closeBtn: true })" padding="xs" flat color="primary" no-caps >
                                                    <q-icon name="visibility" size="xs"  class="q-mr-xs"></q-icon>  Hojavida
                                                </q-btn>
                                            </q-td>
                                            ...
                                            <q-td  key="g_inicio" :props="props">
                                                {{ props.row.g_inicio }}
                                            </q-td>
                                            <q-td  key="g_fin" :props="props">
                                                {{ props.row.g_fin }}
                                            </q-td>
                                                    ...
                                                    <q-btn icon="menu" padding="xs" round flat color="grey">
                                                        <q-menu auto-close transition-show="flip-right"  transition-hide="flip-left" self="center middle" anchor="center middle">
                                                            <q-list dense rounded nav>
                                                                <template v-if="auth.canView('estudios/view')">
                                                                    <q-item link clickable v-ripple :to="`/estudios/view/${props.row.idestudio}`">
                                                                        <q-item-section>
                                                                ...
                                                                <template v-if="auth.canView('estudios/edit')">
                                                                    <q-item link clickable v-ripple :to="`/estudios/edit/${props.row.idestudio}`">
                                                                        <q-item-section>
                                                                ...
                                                                <template v-if="auth.canView('estudios/delete')">
                                                                    <q-item link clickable v-ripple @click="deleteItem(props.row.idestudio)">
                                                                        <q-item-section>
...
<script setup>
	...
	const props = defineProps({
		...
		routeName : {
			type : String,
			default : 'estudioslist',
		},
		apiPath : {
			type : String,
			default : 'estudios/index',
		},
		paginate: {
			type: Boolean,
			default: true,
