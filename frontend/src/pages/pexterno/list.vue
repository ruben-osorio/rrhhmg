                ...
                <div class="container-fluid">
                    <div class="row justify-between items-center q-col-gutter-md">
                        ...
                        <div  class="col-md-auto col-12 " >
                            <template v-if="auth.canView('/pexterno/add')">
                                <q-btn       :rounded="false"  size=""  color="primary" no-caps  unelevated   :to="`/pexterno/add`" class="" >
                        ...
                        <div >
                            <template v-if="showBreadcrumbs && $route.query.tag">
                                <q-breadcrumbs class="q-pa-md">
                                    <q-breadcrumbs-el icon="arrow_back" class="text-capitalize" :label="$route.query.tag" to="/pexterno"></q-breadcrumbs-el>
                            ...
                            <div >
                                ...
                                :bordered="false"
                                :columns="app.menus.PexternoListHeaderItems" 
                                :rows="records"
                                ...
                                <template v-slot:body="props">
                                    <q-tr :class="{selected: isCurrentRecord(props.row)}" :props="props">
                                        ...
                                        <q-td  key="idpexterno" :props="props">
                                            <q-btn padding="xs"   :rounded="false"  color="primary"  no-caps  unelevated   flat :to="`/pexterno/view/${props.row.idpexterno}`">{{ props.row.idpexterno }}</q-btn>
                                        </q-td>
                                                ...
                                                <q-btn icon="menu" padding="xs" round flat color="grey">
                                                    <q-menu auto-close transition-show="flip-right"  transition-hide="flip-left" self="center middle" anchor="center middle">
                                                        <q-list dense rounded nav>
                                                            <template v-if="auth.canView('pexterno/view')">
                                                                <q-item link clickable v-ripple :to="`/pexterno/view/${props.row.idpexterno}`">
                                                                    <q-item-section>
                                                            ...
                                                            <template v-if="auth.canView('pexterno/edit')">
                                                                <q-item link clickable v-ripple :to="`/pexterno/edit/${props.row.idpexterno}`">
                                                                    <q-item-section>
                                                            ...
                                                            <template v-if="auth.canView('pexterno/delete')">
                                                                <q-item link clickable v-ripple @click="deleteItem(props.row.idpexterno)">
                                                                    <q-item-section>
...
<script setup>
	...
	const props = defineProps({
		...
		routeName : {
			type : String,
			default : 'pexternolist',
		},
		apiPath : {
			type : String,
			default : 'pexterno/index',
		},
		paginate: {
			type: Boolean,
			default: true,
