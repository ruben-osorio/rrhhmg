                ...
                <div class="container-fluid">
                    <div class="row justify-between items-center q-col-gutter-md">
                        ...
                        <div  class="col-md-auto col-12 " >
                            <template v-if="auth.canView('/carrerashv/add')">
                                <q-btn       :rounded="false"  size=""  color="primary" no-caps  unelevated   :to="`/carrerashv/add`" class="" >
                        ...
                        <div >
                            <template v-if="showBreadcrumbs && $route.query.tag">
                                <q-breadcrumbs class="q-pa-md">
                                    <q-breadcrumbs-el icon="arrow_back" class="text-capitalize" :label="$route.query.tag" to="/carrerashv"></q-breadcrumbs-el>
                            ...
                            <div >
                                ...
                                :bordered="false"
                                :columns="app.menus.CarrerashvListHeaderItems" 
                                :rows="records"
                                ...
                                <template v-slot:body="props">
                                    <q-tr :class="{selected: isCurrentRecord(props.row)}" :props="props">
                                                ...
                                                <q-btn icon="menu" padding="xs" round flat color="grey">
                                                    <q-menu auto-close transition-show="flip-right"  transition-hide="flip-left" self="center middle" anchor="center middle">
                                                        <q-list dense rounded nav>
                                                            <template v-if="auth.canView('carrerashv/view')">
                                                                <q-item link clickable v-ripple :to="`/carrerashv/view/${props.row.idcarrerashv}`">
                                                                    <q-item-section>
                                                            ...
                                                            <template v-if="auth.canView('carrerashv/edit')">
                                                                <q-item link clickable v-ripple :to="`/carrerashv/edit/${props.row.idcarrerashv}`">
                                                                    <q-item-section>
                                                            ...
                                                            <template v-if="auth.canView('carrerashv/delete')">
                                                                <q-item link clickable v-ripple @click="deleteItem(props.row.idcarrerashv)">
                                                                    <q-item-section>
                                        ...
                                        <q-td  key="idcarrerashv" :props="props">
                                            <q-btn padding="xs"   :rounded="false"  color="primary"  no-caps  unelevated   flat :to="`/carrerashv/view/${props.row.idcarrerashv}`">{{ props.row.idcarrerashv }}</q-btn>
                                        </q-td>
                                        <q-td  key="carrerashv" :props="props">
                                            {{ props.row.carrerashv }}
                                        </q-td>
...
<script setup>
	...
	const props = defineProps({
		...
		routeName : {
			type : String,
			default : 'carrerashvlist',
		},
		apiPath : {
			type : String,
			default : 'carrerashv/index',
		},
		paginate: {
			type: Boolean,
			default: true,
