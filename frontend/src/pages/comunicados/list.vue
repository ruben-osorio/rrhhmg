                ...
                <div class="container-fluid">
                    <div class="row justify-between items-center q-col-gutter-md">
                        ...
                        <div  class="col-md-auto col-12 " >
                            <template v-if="auth.canView('/comunicados/add')">
                                <q-btn       :rounded="false"  size=""  color="primary" no-caps  unelevated   :to="`/comunicados/add`" class="" >
                        ...
                        <div >
                            <template v-if="showBreadcrumbs && $route.query.tag">
                                <q-breadcrumbs class="q-pa-md">
                                    <q-breadcrumbs-el icon="arrow_back" class="text-capitalize" :label="$route.query.tag" to="/comunicados"></q-breadcrumbs-el>
                            ...
                            <div >
                                ...
                                :bordered="false"
                                :columns="app.menus.ComunicadosListHeaderItems" 
                                :rows="records"
                                ...
                                <template v-slot:body="props">
                                    <q-tr :class="{selected: isCurrentRecord(props.row)}" :props="props">
                                        ...
                                        <q-td  key="fechacom" :props="props">
                                            {{ props.row.fechacom }}
                                        </q-td>
                                        <q-td  key="fecha" :props="props">
                                            {{ props.row.fecha }}
                                        </q-td>
                                        <q-td  key="idcomunicado" :props="props">
                                            <q-btn padding="xs"   :rounded="false"  color="primary"  no-caps  unelevated   flat :to="`/comunicados/view/${props.row.idcomunicado}`">{{ props.row.idcomunicado }}</q-btn>
                                        </q-td>
                                                ...
                                                <q-btn icon="menu" padding="xs" round flat color="grey">
                                                    <q-menu auto-close transition-show="flip-right"  transition-hide="flip-left" self="center middle" anchor="center middle">
                                                        <q-list dense rounded nav>
                                                            <template v-if="auth.canView('comunicados/view')">
                                                                <q-item link clickable v-ripple :to="`/comunicados/view/${props.row.idcomunicado}`">
                                                                    <q-item-section>
                                                            ...
                                                            <template v-if="auth.canView('comunicados/edit')">
                                                                <q-item link clickable v-ripple :to="`/comunicados/edit/${props.row.idcomunicado}`">
                                                                    <q-item-section>
                                                            ...
                                                            <template v-if="auth.canView('comunicados/delete')">
                                                                <q-item link clickable v-ripple @click="deleteItem(props.row.idcomunicado)">
                                                                    <q-item-section>
