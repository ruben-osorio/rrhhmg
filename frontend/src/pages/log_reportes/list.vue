                ...
                <div class="container-fluid">
                    <div class="row justify-between items-center q-col-gutter-md">
                        ...
                        <div  class="col-md-auto col-12 " >
                            <template v-if="auth.canView('/log_reportes/add')">
                                <q-btn       :rounded="false"  size=""  color="primary" no-caps  unelevated   :to="`/log_reportes/add`" class="" >
                        ...
                        <div >
                            <template v-if="showBreadcrumbs && $route.query.tag">
                                <q-breadcrumbs class="q-pa-md">
                                    <q-breadcrumbs-el icon="arrow_back" class="text-capitalize" :label="$route.query.tag" to="/log_reportes"></q-breadcrumbs-el>
                            ...
                            <div >
                                ...
                                :bordered="false"
                                :columns="app.menus.LogReportesListHeaderItems" 
                                :rows="records"
                                ...
                                <template v-slot:body="props">
                                    <q-tr :class="{selected: isCurrentRecord(props.row)}" :props="props">
                                        ...
                                        <q-td  key="feccumple" :props="props">
                                            {{ props.row.feccumple }}
                                        </q-td>
                                        <q-td  key="vacaciones" :props="props">
                                            {{ props.row.vacaciones }}
                                        </q-td>
                                        <q-td  key="cviajes" :props="props">
                                            {{ props.row.cviajes }}
                                        </q-td>
                                        <q-td  key="bmedicas" :props="props">
                                            {{ props.row.bmedicas }}
                                        </q-td>
                                        <q-td  key="singocehaber" :props="props">
                                            {{ props.row.singocehaber }}
                                        </q-td>
                                        <q-td  key="id_log_reporte" :props="props">
                                            <q-btn padding="xs"   :rounded="false"  color="primary"  no-caps  unelevated   flat :to="`/log_reportes/view/${props.row.id_log_reporte}`">{{ props.row.id_log_reporte }}</q-btn>
                                        </q-td>
                                        <q-td  key="fecha_reporte" :props="props">
                                            {{ props.row.fecha_reporte }}
                                        </q-td>
                                        <q-td  key="falta" :props="props">
                                            {{ props.row.falta }}
                                        </q-td>
                                        <q-td  key="abandono" :props="props">
                                            {{ props.row.abandono }}
                                        </q-td>
                                        ...
                                        <q-td  key="usuario_reporte" :props="props">
                                            {{ props.row.usuario_reporte }}
                                        </q-td>
                                        <q-td  key="fecha_reporte_cadena" :props="props">
                                            {{ props.row.fecha_reporte_cadena }}
                                        </q-td>
                                        <q-td  key="documento_identidad" :props="props">
                                            {{ props.row.documento_identidad }}
                                        </q-td>
                                                ...
                                                <q-btn icon="menu" padding="xs" round flat color="grey">
                                                    <q-menu auto-close transition-show="flip-right"  transition-hide="flip-left" self="center middle" anchor="center middle">
                                                        <q-list dense rounded nav>
                                                            <template v-if="auth.canView('log_reportes/view')">
                                                                <q-item link clickable v-ripple :to="`/log_reportes/view/${props.row.id_log_reporte}`">
                                                                    <q-item-section>
                                                            ...
                                                            <template v-if="auth.canView('log_reportes/edit')">
                                                                <q-item link clickable v-ripple :to="`/log_reportes/edit/${props.row.id_log_reporte}`">
                                                                    <q-item-section>
                                                            ...
                                                            <template v-if="auth.canView('log_reportes/delete')">
                                                                <q-item link clickable v-ripple @click="deleteItem(props.row.id_log_reporte)">
                                                                    <q-item-section>
...
<script setup>
	...
	const props = defineProps({
		primaryKey : {
			type : String,
			default : 'id_log_reporte',
		},
		pageName : {
			type : String,
			default : 'log_reportes',
		},
		routeName : {
			type : String,
			default : 'log_reporteslist',
		},
		apiPath : {
			type : String,
			default : 'log_reportes/index',
		},
		paginate: {
			type: Boolean,
			default: true,
