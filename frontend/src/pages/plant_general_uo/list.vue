                ...
                <div class="container-fluid">
                    <div class="row justify-between items-center q-col-gutter-md">
                        ...
                        <div  class="col-md-auto col-12 " >
                            <template v-if="auth.canView('/plant_general_uo/add')">
                                <q-btn       :rounded="false"  size=""  color="primary" no-caps  unelevated   :to="`/plant_general_uo/add`" class="" >
                        ...
                        <div >
                            <template v-if="showBreadcrumbs && $route.query.tag">
                                <q-breadcrumbs class="q-pa-md">
                                    <q-breadcrumbs-el icon="arrow_back" class="text-capitalize" :label="$route.query.tag" to="/plant_general_uo"></q-breadcrumbs-el>
                            ...
                            <div >
                                ...
                                :bordered="false"
                                :columns="app.menus.PlantGeneralUoListHeaderItems" 
                                :rows="records"
                                ...
                                <template v-slot:body="props">
                                    <q-tr :class="{selected: isCurrentRecord(props.row)}" :props="props">
                                                ...
                                                <q-btn icon="menu" padding="xs" round flat color="grey">
                                                    <q-menu auto-close transition-show="flip-right"  transition-hide="flip-left" self="center middle" anchor="center middle">
                                                        <q-list dense rounded nav>
                                                            <template v-if="auth.canView('plant_general_uo/view')">
                                                                <q-item link clickable v-ripple :to="`/plant_general_uo/view/${props.row.idpuo}`">
                                                                    <q-item-section>
                                                            ...
                                                            <template v-if="auth.canView('plant_general_uo/edit')">
                                                                <q-item link clickable v-ripple :to="`/plant_general_uo/edit/${props.row.idpuo}`">
                                                                    <q-item-section>
                                                            ...
                                                            <template v-if="auth.canView('plant_general_uo/delete')">
                                                                <q-item link clickable v-ripple @click="deleteItem(props.row.idpuo)">
                                                                    <q-item-section>
                                        ...
                                        <q-td  key="idpuo" :props="props">
                                            <q-btn padding="xs"   :rounded="false"  color="primary"  no-caps  unelevated   flat :to="`/plant_general_uo/view/${props.row.idpuo}`">{{ props.row.idpuo }}</q-btn>
                                        </q-td>
                                        <q-td  key="codn1" :props="props">
                                            {{ props.row.codn1 }}
                                        </q-td>
                                        <q-td  key="codn2" :props="props">
                                            {{ props.row.codn2 }}
                                        </q-td>
                                        <q-td  key="codn3" :props="props">
                                            {{ props.row.codn3 }}
                                        </q-td>
                                        <q-td  key="codn4" :props="props">
                                            {{ props.row.codn4 }}
                                        </q-td>
                                        <q-td  key="codn5" :props="props">
                                            {{ props.row.codn5 }}
                                        </q-td>
                                        <q-td  key="codn6" :props="props">
                                            {{ props.row.codn6 }}
                                        </q-td>
                                        <q-td  key="sigla" :props="props">
                                            {{ props.row.sigla }}
                                        </q-td>
                                        <q-td  key="prefijosoa" :props="props">
                                            {{ props.row.prefijosoa }}
                                        </q-td>
                                        <q-td  key="nombreuo" :props="props">
                                            {{ props.row.nombreuo }}
                                        </q-td>
                                        <q-td  key="clasificacionuo" :props="props">
                                            {{ props.row.clasificacionuo }}
                                        </q-td>
                                        <q-td  key="dependenciauo" :props="props">
                                            {{ props.row.dependenciauo }}
                                        </q-td>
                                        <q-td  key="niveluo" :props="props">
                                            {{ props.row.niveluo }}
                                        </q-td>
                                        <q-td  key="codgestion" :props="props">
                                            {{ props.row.codgestion }}
                                        </q-td>
                                        <q-td  key="nrodependencia" :props="props">
                                            {{ props.row.nrodependencia }}
                                        </q-td>
                                    </q-tr>
                                </template>
                                <!-- End of Table Layout-->
...
<script setup>
	...
	const props = defineProps({
		...
		routeName : {
			type : String,
			default : 'plant_general_uolist',
		},
		apiPath : {
			type : String,
			default : 'plant_general_uo/index',
		},
		paginate: {
			type: Boolean,
			default: true,
