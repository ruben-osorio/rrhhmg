                    ...
                    <div class="row justify-between items-center q-col-gutter-md">
                        <div  class="col col-md-auto " >
                            <div class=" text-h6 text-primary" >
                                Declaracion Pregunta Usuario
                            </div>
                        </div>
                        <div  class="col-md-auto col-12 " >
                            <template v-if="auth.canView('/declaracion_pregunta_usuario/add')">
                                <q-btn       :rounded="false"  size=""  color="primary" no-caps  unelevated   :to="`/declaracion_pregunta_usuario/add`" class="" >
                        ...
                        <div >
                            <template v-if="showBreadcrumbs && $route.query.tag">
                                <q-breadcrumbs class="q-pa-md">
                                    <q-breadcrumbs-el icon="arrow_back" class="text-capitalize" :label="$route.query.tag" to="/declaracion_pregunta_usuario"></q-breadcrumbs-el>
                            ...
                            <div >
                                ...
                                :bordered="false"
                                :columns="app.menus.DeclaracionPreguntaUsuarioListHeaderItems" 
                                :rows="records"
                                ...
                                selection="multiple"
                                row-key="iddeclaracion_pregunta_usuario" 
                                ...
                                <template v-slot:body="props">
                                    <q-tr :class="{selected: isCurrentRecord(props.row)}" :props="props">
                                        ...
                                        <q-td  key="iddeclaracion_pregunta_usuario" :props="props">
                                            <q-btn padding="xs"   :rounded="false"  color="primary"  no-caps  unelevated   flat :to="`/declaracion_pregunta_usuario/view/${props.row.iddeclaracion_pregunta_usuario}`">{{ props.row.iddeclaracion_pregunta_usuario }}</q-btn>
                                        </q-td>
                                        <q-td  key="iddeclaracion" :props="props">
                                            <q-btn v-if="props.row.iddeclaracion" @click="app.openPageDialog({ page: 'declaraciones/view', url: `/declaraciones/view/${props.row.iddeclaracion}` , closeBtn: true })" padding="xs" flat color="primary" no-caps >
                                                <q-icon name="visibility" size="xs"  class="q-mr-xs"></q-icon>  Declaraciones
                                            </q-btn>
                                        </q-td>
                                        ...
                                        <q-td  key="coddeclaracion" :props="props">
                                            {{ props.row.coddeclaracion }}
                                        </q-td>
                                                ...
                                                <q-btn icon="menu" padding="xs" round flat color="grey">
                                                    <q-menu auto-close transition-show="flip-right"  transition-hide="flip-left" self="center middle" anchor="center middle">
                                                        <q-list dense rounded nav>
                                                            <template v-if="auth.canView('declaracion_pregunta_usuario/view')">
                                                                <q-item link clickable v-ripple :to="`/declaracion_pregunta_usuario/view/${props.row.iddeclaracion_pregunta_usuario}`">
                                                                    <q-item-section>
                                                            ...
                                                            <template v-if="auth.canView('declaracion_pregunta_usuario/edit')">
                                                                <q-item link clickable v-ripple :to="`/declaracion_pregunta_usuario/edit/${props.row.iddeclaracion_pregunta_usuario}`">
                                                                    <q-item-section>
                                                            ...
                                                            <template v-if="auth.canView('declaracion_pregunta_usuario/delete')">
                                                                <q-item link clickable v-ripple @click="deleteItem(props.row.iddeclaracion_pregunta_usuario)">
                                                                    <q-item-section>
...
<script setup>
	...
	const props = defineProps({
		...
		routeName : {
			type : String,
			default : 'declaracion_pregunta_usuariolist',
		},
		apiPath : {
			type : String,
			default : 'declaracion_pregunta_usuario/index',
		},
		paginate: {
			type: Boolean,
			default: true,
	...
	const pageTitle = computed({
		get: function () {
			return "Declaracion Pregunta Usuario"
		}
	});
