                ...
                <div class="container-fluid">
                    <div class="row justify-between items-center q-col-gutter-md">
                        ...
                        <div  class="col-md-auto col-12 " >
                            <template v-if="auth.canView('/grado_univhv/add')">
                                <q-btn       :rounded="false"  size=""  color="primary" no-caps  unelevated   :to="`/grado_univhv/add`" class="" >
                        ...
                        <div >
                            <template v-if="showBreadcrumbs && $route.query.tag">
                                <q-breadcrumbs class="q-pa-md">
                                    <q-breadcrumbs-el icon="arrow_back" class="text-capitalize" :label="$route.query.tag" to="/grado_univhv"></q-breadcrumbs-el>
                            ...
                            <div >
                                ...
                                :bordered="false"
                                :columns="app.menus.GradoUnivhvListHeaderItems" 
                                :rows="records"
                                ...
                                <template v-slot:body="props">
                                    <q-tr :class="{selected: isCurrentRecord(props.row)}" :props="props">
                                                ...
                                                <q-btn icon="menu" padding="xs" round flat color="grey">
                                                    <q-menu auto-close transition-show="flip-right"  transition-hide="flip-left" self="center middle" anchor="center middle">
                                                        <q-list dense rounded nav>
                                                            <template v-if="auth.canView('grado_univhv/view')">
                                                                <q-item link clickable v-ripple :to="`/grado_univhv/view/${props.row.idgraduniv}`">
                                                                    <q-item-section>
                                                            ...
                                                            <template v-if="auth.canView('grado_univhv/edit')">
                                                                <q-item link clickable v-ripple :to="`/grado_univhv/edit/${props.row.idgraduniv}`">
                                                                    <q-item-section>
                                                            ...
                                                            <template v-if="auth.canView('grado_univhv/delete')">
                                                                <q-item link clickable v-ripple @click="deleteItem(props.row.idgraduniv)">
                                                                    <q-item-section>
                                        ...
                                        <q-td  key="idgraduniv" :props="props">
                                            <q-btn padding="xs"   :rounded="false"  color="primary"  no-caps  unelevated   flat :to="`/grado_univhv/view/${props.row.idgraduniv}`">{{ props.row.idgraduniv }}</q-btn>
                                        </q-td>
                                        <q-td  key="nombregrado_hv" :props="props">
                                            {{ props.row.nombregrado_hv }}
                                        </q-td>
...
<script setup>
	...
	const props = defineProps({
		...
		pageName : {
			type : String,
			default : 'grado_univhv',
		},
		routeName : {
			type : String,
			default : 'grado_univhvlist',
		},
		apiPath : {
			type : String,
			default : 'grado_univhv/index',
		},
		paginate: {
			type: Boolean,
			default: true,
