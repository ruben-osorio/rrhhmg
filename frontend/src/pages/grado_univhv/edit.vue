                                        ...
                                        <div class="col-12">
                                            <div class="row">
                                                ...
                                                <div class="col-sm-9 col-12">
                                                    <q-input   ref="ctrlnombregrado_hv" v-model.trim="formData.nombregrado_hv"  label="Nombregrado Hv" type="text" placeholder="Escribir Nombregrado Hv"      
                                                    class="" :error="isFieldValid('nombregrado_hv')" :error-message="getFieldError('nombregrado_hv')">
                                                    </q-input>
                                                </div>
                                            </div>
                                        </div>
...
<script setup>
	...
	const props = defineProps({
		...
		routeName: {
			type: String,
			default: 'grado_univhvedit',
		},
		pagePath: {
			type : String,
			default : 'grado_univhv/edit',
		},
		apiPath: {
			type: String,
			default: 'grado_univhv/edit',
