                ...
                <div class="container-fluid">
                    <div class="row justify-between items-center q-col-gutter-md">
                        ...
                        <div  class="col-md-auto col-12 " >
                            <template v-if="auth.canView('/configuracion/add')">
                                <q-btn       :rounded="false"  size=""  color="primary" no-caps  unelevated   :to="`/configuracion/add`" class="" >
                        ...
                        <div >
                            <template v-if="showBreadcrumbs && $route.query.tag">
                                <q-breadcrumbs class="q-pa-md">
                                    <q-breadcrumbs-el icon="arrow_back" class="text-capitalize" :label="$route.query.tag" to="/configuracion"></q-breadcrumbs-el>
                            ...
                            <div >
                                ...
                                :bordered="false"
                                :columns="app.menus.ConfiguracionListHeaderItems" 
                                :rows="records"
                                ...
                                <template v-slot:body="props">
                                    <q-tr :class="{selected: isCurrentRecord(props.row)}" :props="props">
                                        ...
                                        <q-td  key="idconf" :props="props">
                                            <q-btn padding="xs"   :rounded="false"  color="primary"  no-caps  unelevated   flat :to="`/configuracion/view/${props.row.idconf}`">{{ props.row.idconf }}</q-btn>
                                        </q-td>
                                        <q-td  key="refrigerio" :props="props">
                                            {{ props.row.refrigerio }}
                                        </q-td>
                                        <q-td  key="descafp" :props="props">
                                            {{ props.row.descafp }}
                                        </q-td>
                                        <q-td  key="desciva" :props="props">
                                            {{ props.row.desciva }}
                                        </q-td>
                                        <q-td  key="frontera" :props="props">
                                            {{ props.row.frontera }}
                                        </q-td>
                                        <q-td  key="minnacional" :props="props">
                                            {{ props.row.minnacional }}
                                        </q-td>
                                                ...
                                                <q-btn icon="menu" padding="xs" round flat color="grey">
                                                    <q-menu auto-close transition-show="flip-right"  transition-hide="flip-left" self="center middle" anchor="center middle">
                                                        <q-list dense rounded nav>
                                                            <template v-if="auth.canView('configuracion/view')">
                                                                <q-item link clickable v-ripple :to="`/configuracion/view/${props.row.idconf}`">
                                                                    <q-item-section>
                                                            ...
                                                            <template v-if="auth.canView('configuracion/edit')">
                                                                <q-item link clickable v-ripple :to="`/configuracion/edit/${props.row.idconf}`">
                                                                    <q-item-section>
                                                            ...
                                                            <template v-if="auth.canView('configuracion/delete')">
                                                                <q-item link clickable v-ripple @click="deleteItem(props.row.idconf)">
                                                                    <q-item-section>
...
<script setup>
	...
	const props = defineProps({
		...
		routeName : {
			type : String,
			default : 'configuracionlist',
		},
		apiPath : {
			type : String,
			default : 'configuracion/index',
		},
		paginate: {
			type: Boolean,
			default: true,
