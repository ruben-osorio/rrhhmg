                ...
                <div class="container-fluid">
                    <div class="row justify-between items-center q-col-gutter-md">
                        ...
                        <div  class="col-md-auto col-12 " >
                            <template v-if="auth.canView('/eo_maestra/add')">
                                <q-btn       :rounded="false"  size=""  color="primary" no-caps  unelevated   :to="`/eo_maestra/add`" class="" >
                        ...
                        <div >
                            <template v-if="showBreadcrumbs && $route.query.tag">
                                <q-breadcrumbs class="q-pa-md">
                                    <q-breadcrumbs-el icon="arrow_back" class="text-capitalize" :label="$route.query.tag" to="/eo_maestra"></q-breadcrumbs-el>
                            ...
                            <div >
                                ...
                                :bordered="false"
                                :columns="app.menus.EoMaestraListHeaderItems" 
                                :rows="records"
                                ...
                                <template v-slot:body="props">
                                    <q-tr :class="{selected: isCurrentRecord(props.row)}" :props="props">
                                                ...
                                                <q-btn icon="menu" padding="xs" round flat color="grey">
                                                    <q-menu auto-close transition-show="flip-right"  transition-hide="flip-left" self="center middle" anchor="center middle">
                                                        <q-list dense rounded nav>
                                                            <template v-if="auth.canView('eo_maestra/view')">
                                                                <q-item link clickable v-ripple :to="`/eo_maestra/view/${props.row.id_eo}`">
                                                                    <q-item-section>
                                                            ...
                                                            <template v-if="auth.canView('eo_maestra/edit')">
                                                                <q-item link clickable v-ripple :to="`/eo_maestra/edit/${props.row.id_eo}`">
                                                                    <q-item-section>
                                                            ...
                                                            <template v-if="auth.canView('eo_maestra/delete')">
                                                                <q-item link clickable v-ripple @click="deleteItem(props.row.id_eo)">
                                                                    <q-item-section>
                                        ...
                                        <q-td  key="id_eo" :props="props">
                                            <q-btn padding="xs"   :rounded="false"  color="primary"  no-caps  unelevated   flat :to="`/eo_maestra/view/${props.row.id_eo}`">{{ props.row.id_eo }}</q-btn>
                                        </q-td>
                                        <q-td  key="nro_eo" :props="props">
                                            {{ props.row.nro_eo }}
                                        </q-td>
                                        <q-td  key="fecha_reg_eo" :props="props">
                                            {{ props.row.fecha_reg_eo }}
                                        </q-td>
                                        <q-td  key="soa_eo" :props="props">
                                            {{ props.row.soa_eo }}
                                        </q-td>
                                        <q-td  key="sigla_eo" :props="props">
                                            {{ props.row.sigla_eo }}
                                        </q-td>
                                        <q-td  key="dependencia_eo" :props="props">
                                            {{ props.row.dependencia_eo }}
                                        </q-td>
                                        <q-td  key="cod_gestion_eo" :props="props">
                                            {{ props.row.cod_gestion_eo }}
                                        </q-td>
                                        <q-td  key="rm_eo" :props="props">
                                            {{ props.row.rm_eo }}
                                        </q-td>
                                        <q-td  key="nivel_eo" :props="props">
                                            {{ props.row.nivel_eo }}
                                        </q-td>
                                        <q-td  key="denominacion_eo" :props="props">
                                            {{ props.row.denominacion_eo }}
                                        </q-td>
                                    </q-tr>
                                </template>
                                <!-- End of Table Layout-->
...
<script setup>
	...
	const props = defineProps({
		...
		routeName : {
			type : String,
			default : 'eo_maestralist',
		},
		apiPath : {
			type : String,
			default : 'eo_maestra/index',
		},
		paginate: {
			type: Boolean,
			default: true,
