                                    ...
                                    <div class="row q-col-gutter-x-md">
                                        ...
                                        <div class="col-12">
                                            <div class="row">
                                                ...
                                                <div class="col-sm-9 col-12">
                                                    <q-input   ref="ctrlcodentidad" v-model.trim="formData.codentidad"  label="Codentidad" type="number" placeholder="Escribir Codentidad"   step="any"    
                                                    class="" :error="isFieldValid('codentidad')" :error-message="getFieldError('codentidad')">
                                                    </q-input>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-12">
                                            <div class="row">
                                                ...
                                                <div class="col-sm-9 col-12">
                                                    <q-input   ref="ctrldescripcion" v-model.trim="formData.descripcion"  label="Descripcion" type="text" placeholder="Escribir Descripcion"      
                                        ...
                                        <div class="col-12">
                                            <div class="row">
                                                ...
                                                <div class="col-sm-9 col-12">
                                                    <q-input   ref="ctrlley" v-model.trim="formData.ley"  label="Ley" type="text" placeholder="Escribir Ley"      
                                                    class="" :error="isFieldValid('ley')" :error-message="getFieldError('ley')">
                                                    </q-input>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-12">
                                            <div class="row">
                                                ...
                                                <div class="col-sm-9 col-12">
                                                    <q-input   ref="ctrlsoa" v-model.trim="formData.soa"  label="Soa" type="text" placeholder="Escribir Soa"      
...
<script setup>
	...
	const props = defineProps({
		...
		routeName : {
			type : String,
			default : 'plantilla_estructura_orgadd',
		},
		apiPath : {
			type : String,
			default : 'plantilla_estructura_org/add',
		},
		submitButtonLabel: {
			type: String,
			default: "Guardar",
	...
	function afterSubmit(response) {
		...
		if(app.isDialogOpen()){
			...
			app.navigateTo(`/plantilla_estructura_org`);
		}
	}
