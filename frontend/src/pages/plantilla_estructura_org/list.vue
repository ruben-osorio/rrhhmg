                    ...
                    <div class="row justify-between items-center q-col-gutter-md">
                        <div  class="col col-md-auto " >
                            <div class=" text-h6 text-primary" >
                                Plantilla Estructura Org
                            </div>
                        </div>
                        <div  class="col-md-auto col-12 " >
                            <template v-if="auth.canView('/plantilla_estructura_org/add')">
                                <q-btn       :rounded="false"  size=""  color="primary" no-caps  unelevated   :to="`/plantilla_estructura_org/add`" class="" >
                        ...
                        <div >
                            <template v-if="showBreadcrumbs && $route.query.tag">
                                <q-breadcrumbs class="q-pa-md">
                                    <q-breadcrumbs-el icon="arrow_back" class="text-capitalize" :label="$route.query.tag" to="/plantilla_estructura_org"></q-breadcrumbs-el>
                            ...
                            <div >
                                ...
                                :bordered="false"
                                :columns="app.menus.PlantillaEstructuraOrgListHeaderItems" 
                                :rows="records"
                                ...
                                <template v-slot:body="props">
                                    <q-tr :class="{selected: isCurrentRecord(props.row)}" :props="props">
                                                ...
                                                <q-btn icon="menu" padding="xs" round flat color="grey">
                                                    <q-menu auto-close transition-show="flip-right"  transition-hide="flip-left" self="center middle" anchor="center middle">
                                                        <q-list dense rounded nav>
                                                            <template v-if="auth.canView('plantilla_estructura_org/view')">
                                                                <q-item link clickable v-ripple :to="`/plantilla_estructura_org/view/${props.row.idunidad}`">
                                                                    <q-item-section>
                                                            ...
                                                            <template v-if="auth.canView('plantilla_estructura_org/edit')">
                                                                <q-item link clickable v-ripple :to="`/plantilla_estructura_org/edit/${props.row.idunidad}`">
                                                                    <q-item-section>
                                        ...
                                        <q-td  key="idunidad" :props="props">
                                            <q-btn padding="xs"   :rounded="false"  color="primary"  no-caps  unelevated   flat :to="`/plantilla_estructura_org/view/${props.row.idunidad}`">{{ props.row.idunidad }}</q-btn>
                                        </q-td>
...
<script setup>
	...
	const props = defineProps({
		...
		routeName : {
			type : String,
			default : 'plantilla_estructura_orglist',
		},
		apiPath : {
			type : String,
			default : 'plantilla_estructura_org/index',
		},
		paginate: {
			type: Boolean,
			default: true,
	...
	const pageTitle = computed({
		get: function () {
			return "Plantilla Estructura Org"
		}
	});
