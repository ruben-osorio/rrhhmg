                ...
                <div class="container-fluid">
                    <div class="row justify-between items-center q-col-gutter-md">
                        ...
                        <div  class="col-md-auto col-12 " >
                            <template v-if="auth.canView('/formposgestudios2/add')">
                                <q-btn       :rounded="false"  size=""  color="primary" no-caps  unelevated   :to="`/formposgestudios2/add`" class="" >
                        ...
                        <div >
                            <template v-if="showBreadcrumbs && $route.query.tag">
                                <q-breadcrumbs class="q-pa-md">
                                    <q-breadcrumbs-el icon="arrow_back" class="text-capitalize" :label="$route.query.tag" to="/formposgestudios2"></q-breadcrumbs-el>
                            ...
                            <div >
                                ...
                                :bordered="false"
                                :columns="app.menus.Formposgestudios2ListHeaderItems" 
                                :rows="records"
                                ...
                                <template v-slot:body="props">
                                    <q-tr :class="{selected: isCurrentRecord(props.row)}" :props="props">
                                        ...
                                        <q-td  key="cursocarrera" :props="props">
                                            {{ props.row.cursocarrera }}
                                        </q-td>
                                        <q-td  key="nombrecurso" :props="props">
                                            {{ props.row.nombrecurso }}
                                        </q-td>
                                        <q-td  key="lugarestudios" :props="props">
                                            {{ props.row.lugarestudios }}
                                        </q-td>
                                        <q-td  key="gestionestudios" :props="props">
                                            {{ props.row.gestionestudios }}
                                        </q-td>
                                        <q-td  key="fechatitulo" :props="props">
                                            {{ props.row.fechatitulo }}
                                        </q-td>
                                        <q-td  key="tienetitulo" :props="props">
                                            {{ props.row.tienetitulo }}
                                        </q-td>
                                        <q-td  key="modalidadcursoest" :props="props">
                                            {{ props.row.modalidadcursoest }}
                                        </q-td>
                                                ...
                                                <q-btn icon="menu" padding="xs" round flat color="grey">
                                                    <q-menu auto-close transition-show="flip-right"  transition-hide="flip-left" self="center middle" anchor="center middle">
                                                        <q-list dense rounded nav>
                                                            <template v-if="auth.canView('formposgestudios2/view')">
                                                                <q-item link clickable v-ripple :to="`/formposgestudios2/view/${props.row.idpstestudios}`">
                                                                    <q-item-section>
                                                            ...
                                                            <template v-if="auth.canView('formposgestudios2/edit')">
                                                                <q-item link clickable v-ripple :to="`/formposgestudios2/edit/${props.row.idpstestudios}`">
                                                                    <q-item-section>
                                                            ...
                                                            <template v-if="auth.canView('formposgestudios2/delete')">
                                                                <q-item link clickable v-ripple @click="deleteItem(props.row.idpstestudios)">
                                                                    <q-item-section>
...
<script setup>
	...
	const props = defineProps({
		...
		routeName : {
			type : String,
			default : 'formposgestudios2list',
		},
		apiPath : {
			type : String,
			default : 'formposgestudios2/index',
		},
		paginate: {
			type: Boolean,
			default: true,
