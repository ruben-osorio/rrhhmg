                    ...
                    <div class="row justify-between items-center q-col-gutter-md">
                        ...
                        <div  class="col-md-auto col-12 " >
                            <template v-if="auth.canView('/permissions/add')">
                                <q-btn       :rounded="false"  size=""  color="primary" no-caps  unelevated   :to="`/permissions/add`" class="" >
                    ...
                    <div  class="col comp-grid" >
                        ...
                        <div >
                            ...
                            <div >
                                ...
                                :bordered="false"
                                :columns="app.menus.PermissionsListHeaderItems" 
                                :rows="records"
                                ...
                                <template v-slot:body="props">
                                    <q-tr :class="{selected: isCurrentRecord(props.row)}" :props="props">
                                        ...
                                        <q-td  key="role_id" :props="props">
                                            <q-btn v-if="props.row.role_id" @click="app.openPageDialog({ page: 'roles/view', url: `/roles/view/${props.row.role_id}` , closeBtn: true })" padding="xs" flat color="primary" no-caps >
                                                ...
                                                <q-btn icon="menu" padding="xs" round flat color="grey">
                                                    <q-menu auto-close transition-show="flip-right"  transition-hide="flip-left" self="center middle" anchor="center middle">
                                                        <q-list dense rounded nav>
                                                            <template v-if="auth.canView('permissions/view')">
