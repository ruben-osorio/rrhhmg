                ...
                <div class="container-fluid">
                    <div class="row justify-between items-center q-col-gutter-md">
                        ...
                        <div  class="col-md-auto col-12 " >
                            <template v-if="auth.canView('/equivcursoshv/add')">
                                <q-btn       :rounded="false"  size=""  color="primary" no-caps  unelevated   :to="`/equivcursoshv/add`" class="" >
                        ...
                        <div >
                            <template v-if="showBreadcrumbs && $route.query.tag">
                                <q-breadcrumbs class="q-pa-md">
                                    <q-breadcrumbs-el icon="arrow_back" class="text-capitalize" :label="$route.query.tag" to="/equivcursoshv"></q-breadcrumbs-el>
                            ...
                            <div >
                                ...
                                :bordered="false"
                                :columns="app.menus.EquivcursoshvListHeaderItems" 
                                :rows="records"
                                ...
                                <template v-slot:body="props">
                                    <q-tr :class="{selected: isCurrentRecord(props.row)}" :props="props">
                                                ...
                                                <q-btn icon="menu" padding="xs" round flat color="grey">
                                                    <q-menu auto-close transition-show="flip-right"  transition-hide="flip-left" self="center middle" anchor="center middle">
                                                        <q-list dense rounded nav>
                                                            <template v-if="auth.canView('equivcursoshv/view')">
                                                                <q-item link clickable v-ripple :to="`/equivcursoshv/view/${props.row.idcursoshv}`">
                                                                    <q-item-section>
                                                            ...
                                                            <template v-if="auth.canView('equivcursoshv/edit')">
                                                                <q-item link clickable v-ripple :to="`/equivcursoshv/edit/${props.row.idcursoshv}`">
                                                                    <q-item-section>
                                                            ...
                                                            <template v-if="auth.canView('equivcursoshv/delete')">
                                                                <q-item link clickable v-ripple @click="deleteItem(props.row.idcursoshv)">
                                                                    <q-item-section>
                                        ...
                                        <q-td  key="idcursoshv" :props="props">
                                            <q-btn padding="xs"   :rounded="false"  color="primary"  no-caps  unelevated   flat :to="`/equivcursoshv/view/${props.row.idcursoshv}`">{{ props.row.idcursoshv }}</q-btn>
                                        </q-td>
                                        <q-td  key="nomcurshv" :props="props">
                                            {{ props.row.nomcurshv }}
                                        </q-td>
                                        <q-td  key="nivelhv" :props="props">
                                            {{ props.row.nivelhv }}
                                        </q-td>
                                        <q-td  key="ordenhv" :props="props">
                                            {{ props.row.ordenhv }}
                                        </q-td>
                                    </q-tr>
                                </template>
...
<script setup>
	...
	const props = defineProps({
		...
		pageName : {
			type : String,
			default : 'equivcursoshv',
		},
		routeName : {
			type : String,
			default : 'equivcursoshvlist',
		},
		apiPath : {
			type : String,
			default : 'equivcursoshv/index',
		},
		paginate: {
			type: Boolean,
			default: true,
