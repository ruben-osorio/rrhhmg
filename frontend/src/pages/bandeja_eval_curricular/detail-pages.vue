        ...
        <template v-if="auth.canView('formestudios3/list')">
            <div class="q-my-md">
                <div class="reset-grid">
                    <list-formestudios3-page ref="formestudios3ListPage"  field-name="formestudios3.codusuario" :field-value="masterRecord.coduser" :show-header="false" isSubPage>
            ...
            <template v-if="auth.canView('formestudiossup3/list')">
                <div class="q-my-md">
                    <div class="reset-grid">
                        <list-formestudiossup3-page ref="formestudiossup3ListPage"  field-name="formestudiossup3.codusuario" :field-value="masterRecord.coduser" :show-header="false" isSubPage>
                ...
                <template v-if="auth.canView('formidiomas2/list')">
                    <div class="q-my-md">
                        <div class="reset-grid">
                            <list-formidiomas2-page ref="formidiomas2ListPage"  field-name="formidiomas2.codusuario" :field-value="masterRecord.coduser" :show-header="false" isSubPage>
...
const app = useApp();
const auth = useAuth();
const store = usePageStore('bandejaevalcurricular');
