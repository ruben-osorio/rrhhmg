                                    ...
                                    <div class="row q-col-gutter-x-md">
                                        ...
                                        <div class="col-12">
                                            <div class="row">
                                                ...
                                                <div class="col-sm-9 col-12">
                                                    <q-input   ref="ctrlhaber" v-model.trim="formData.haber"  label="Haber" type="text" placeholder="Escribir Haber"      
                                                    class="" :error="isFieldValid('haber')" :error-message="getFieldError('haber')">
                                                    </q-input>
                                                </div>
                                            </div>
                                        </div>
...
<script setup>
	...
	const props = defineProps({
		...
		routeName: {
			type: String,
			default: 'detboletaedit',
		},
		pagePath: {
			type : String,
			default : 'detboleta/edit',
		},
		apiPath: {
			type: String,
			default: 'detboleta/edit',
