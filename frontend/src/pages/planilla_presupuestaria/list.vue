                ...
                <div class="container-fluid">
                    <div class="row justify-between items-center q-col-gutter-md">
                        ...
                        <div  class="col-md-auto col-12 " >
                            <template v-if="auth.canView('/planilla_presupuestaria/agregar')">
                                <q-btn       :rounded="false"  size=""  color="primary" no-caps  unelevated   :to="`/planilla_presupuestaria/agregar`" class="" >
                                                ...
                                                <q-btn icon="menu" padding="xs" round flat color="grey">
                                                    <q-menu auto-close transition-show="flip-right"  transition-hide="flip-left" self="center middle" anchor="center middle">
                                                        <q-list dense rounded nav>
                                                            ...
                                                            <template v-if="auth.canView('planilla_presupuestaria/editar')">
                                                                <q-item link clickable v-ripple :to="`/planilla_presupuestaria/editar/${props.row.idplanillapres}`">
                                                                    <q-item-section>
