                    ...
                    <div  class="col comp-grid" >
                        ...
                        <div class="">
                            <div class="reset-grid">
                                <add-evaltempgrid-page ref="evalTempGridAddPage"  :show-header="true" :redirect="false">
                                    </add-evaltempgrid-page>
                                </div>
                            </div>
                            <div >
...
<script setup>
	...
	import addEvaltempgridPage from "../eval_temp_grid/add.vue";
