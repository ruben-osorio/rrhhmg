                ...
                <div class="container-fluid">
                    <div class="row justify-between items-center q-col-gutter-md">
                        ...
                        <div  class="col-md-auto col-12 " >
                            <template v-if="auth.canView('/infouser/add')">
                                <q-btn       :rounded="false"  size=""  color="primary" no-caps  unelevated   :to="`/infouser/add`" class="" >
                        ...
                        <div >
                            <template v-if="showBreadcrumbs && $route.query.tag">
                                <q-breadcrumbs class="q-pa-md">
                                    <q-breadcrumbs-el icon="arrow_back" class="text-capitalize" :label="$route.query.tag" to="/infouser"></q-breadcrumbs-el>
                            ...
                            <div >
                                ...
                                :bordered="false"
                                :columns="app.menus.InfouserListHeaderItems" 
                                :rows="records"
                                ...
                                <template v-slot:body="props">
                                    <q-tr :class="{selected: isCurrentRecord(props.row)}" :props="props">
                                        ...
                                        <q-td  key="fingreso" :props="props">
                                            {{ props.row.fingreso }}
                                        </q-td>
                                        <q-td  key="autovac" :props="props">
                                            {{ props.row.autovac }}
                                        </q-td>
                                        <q-td  key="cbancaria" :props="props">
                                            {{ props.row.cbancaria }}
                                        </q-td>
                                        <q-td  key="nativo" :props="props">
                                            {{ props.row.nativo }}
                                        </q-td>
                                        <q-td  key="visible" :props="props">
                                            {{ props.row.visible }}
                                        </q-td>
                                        <q-td  key="idinfo" :props="props">
                                            <q-btn padding="xs"   :rounded="false"  color="primary"  no-caps  unelevated   flat :to="`/infouser/view/${props.row.idinfo}`">{{ props.row.idinfo }}</q-btn>
                                        </q-td>
                                        <q-td  key="ley1178" :props="props">
                                            {{ props.row.ley1178 }}
                                        </q-td>
                                        <q-td  key="ppublicas" :props="props">
                                            {{ props.row.ppublicas }}
                                        </q-td>
                                        <q-td  key="rpfpublica" :props="props">
                                            {{ props.row.rpfpublica }}
                                        </q-td>
                                        <q-td  key="rejap" :props="props">
                                            {{ props.row.rejap }}
                                        </q-td>
                                        <q-td  key="frejap" :props="props">
                                            {{ props.row.frejap }}
                                        </q-td>
                                        <q-td  key="sipasse" :props="props">
                                            {{ props.row.sipasse }}
                                        </q-td>
                                        <q-td  key="fsipasse" :props="props">
                                            {{ props.row.fsipasse }}
                                        </q-td>
                                        <q-td  key="hojavida" :props="props">
                                            {{ props.row.hojavida }}
                                        </q-td>
                                        <q-td  key="incompatibilidad" :props="props">
                                            {{ props.row.incompatibilidad }}
                                        </q-td>
                                        <q-td  key="cnacimiento" :props="props">
                                            {{ props.row.cnacimiento }}
                                        </q-td>
                                        <q-td  key="nua" :props="props">
                                            {{ props.row.nua }}
                                        </q-td>
                                        <q-td  key="afp" :props="props">
                                            {{ props.row.afp }}
                                        </q-td>
                                                ...
                                                <q-btn icon="menu" padding="xs" round flat color="grey">
                                                    <q-menu auto-close transition-show="flip-right"  transition-hide="flip-left" self="center middle" anchor="center middle">
                                                        <q-list dense rounded nav>
                                                            <template v-if="auth.canView('infouser/view')">
                                                                <q-item link clickable v-ripple :to="`/infouser/view/${props.row.idinfo}`">
                                                                    <q-item-section>
                                                            ...
                                                            <template v-if="auth.canView('infouser/edit')">
                                                                <q-item link clickable v-ripple :to="`/infouser/edit/${props.row.idinfo}`">
                                                                    <q-item-section>
                                                            ...
                                                            <template v-if="auth.canView('infouser/delete')">
                                                                <q-item link clickable v-ripple @click="deleteItem(props.row.idinfo)">
                                                                    <q-item-section>
...
<script setup>
	...
	const props = defineProps({
		...
		routeName : {
			type : String,
			default : 'infouserlist',
		},
		apiPath : {
			type : String,
			default : 'infouser/index',
		},
		paginate: {
			type: Boolean,
			default: true,
