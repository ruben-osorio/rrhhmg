                ...
                <div class="container-fluid">
                    <div class="row justify-between items-center q-col-gutter-md">
                        ...
                        <div  class="col-md-auto col-12 " >
                            <template v-if="auth.canView('/secundariahv/add')">
                                <q-btn       :rounded="false"  size=""  color="primary" no-caps  unelevated   :to="`/secundariahv/add`" class="" >
                        ...
                        <div >
                            <template v-if="showBreadcrumbs && $route.query.tag">
                                <q-breadcrumbs class="q-pa-md">
                                    <q-breadcrumbs-el icon="arrow_back" class="text-capitalize" :label="$route.query.tag" to="/secundariahv"></q-breadcrumbs-el>
                            ...
                            <div >
                                ...
                                :bordered="false"
                                :columns="app.menus.SecundariahvListHeaderItems" 
                                :rows="records"
                                ...
                                <template v-slot:body="props">
                                    <q-tr :class="{selected: isCurrentRecord(props.row)}" :props="props">
                                                ...
                                                <q-btn icon="menu" padding="xs" round flat color="grey">
                                                    <q-menu auto-close transition-show="flip-right"  transition-hide="flip-left" self="center middle" anchor="center middle">
                                                        <q-list dense rounded nav>
                                                            <template v-if="auth.canView('secundariahv/view')">
                                                                <q-item link clickable v-ripple :to="`/secundariahv/view/${props.row.idsecundariahv}`">
                                                                    <q-item-section>
                                                            ...
                                                            <template v-if="auth.canView('secundariahv/edit')">
                                                                <q-item link clickable v-ripple :to="`/secundariahv/edit/${props.row.idsecundariahv}`">
                                                                    <q-item-section>
                                                            ...
                                                            <template v-if="auth.canView('secundariahv/delete')">
                                                                <q-item link clickable v-ripple @click="deleteItem(props.row.idsecundariahv)">
                                                                    <q-item-section>
                                        ...
                                        <q-td  key="idsecundariahv" :props="props">
                                            <q-btn padding="xs"   :rounded="false"  color="primary"  no-caps  unelevated   flat :to="`/secundariahv/view/${props.row.idsecundariahv}`">{{ props.row.idsecundariahv }}</q-btn>
                                        </q-td>
                                        <q-td  key="nombresechv" :props="props">
                                            {{ props.row.nombresechv }}
                                        </q-td>
...
<script setup>
	...
	const props = defineProps({
		primaryKey : {
			type : String,
			default : 'idsecundariahv',
		},
		pageName : {
			type : String,
			default : 'secundariahv',
		},
		routeName : {
			type : String,
			default : 'secundariahvlist',
		},
		apiPath : {
			type : String,
			default : 'secundariahv/index',
		},
		paginate: {
			type: Boolean,
			default: true,
