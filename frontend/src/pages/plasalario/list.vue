                ...
                <div class="container-fluid">
                    <div class="row justify-between items-center q-col-gutter-md">
                        ...
                        <div  class="col-md-auto col-12 " >
                            <template v-if="auth.canView('/plasalario/add')">
                                <q-btn       :rounded="false"  size=""  color="primary" no-caps  unelevated   :to="`/plasalario/add`" class="" >
                        ...
                        <div >
                            <template v-if="showBreadcrumbs && $route.query.tag">
                                <q-breadcrumbs class="q-pa-md">
                                    <q-breadcrumbs-el icon="arrow_back" class="text-capitalize" :label="$route.query.tag" to="/plasalario"></q-breadcrumbs-el>
                            ...
                            <div >
                                ...
                                :bordered="false"
                                :columns="app.menus.PlasalarioListHeaderItems" 
                                :rows="records"
                                ...
                                <template v-slot:body="props">
                                    <q-tr :class="{selected: isCurrentRecord(props.row)}" :props="props">
                                        ...
                                        <q-td  key="codpla" :props="props">
                                            <q-btn v-if="props.row.codpla" @click="app.openPageDialog({ page: 'planillas/view', url: `/planillas/view/${props.row.codpla}` , closeBtn: true })" padding="xs" flat color="primary" no-caps >
                                                <q-icon name="visibility" size="xs"  class="q-mr-xs"></q-icon>  Planillas
                                            </q-btn>
                                        </q-td>
                                        <q-td  key="cargos" :props="props">
                                            {{ props.row.cargos }}
                                        </q-td>
                                        <q-td  key="salarios" :props="props">
                                            {{ props.row.salarios }}
                                        </q-td>
                                        <q-td  key="ausencia" :props="props">
                                            {{ props.row.ausencia }}
                                        </q-td>
                                        <q-td  key="atraso" :props="props">
                                            {{ props.row.atraso }}
                                        </q-td>
                                        <q-td  key="sminimo" :props="props">
                                            {{ props.row.sminimo }}
                                        </q-td>
                                        <q-td  key="haberbasico" :props="props">
                                            {{ props.row.haberbasico }}
                                        </q-td>
                                        <q-td  key="tsalario" :props="props">
                                            {{ props.row.tsalario }}
                                        </q-td>
                                        <q-td  key="tdescuento" :props="props">
                                            {{ props.row.tdescuento }}
                                        </q-td>
                                        <q-td  key="idplasalario" :props="props">
                                            <q-btn padding="xs"   :rounded="false"  color="primary"  no-caps  unelevated   flat :to="`/plasalario/view/${props.row.idplasalario}`">{{ props.row.idplasalario }}</q-btn>
                                        </q-td>
                                        ...
                                        <q-td  key="cas" :props="props">
                                            {{ props.row.cas }}
                                        </q-td>
                                        <q-td  key="mantiguedad" :props="props">
                                            {{ props.row.mantiguedad }}
                                        </q-td>
                                        <q-td  key="frontera" :props="props">
                                            {{ props.row.frontera }}
                                        </q-td>
                                                ...
                                                <q-btn icon="menu" padding="xs" round flat color="grey">
                                                    <q-menu auto-close transition-show="flip-right"  transition-hide="flip-left" self="center middle" anchor="center middle">
                                                        <q-list dense rounded nav>
                                                            <template v-if="auth.canView('plasalario/view')">
                                                                <q-item link clickable v-ripple :to="`/plasalario/view/${props.row.idplasalario}`">
                                                                    <q-item-section>
                                                            ...
                                                            <template v-if="auth.canView('plasalario/edit')">
                                                                <q-item link clickable v-ripple :to="`/plasalario/edit/${props.row.idplasalario}`">
                                                                    <q-item-section>
                                                            ...
                                                            <template v-if="auth.canView('plasalario/delete')">
                                                                <q-item link clickable v-ripple @click="deleteItem(props.row.idplasalario)">
                                                                    <q-item-section>
...
<script setup>
	...
	const props = defineProps({
		...
		routeName : {
			type : String,
			default : 'plasalariolist',
		},
		apiPath : {
			type : String,
			default : 'plasalario/index',
		},
		paginate: {
			type: Boolean,
			default: true,
