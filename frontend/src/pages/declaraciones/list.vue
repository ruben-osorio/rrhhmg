                ...
                <div class="container-fluid">
                    <div class="row justify-between items-center q-col-gutter-md">
                        ...
                        <div  class="col-md-auto col-12 " >
                            <template v-if="auth.canView('/declaraciones/add')">
                                <q-btn       :rounded="false"  size=""  color="primary" no-caps  unelevated   :to="`/declaraciones/add`" class="" >
                        ...
                        <div >
                            <template v-if="showBreadcrumbs && $route.query.tag">
                                <q-breadcrumbs class="q-pa-md">
                                    <q-breadcrumbs-el icon="arrow_back" class="text-capitalize" :label="$route.query.tag" to="/declaraciones"></q-breadcrumbs-el>
                            ...
                            <div class="row q-col-gutter-x-md q-col-gutter-md justify-start">
                                <div class="col">
                                    ...
                                    <div >
                                        ...
                                        :bordered="false"
                                        :columns="app.menus.DeclaracionesListHeaderItems" 
                                        :rows="records"
                                        ...
                                        <template v-slot:body="props">
                                            <q-tr :class="{selected: isCurrentRecord(props.row)}" :props="props">
                                                ...
                                                <q-td  key="iddeclaracion" :props="props">
                                                    <q-btn padding="xs"   :rounded="false"  color="primary"  no-caps  unelevated   flat :to="`/declaraciones/view/${props.row.iddeclaracion}`">{{ props.row.iddeclaracion }}</q-btn>
                                                </q-td>
                                                        ...
                                                        <q-btn icon="menu" padding="xs" round flat color="grey">
                                                            <q-menu auto-close transition-show="flip-right"  transition-hide="flip-left" self="center middle" anchor="center middle">
                                                                <q-list dense rounded nav>
                                                                    <template v-if="auth.canView('declaraciones/view')">
                                                                        <q-item link clickable v-ripple :to="`/declaraciones/view/${props.row.iddeclaracion}`">
                                                                            <q-item-section>
                                                                    ...
                                                                    <template v-if="auth.canView('declaraciones/edit')">
                                                                        <q-item link clickable v-ripple :to="`/declaraciones/edit/${props.row.iddeclaracion}`">
                                                                            <q-item-section>
                                                                    ...
                                                                    <template v-if="auth.canView('declaraciones/delete')">
                                                                        <q-item link clickable v-ripple @click="deleteItem(props.row.iddeclaracion)">
                                                                            <q-item-section>
...
<script setup>
	...
	const props = defineProps({
		...
		routeName : {
			type : String,
			default : 'declaracioneslist',
		},
		apiPath : {
			type : String,
			default : 'declaraciones/index',
		},
		paginate: {
			type: Boolean,
			default: true,
